...
The British came to India in 1600 as traders, in the form of East India Company, which had the exclusive right of trading in India under a chapter granted by \gls{person:QueenElizabethIu4o}. In 1764, the Company, which till now had purely trading functions obtained the \quotesingle{diwani}\hspace{4pt}(i.e., rights over revenue and civil justice) of Bengal, Bihar and Orissa
\footnote{The Mughal Emperor, \gls{person:ShahAlamfhm}, granted \quotesingle{Diwani} to the Company after its victory in the Battle of Buxar (1764)}. This started its career as a territorial power. In 1858, in the wake of the \quotesingle{\index{Sepoy mutiny}}, the British Crown assumed direct responsibility for the governance of India. This rule continued until India was granted independence on \gls{date:August15194794L}.

With Independence came the need of a Constitution. As suggested by \gls{person:MNRoyYY2} (a pioneer of communist movement in India and an advocate of Radical Democrat-ism) in 1934, a Constituent Assembly was formed for this purpose in 1946 and on January 26, 1950, the Constitution and polity have their roots in the British rule. There are certain events in the British rule that laid down the legal framework for the organization and functioning of government and administration in British India. These events have greatly influenced out contribution and polity. They are explained here in a chronological order:

\section{The Company Rule (1973-1858)}

\subsection{\index{Acts!Regulating Act of 1773}}
...
\subsection{\index{Acts!Pitt's India Act of 1784}}

In a bid to rectify the defects of the \index{Acts!Regulating Act of 1773}, the British Parliament passed the \index{Acts!Amending Act of 1781}, also known as the \index{Acts!Act of Settlement}. The next important act was the Pitt's India Act\footnote{It was introduced in the British Parliament by the then Prime Minister, \gls{person:WilliamPittrds}} of 1784.
...
\begin{enumerate}
  ...
  \item The \index{Acts!Charter Act of 1833} attempted to introduce a system of open competition for \index{civil servants}, and stated that the Indians should not be debarred from holding any place, office and employment under the Company. However, this provision negated after opposition from the Courts of Directors.
\end{enumerate}

\subsection{\index{Acts!Charter Act of 1853}}
...
\begin{enumerate}
  ...
  \item It introduced an open competition system of selection and recruitment of \index{civil servants}\footnote{At that time, the Civil Services of the company were classified into covenanted civil services (higher civil services) and uncovenanted civil services (lower civil services). The former was created by a law of the Company, while the lated was created otherwise.} was thus thrown open to Indians also. Accordingly, the Macaulay Committee (the Committee on the Indian Civil Services) was appointed in 1854.
...
\subsection*{\index{Acts!Government of India Act of 1858}}

This significant Act was enacted in the wake of the \index{Revolt of 1857} - also known as the First War of Independence of the \quotesingle{\index{Sepoy mutiny}}. The act known as the \textbf{\index{Acts!Act for the Good Government of India}}, abolished the East India Company, and transferred the powers of government, territories and revenues to British Crown.

\paragraph{Features of the Act}
\begin{enumerate}
  \item It provided that India henceforth was to be governed by, and in the name of, Her Majesty. It changed the designation of th Governor-General of India to that of Viceroy of India. He (viceroy) was the direct representative of the British Crown in India. \gls{person:LordCanningrwU} thus became first Viceroy of India.
...
\begin{enumerate}
  \item It made a beginning of representative institutions by association Indians with the law-making process. It thus provided that the viceroy should nominate some Indians as non-official members of his expanded council. In 1862, \gls{person:LordCanningrwU}, the then viceroy, nominated three Indians to his legislative council — the Raja of Benaras, the Maharaja of Patiala and \gls{person:DinkarRaoH5q}Sir \gls{person:DinkarRaoH5q}.
  \item It initiated the process of decentralization by restoring the legislative powers to the Bombay and Madras Presidencies. It thus reversed the centralizing tendency that started from the \index{Acts!Regulating Act of 1773} and reached its climax under the \index{Acts!Charter Act of 1833}. This policy of legislative devolution resulted in the grant of almost complete internal autonomy to the provinces in 1937.
  \item It also provided for the establishment of new legislative councils for Bengal, \gls{NorthWesternFrontierProvinceome} (NWFP) and Panjab, which were established in 1862, 1866 and 1897 respectively.
  \item It empowered the Viceroy to make rules and orders for the more convenient transaction of business in the council. It also gave a recognition to the  \quotesingle{portfolio} system, introduced by \gls{person:LordCanningrwU}\gls{person:LordCanningrwU} in 1859. Under this, a member of the Viceroy's council was made in-charge of one or more departments of the government and was authorized to issue final orders on behalf of the council on matters of his department(s).
...
\begin{enumerate}
  ...
  \item It increased the function of legislative councils and gave them the power of discussing the budget\footnote{The system of Budget was introduced in British India in 1860.} and addressing questions to executive.
  ...
  \end{list}
\end{enumerate}
\quotesingle{The act made a limited and indirect provision for the use of election in filling up some of the non-official seats both in the Central and provincial legislative councils. The word \quotedouble{election} was, however not used in the act. The process was described as nomination made on the recommendation of certain bodies\footnote{V. N. Shukla, The Constitution of India, Esatern Book Company, 10th Edition, 2001, P. A-10.}.}

\paragraph{Features of the Act of 1909}
This Act is also known as Morley-Minto Reforms (Lord Morley was the then Secretary of State for India and \gls{person:LordMintoSWG} was the then Viceroy of India).
\begin{enumerate}
  ...
  \item It provided (for the first time) for the association of Indians with the executive Councils of the Viceroy and Governors. \gls{person:SatyendraPrasadSinhacfj} became the first Indian to join the Viceroy's Executive Council. He was appointed as the law member.
  \item It introduced a system of \index{communal representation} for Muslims by accepting the concept of \quotesingle{\gls{SeparateElectorateYd1}}. Under this, the Muslim members were to be elected only by Muslim voter. Thus, the Act \quotesingle{legalized communal-ism} and \gls{person:LordMintoSWG} came to be known as the Father of Communal Electorate.
...
\subsection{\index{Acts!Government of India Act of 1919}}

On \gls{date:August201917mC3}, the British Government declared, for the first time, that its objective was the gradual introduction of responsible government in India\footnote{The declaration this stated: \quotesingle{The policy of His Majesty's Government is that of the increasing association of Indians in every branch of the administration, and the gradual development of self-government institutions, with a view to the progressive realization of responsible government in India as an integral part of the British Empire}.}.

The \index{Acts!Government of India Act of 1919} was thus enacted, which came into force in 1921. This Act is also known as \gls{person:Montagudpf}-\gls{person:Chelmsford0ig} Reforms (\gls{person:Montagudpf} was the Secretary of State for India and \gls{person:Chelmsford0ig} was the Viceroy of India).
...
\begin{enumerate}
  ...
  \item It extended the principle of \index{communal representation} by providing \index{separate electorate}s for Sikhs, Indian Christias, Anglo-Indians and Europeans.
  ...
  \item It provided for the establishment of a \index{public service commission}. Hence, a Central Public Service Commission was set up in 1926 for recruiting \index{civil servants}\footnote{This was done on the recommendation of the Lee Commission on Superior Civil Services in India (1923–24).}.
...
\paragraph{\index{Simon Commission}}

In November 1927 itself (i.e. 2 years before the schedule), the British Government announced the appointment of a seven member statutory commission under the chairmanship of \gls{person:SirJohnSimongjR} to report on the condition of India under its new Constitution. All the members of the commission were British and hence, all the parties boycotted the commission, The commission submitted its report in 1930 and recommended the abolition of dyarchy, extension of responsible government in the provinces, establishment of a federation of British India and princely states, continuation of communal electorate and so on. To consider the proposal of the commission, the British Government convened three round table conferences of the representatives of the British Government, British India and Indian princely state. On the basis of these discussions, a \quotesingle{White Paper on Constitutional Reforms} was prepared and submitted for the consideration of the Joint Select Committee of the British Parliament. The recommendations of this committee were incorporated (with certain changes) in the next \index{Acts!Government of India Act of 1935}.

\paragraph{\index{Communal Award}}
In August 1932, \gls{person:RamsayMacDonaldztE}, the British Prime Minister, announced a scheme of representation of the minorities, which came to be known as the \index{Communal Award}. The award not only continued \index{separate electorate}s for the Muslims, Sikhs, Indian Christians, Anglo-Indians and Europeans but also extended it to the depressed classes (schedules castes). \gls{person:MahatmaGandhivNF} was distressed over this extension of the principle of \index{communal representation} to the depressed classes and undertook fast unto death in \index{Yervada Jail} (Poona) to get the award modified. At last, there was an agreement between the leaders of the Congress and the depressed classes. The agreement, known and \index{Poona Pact}, retained the Hindu joint electorate and gave reserved seats to the depressed classes.



\subsection{\index{Acts!Government of India Act of 1935}}
...
\begin{enumerate}
  ...
  \item It introduced \index{bicameralism} in six out of eleven provinces. Thus, the legislature of Bengal, Bombay, Madras, Bihar, Assam and the United Provinces were made bicameral consisting of a legislative council (upper house) and a legislative assembly (lower house). However, many restrictions were placed on them.
  \item It further extended the principle of \index{communal representation} by providing \index{separate electorate}s for depressed classes (schedules castes), women and labor (workers).
  \item It abolished the Council of India, established by the \index{Acts!Government of India Act of 1858}. The secretary of state for India was provided with a team of advisors.
  \item It extended franchise. About 10 percent of the total population got the voting right.
  \item It provided for the establishment of \index{Reserve Bank of India} to control the currency and credit of the country.
...
\subsection{\index{Acts!Indian Independence Act of 1947}}

On Feburary 20, 1947, the British Prime Minister \gls{person:ClementAtleeXch} declared that the British rule in India would end by \gls{date:June201948svF}; after which the power would be transferred to responsible Indian hands. This announcement was followed by the agitation by the Muslim League demanding partition of the country. Again on \gls{date:June31947Nqd}, the British Government made it clear that any Constitution framed by the Constituent Assembly of India (formed in 1946) cannot apply to those parts of the country which were unwilling to accept it. On the same day (\gls{date:June31947Nqd}), \gls{person:LordMountbettenpWj}, the viceroy of India, put forth the partition plan known as the \index{Mountbatten Plan}. The plan was accepted by the Congress and the Muslim League. Immediate effect was given to the plan by enacting the Indian Independence Act\footnote{The Indian Independence Bill was introduced in the British Parliament on \gls{date:July419471yQ} and received the Royal Assent on \gls{date:July181947Uu8}. The act came into force on \gls{date:August15194794L}.} (1947).

\paragraph{Features of the Act}
\begin{enumerate}
  \item It ended the British rule in India and declared India as an independent and sovereign state from \gls{date:August15194794L}.
  \item It provided for the partition of India and creation of two independent dominions of India and Pakistan with the right to secede from the \index{British Commonwealth}.
  ...
  \item It proclaimed the lapse of British paramountcy over the Indian princely states and treaty relations with tribal areas from \gls{date:August15194794L}.
  ...
  \item It provided for the Governance of each of the dominions and the provinces by the \index{Acts!Government of India Act of 1935}, till the new Constitutions were framed. The dominions were however authorized to make modifications in the Act.
  ...
  \item It discontinued the appointment to civil services and reservation of posts by the secretary of state for India. The members of the civil services appointed before \gls{date:August15194794L} would continue to enjoy all benefits that they were entitled to till that time.
\end{enumerate}

At the stroke of midnight 14-15 August, 1947, the British rule came to an end and power was transferred to the two new independent Dominions of India and Pakistan\footnote{The boundaries between the two Dominions were determined by a Boundary Commission headed by Radcliff. Pakistan included the provinces of West Punjab, Sind, Baluchistan, East Bengal, \gls{NorthWesternFrontierProvinceome} and the district of Sylhet in Assam. The referendum in the \gls{NorthWesternFrontierProvinceome} and Sylhet was in favor of Pakistan.}. \gls{person:LordMountbettenpWj} became the first governor-general of the new Dominion of India. He swore in \gls{person:JawaharlalNehruLrI} as the first prime minister of independent India. The Constituent Assembly of India formed in 1946 became the Parliament of the Indian Dominion.
...
\begin{longtable}[c]{@{}|l|l|l|@{}}
  ...
  \endlastfoot
  %
  1. & \gls{person:JawaharlalNehruLrI} & External Affairs \& Commonwealth \\
     &                           & Relations \\
  2. & \gls{person:SardarVallabhbhaiPatelZW9} & Home, Information \& Broadcasting \\
  3. & \gls{person:DrRajendraPrasad6Nq} & Food \& Agriculture \\
  4. & \gls{person:DrJohnMathaiY9J} & Industries \& Supplies \\
  5. & \gls{person:JagjivanRam3KW} & Labor \\
  6. & \gls{person:SardarBaldevSingh4tx} & Defense \\
  7. & \gls{person:CHBhabhaVnf} & Works, Mines \& Power \\
  8. & \gls{person:LiaquatAliKhanmUA} & Finance \\
  9. & \gls{person:AbdurRabNishtarFL9} & Posts \& Air \\
  10. & \gls{person:AsafAliMJC} & Railways \& Transport \\
  11. & \gls{person:CRajagopalacharilla} & Education \& Arts \\
  12. & \gls{person:IIChundrigarIFv} & Commerce \\
  13. & \gls{person:GhaznafarAliKhan1gZ} & Health \\
  14. & \gls{person:JoginderNathMandal22o} & Law \\* \bottomrule
\end{longtable}
\textit{\textbf{Note}}: The members of the interim government were members of the Viceroy's Executive Council. The Viceroy continues to be the head of the Council. But, \gls{person:JawaharlalNehruLrI} was designated as the Vice-President of the Council.
...
\begin{longtable}[c]{@{}|l|l|l|@{}}
	...
	\endlastfoot
	%
	1. & \gls{person:JawaharlalNehruLrI} & Prime Minister; External Affairs \& Commonwealth \\
	&                           & Relations; Scientific Research \\
	2. & \gls{person:SardarVallabhbhaiPatelZW9} & Home, Information \& Broadcasting; States \\
	3. & \gls{person:DrRajendraPrasad6Nq} & Food \& Agriculture \\
	4. & \gls{person:MaulanaAbulKalamAzadIoR} & Education \\
	5. & \gls{person:DrJohnMathaiY9J} & Railway \& Transport \\
	6. & \gls{person:RKShanmughamvjM} & Finance \\
	7. & \gls{person:DrBRAmbedkarls6} & Law \\
	8. & \gls{person:JagjivanRam3KW} & Labor \\
	9. & \gls{person:SardarBaldevSingh4tx} & Defense \\
	10. & \gls{person:RajKumariAmritKaurKbM} & Health \\
	11. & \gls{person:CHBhabhaVnf} & Commerce \\
	12. & \gls{person:RafiAhmedKidwaixH6} & Communication \\
	13. & \gls{person:DrShyamaPrasadMukherjiAM1} & Industries \& Supplies \\
	14. & \gls{person:VNGadgilxIt} & Works, Mines \& Power \\* \bottomrule
\end{longtable}
...
It is thus clear that the Constituent Assembly was to be a partly elected and partly nominated body. Moreover, the members were to be indirectly elected by the members of provincial assemblies, who themselves were elected on a limited franchise\footnote{The \index{Acts!Government of India Act of 1935} granted limited franchise on the basis of tax, property and education.}.
...
Although the Constituent Assembly was not directly elected by the people of India on the basis of adult franchise, the Assembly comprised representatives of all section of Indian Society - Hindus, Muslims, Sikhs, Parsis, Anglo-Indians, Indian Christians, SCs, STs including women of all these sections. The Assembly included all important personalities of India at that time, with the exception of \gls{person:MahatmaGandhivNF}.

\section{Working of the Constituent Assembly}

The Constituent Assembly held its first meeting on \gls{date:December91946vwN}. The Muslim League boycotted the meeting and insisted on a separate state of Pakistan. The meeting was thus attended by only 211 members. {\colord{}\gls{person:DrSachchidanandSinhamda}, the oldest member, was elected as the temporary President of the Assembly, following the French practice.}

Later, \gls{person:DrRajendraPrasad6Nq} was elected as the President of the Assembly. Similarly, both \gls{person:HCMukherjeeRQ8} and \gls{person:VTKrishnamachiiJw} were elected as the Vice-Presidents of the Assembly. In other words, the Assembly had two Vice-Presidents.

\paragraph{\index{Objectives Resolution}}

On \gls{date:December1319464de}, \gls{person:JawaharlalNehruLrI} moved the historic \quotesingle{\index{Objectives Resolution}} in the Assembly. It laid down the fundamentals and philosophy of the constitutional structure. It read:
...
The representatives of the princely states, who had stayed awat from the Constituent Assembly, gradually joined in. On \gls{date:April281947SAt}, representatives of the six states\footnote{These include Baroda, Bikaner, Jaipur, Patiala, Rewa and Udaipur.} were part of the Assembly. After the acceptance of \index{Mountbatten Plan} of \gls{date:June31947Nqd} for a partition of the country, the representatives of most of the other princely states took their seats in the Assembly. The members of the Muslim League from the Indian Dominion also entered the Assembly.

The \index{Acts!Indian Independence Act of 1947} made the following three changes in the position of the Assembly:
...
\begin{enumerate}
  ...
  \item The Assembly also became a legislative body. In other words, two separate functions were assigned to the Assembly, that is, making of a constitution for free India and enacting of ordinary laws for the country. These two tasks were to be performed on separate days. Thus, the Assembly became the first Parliament of free India (Dominion Legislature). Whenever the Assembly met as the Constituent body it was chaired by \gls{person:DrRajendraPrasad6Nq} and when it met as the legislative body\footnote{For the first time, the Constituent Assembly met as Dominion Legislature on \gls{date:November1719474We} and elected \gls{person:GVMavalankarg2X} as its speaker.}, it was chaired by \gls{person:GVMavalankarg2X}. These two functions continued till \gls{date:November261949Hl8}, when the task of making the Constitution was over.
  \item The Muslim League members (hailing from the areas\footnote{These are West Punjab, East Bengal, NWFP, Sindh, Baluchistan and Sylhet District of Assam. A separate Constituent Assembly was set up for Pakistan.} included in the Pakistan) withdrew from the Constituent Assembly for India. Consequently, the total strength of the Assembly came down to 299 as against 389 originally fixed in 1946 under the Cabinet Mission Plan. The strength of the Indian provinces (formerly British Provinces) was reduced from 296 to 299 and those of the princely states from 93 to 70. The state-wise membership of the Assembly as on \gls{date:December311947KPZ}, is shown in \ref{tab:StateWiseMemberShipAssembly} at the end of this chapter.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item It elected \gls{person:DrRajendraPrasad6Nq} as the first President of India on January 24, 1950.
\end{enumerate}
...
On January 24, 1950, the Constituent Assembly held its final session. It however, did not end, and continued as the provisional parliament of India from January 26, 1950 till the formation of new Parliament\footnote{The Provisional Parliament ceased to exist on \gls{date:April171952KeD}. The first elected Parliament with the two Houses came into being in May 1952.} after the first general elections in 1951-52.
...
\begin{enumerate}
  \item \gls{committee:UnionPowersCommittee0wa} - \gls{person:JawaharlalNehruLrI}
  \item \gls{committee:UnionConstitutionCommitteeMrs} - \gls{person:JawaharlalNehruLrI}
  \item \gls{committee:ProvincialConstitutionCommittee5GY} - \gls{person:SardarVallabhbhaiPatelZW9}
  \item \gls{committee:DraftingCommitteeIGI} - \gls{person:DrBRAmbedkarls6}
  \item \gls{committee:AdvisoryCommitteevwK} on \index{Fundamental Rights}, Minorities and Tribal and Excluded Areas - \gls{person:SardarVallabhbhaiPatelZW9}. This committee had the following five sub-committees:
  \begin{enumerate}
    \item \gls{committee:FundamentalRightsSubCommitteeWOa} - \gls{person:JBKripalanix8u}
    \item \gls{committee:MinoritiesSubCommittee6mv} - \gls{person:HCMukherjeeRQ8}
    \item \gls{committee:NorthEastFrontierTribunalAreasSubCommitteejMU} (with Assam Excluded \& Partially Excluded Areas) - \gls{person:GopinathBardoloi3zv}
    \item \gls{committee:ExcludedandPartiallyExcludedAreasjTN} Other than those in Assam Sub Committee - \gls{person:AVThakkarBrA}
    \item \gls{committee:NorthWestFrontierTribalAreasSubCommitteeLnx}\footnote{One of the political consequences of the British Government’s statement of \gls{date:June31947Nqd}, was that following a referendum, the North-West Frontier Province and Baluchistan became part of the territory of the Dominion of Pakistan and as a result the tribal areas in this region became a concern of that Dominion. The Sub-Committee on the Tribal Areas in the North-West Frontier Province and Baluchistan was not therefore called upon to function on behalf of the Constituent Assembly of India. (B. Shiva Rao, The Framing of India’s Constitution : Select Documents, Volume III, P.681.) The members of this Sub-Committee were : Khan Abdul Ghaffar Khan, Khan Abdul Samad Khan and Mehr Chand Khanna. The information about the Chairman is not found.}
  \end{enumerate}
  
  \item \gls{committee:RulesofProcedureCommittee7LG} - \gls{person:DrRajendraPrasad6Nq}
  \item \gls{committee:StatesCommitteeCommitteeforNegotiatingwithStatesrrd} - \gls{person:JawaharlalNehruLrI}
  \item \gls{committee:SteeringCommitteeGGV} - \gls{person:DrRajendraPrasad6Nq}
\end{enumerate}

\subsection{Minor Committees}

\begin{enumerate}
  \item \gls{committee:FinanceandStaffCommitteeTwU} - \gls{person:DrRajendraPrasad6Nq}
  \item \gls{committee:CredentialsCommitteeaUH} - \gls{person:AlladiKrishnaswamiAyyarJwD}
  \item \gls{committee:HouseCommittee6O0} - \gls{person:BPattabhiSitaramayyai03}
  \item \gls{committee:OrderofBusinessCommittee4VM} - \gls{person:DrKMMunshikpl}
  \item \gls{committee:AdhocCommitteeontheNationalFlagK79} - \gls{person:DrRajendraPrasad6Nq}
  \item \gls{committee:CommitteeontheFunctionsoftheConstituentAssemblyNc3} - \gls{person:GVMavalankarg2X}
  \item \gls{committee:AdhocCommitteeontheSupremeCourtGEo} - \gls{person:SVaradachariKOY} (Not an Assembly Member)
  \item \gls{committee:CommitteeonChiefCommissionersProvinceswy2} - \gls{person:BPattabhiSitaramayyai03}
  \item \gls{committee:ExpertCommitteeontheFinancialProvisionsoftheUnionConstitution34u} - \gls{person:NaliniRanjanSarkarpsT} (Not an Assembly Member)
  \item \gls{committee:LinguisticProvincesCommissionAYD} - \gls{person:SKDarkD7} (Not an Assembly Member)
  \item \gls{committee:SpecialCommitteetoExaminetheDraftConstitutionj7d} - \gls{person:JawaharlalNehruLrI}
  \item \gls{committee:PressGalleryCommittee44l} - \gls{person:UshaNathSenYBF}
  \item \gls{committee:AdhocCommitteeonCitizenship6CX} - \gls{person:SVaradachariKOY}
\end{enumerate}


\subsection{\gls{committee:DraftingCommitteeIGI}}

Among all the committees of the Constituent Assembly, the most important committee was the \gls{committee:DraftingCommitteeIGI} set up on \gls{date:August291947rNH}. It was this committee that was entrusted with the task of preparing a draft of the new Constitution. It consisted of seven members. They were

\begin{enumerate}
  \item \gls{person:DrBRAmbedkarls6} ({\colord Chairmen})
  \item \gls{person:NGopalaswamyAyyangar3Hv}
  \item \gls{person:AlladiKrishnaswamiAyyarJwD}
  \item \gls{person:DrKMMunshikpl}
  \item \gls{person:SayedMohammadSaadullahSGH}
  \item \gls{person:NMadhavaRauoxZ} (He replaced \gls{person:BLMitterzpO} who resined due to ill-health)
  \item \gls{person:TTKrishnamachariqXy} (He replaced \gls{person:DPKhaitanPRI} who died in 1948)
\end{enumerate}

The \gls{committee:DraftingCommitteeIGI}, after taking into consideration the proposal of the various committees, prepared the first draft of the Constitution of India, which was published in February 1948. The people of India were given eight months to discuss the draft and propose amendments. In the light of the public comments, criticisms and suggestions, the \gls{committee:DraftingCommitteeIGI} prepared a second draft, which was published in October 1948.

The \gls{committee:DraftingCommitteeIGI} took less than six months to prepare its draft. In all it say for 141 days.

\section{Enactment of the Constitution}

\gls{person:DrBRAmbedkarls6} introduced the final draft of the Constitution in the Assembly on \gls{date:November41948IHF} (first reading). The Assembly had a general discussion on it for five days (till \gls{date:November91948YXv}).

The second reading (clause by clause consideration) started on \gls{date:November151948FJD} and ended on \gls{date:October171949yzL}. During this stage, as many as 7653 amendments were proposed and 2473 were actually discussed in the Assembly.

The third reading of the draft started on \gls{date:November1419492H5}. \gls{person:DrBRAmbedkarls6} moved a motion - \quotesingle{the Constitution as settled by the Assembly be passed}. The motion on Draft Constitution was declared as passed on \gls{date:November261949Hl8}, and received the signatures of the members and the president. Out of a total 299 members of the Assembly, only 284 were actually present on that day and signed the Constitution. This is also the date mentioned in the Preamble as the date on which the people of India in the Constituent Assembly adopted, enacted and gave to themselves this Constitution.

{\colord The Constitution as adopted on \gls{date:November261949Hl8}, contained a Preamble, 395 Articles and 8 Schedules}. The Preamble was enacted after the entire Constitution was already enacted.

\gls{person:DrBRAmbedkarls6}, the then Law Minister, piloted the Draft Constitution in the Assembly. He took a very prominent part in the deliberations of the Assembly. He was known for his logical, forceful and persuasive arguments on the floor of the Assembly. He is recognized as the \quotesingle{Father of the Constitution of India}. This brilliant writer, constitutional expert, undisputed leader of the scheduled castes and the \quotesingle{chief architech of the Constitution of India} is also known as a \quotesingle{Modern Manu}.

\section{Enforcement of the Constitution}

Some provisions of the Constitution pertaining to citizenship, elections, provisional parliament, temporary and transitional provisions, and short title contained in Articles 5, 6, 7, 8, 9, 60, 324, 366, 367, 379, 380, 388, 391, 392 and 393 came into force on \gls{date:November261949Hl8} itself.
...
With the commencement of the Constitution, the \index{Acts!Indian Independence Act of 1947} and the \index{Acts!Government of India Act of 1935}, with all enactments amending or supplementing the latter Act, were repealed. The Abolition of Privy Council Jurisdiction Act (1949) was however continued.
...
\begin{enumerate}
  \item \textbf{Not a Representative Body}: The critics have argued that the Constituent  Assembly was not a representative body as its members were not directly elected by the people of India on the basis of \index{universal adult franchise}.
  ...
  \item \textbf{Time Consuming}: According to the critics, the Constituent Assembly took unduly long time to make the Constitution. They stated that the framers of the American Constitution took only four months to complete their work. In this context, \gls{person:NaziruddinAhmedKGQ}, a member of the Constituent Assembly, coined a new name for the \gls{committee:DraftingCommitteeIGI} to show his contempt for it. He called it a \quotedouble{Drifting Committee}.
  \item \textbf{Dominated by Congress}: The critics charged that the Constituent Assembly was dominated by the Congress party. \gls{person:GranvilleAustinfCH}, a British Constitutional expert, remarked: \quotesingle{The Constituent Assembly was a one-party body in an essentially one-party country. The Assembly was the Congress and the Congress was India}\footnote{\gls{person:GranvilleAustinfCH}, The Indian Constitution—Cornerstone of a Nation, Oxford, 1966, P. 8.}.
  ...
  \item \textbf{Dominated by Hindus}: According to some critics, the Constituent Assembly was a Hindu dominated body. \gls{person:LordViscountSimonoD8} called it \quotesingle{a body of Hindus}. Similarly, \gls{person:WinstonChurchillWjM} commented that the Constituent Assembly represented \quotesingle{only one major community in India}.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \gls{person:SirBNRauWaW} was appointed as the constitutional advisor (Legal advisor) to the Constituent Assembly.
  \item \gls{person:HVRIyengarZQ0} was the Secretary to the Constituent Assembly.
  \item \gls{person:SNMukerjeebkA} was the chief draftsman of the constitution in the Constituent Assembly.
  \item \gls{person:PremBehariNarainRaizadaCDa} was the calligrapher of the Indian Constitution. The original constitution was handwritten by him in a flowing italic style.
  \item The original version was beautified and decorated by artists from Shantiniketan including \gls{person:NandLalBose5O1} and \gls{person:BeoharRammanoharSinhavIo}.
  \item \gls{person:BeoharRammanoharSinhavIo} illuminated, beautified and ornamented the original Preamble calligraph-ed by \gls{person:PremBehariNarainRaizadaCDa}.
  \item The calligraphy of the Hindi version of the original constitution was done by \gls{person:VasantKrishanVaidyaemU} and elegantly decorated and illuminated by \gls{person:NandLalBose5O1}.
\end{enumerate}
...
\begin{longtable}[c]{@{}|ll|l|c|@{}}
  \caption{State wise Membership of the Constituent Assembly of India as on \gls{date:December311947KPZ}}
...
It should be notes al the outset that a number of original features of the Constitution (as adopted in 1949) have undergone a substantial change, on account of several amendments, particularly 7th, 42nd, 44th, 73rd, 74th and 97th Amendments. In fact, the 42nd Amendment Act (1976) is known as \quotesingle{Mini-Constitution} due to the important and large number of changes made by it in various parts of the Constitution. However, in the {\colord \textit{\gls{person:KeshavanandaBharti66U}}} case\footnote{Kesavananda Bharati vs State of Kerala, (1973)} (1973), the Supreme Court rules that the constitution power of Parliament under Article 368 does not enable it to alter the \quotesingle{basic structure} of the Constitution.
...
\begin{enumerate}
  ...
  \item Historical factors, e.g., the influence of the \index{Acts!Government of India Act of 1935}, which was bulky.
...
The Constitution of India has borrowed most of its provisions from the constitutions of various other countries as well as from the Government of India Act\footnote{About 250 provisions of the 1935 Act have been included in the Constitution.} of 1935. \gls{person:DrBRAmbedkarls6} proudly acclaimed that the Constitution of India has been framed after \quotesingle{ransacking all the known Constitution of the World\footnote{Constituent Assembly Debates, Volume VII, P. 35–38.}}.

The structural part of the Constitution is, to a large extent, derived from the \index{Acts!Government of India Act of 1935}. The philosophical part of the Constitution (the \index{Fundamental Rights} and the Directive Principles of State Policy) derive their inspiration from the American and Irish Constitution respectively. The political part of the Constitution (the principle of Cabinet Government and the relation between the executive and the legislature) have been largely drawn from the British Constitution\footnote{P M Bakshi, The Constitution of India, Universal, Fifth Edition, 2002, P.4.}.

The other provision of the Constitution have been drawn from the constitutions of Canada, Australia, Germany, USSR (now Russia), France, South Africa, Japan, and so on\footnote{See Table 3.4 at the end of this chapter.}.
...
The Constitution of India establishes a federal system of government. It contains all the usual features of a federation, viz., two government, division of powers, written Constitution, supremacy of Constitution, rigidity of Constitution, independent judiciary and \index{bicameralism}.
...
Moreover, the term \quotesingle{Federation} has nowhere been used in the Constitution. Article 1, on the other hand, describes India as a \quotesingle{Union of States} which implies two things: one, Indian Federation is not the result of an agreement by the states; and two, no state has the right to secede from the federation.

Hence, the Indian Constitution has been variously described a \quotesingle{federal in form but unitary in spirit}, \quotesingle{quasi-federl} by \gls{person:KCWhearexCr}, \quotesingle{bargaining federalism} by \gls{person:MorrisJonesChd}, \quotesingle{co-operative federalism} by \gls{person:GranvilleAustinfCH}, \quotesingle{federation with a centralizing tendency} by \gls{person:IvorJenningsmEO}, and so on.
...
In a parliament system whether in India or Britain, the role of the Prime Minister has become so significant and crucial that the political scientists like to call its a \quotesingle{Prime Ministerial Government}.
...
Just as the Indian parliamentary system differs from the British system, the scope of judicial review power of the Supreme Court in India is narrower than that of what exists in US. This is because the American Constitution provides for \quotesingle{due process of law} against that of \quotesingle{procedure established by law} contained in the Indian Constitution (Article 21).
...
\subsection{\index{Fundamental Rights}}

Part III of the Indian Constitution guarantees six\footnote{Originally, the Constitution provided for seven \index{Fundamental Rights}. However, the Right to Property (Article 31) was deleted from the list of \index{Fundamental Rights} by the 44th Amendment Act of 1978. It is made a legal right under Article 300-A in Part XII of the constitution.} fundamental rights to all the citizens
...
The \index{Fundamental Rights} are meant for promoting the idea of political democracy. They operate as limitations on the tyranny of the executive and arbitrary laws of the legislature. They are justiciable in nature, that is they are enforceable by the courts for their violation. The aggrieved person can directly go to the Supreme Court which can issue the writs of {\colord habeas corpus}, {\colord mandamus}, prohibition, {\colord certiorari} and {\colord quo warranto} for the restoration of his rights.

However, the \index{Fundamental Rights} are not absolute the subject to reasonable restrictions. Further, they are not sacrosanct and can be curtailed or repealed by the Parliament through a constitutional amendment act. They can also be suspended during the operation of National Emergency except the rights guaranteed by Article 20 and 21.

\subsection{Directive Principles of State Policy}

According to \gls{person:DrBRAmbedkarls6}, the Directive Principles of State Policy is a \quotesingle{novel feature} of the Indian Constitution. They are enumerated in Part IV of the Constitution. They can be classified into three broad categories — socialistic, Gandhian and liberal-intellectual.

The directive principles are meant for promoting the idea of social and economic democracy. They seek to establish a \quotesingle{welfare state} in India. However, unlike the \index{Fundamental Rights}, the directives are non-justifiable in nature, that is, they are not enforceable by the courts for their violation. Yet, the Constitution itself declares that \quotesingle{these principles are fundamental in the governance of the country and it shall be the duty of the state to apply these principles in making laws}. Hence, they impose a moral obligation on the state authorities for their application. But, the real force (sanction) behind them is political, that is, public opinion.

In the {\colord \textit{Minerva Mills}} case\footnote{Minerva Mills v.Union of India, (1980).} (1980), the Supreme Court held that \quotesingle{the Indian Constitution is founded on the bedrock of the balance between the \index{Fundamental Rights} and the Directive Principles}.

\subsection{Fundamental Duties}

The original constitution did not provide for the fundamental duties of the citizens. These were added during the operation of internal emergency(1975-77) by the 42nd Constitutional Amendment Act of 1976 on the recommendation of the \gls{committee:SwaranSinghCommittee0Hn}. The 86the Constitutional Amendment Act of 2002 added one more fundamental duty.
...
\renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
\begin{enumerate}
  \item The term \quotesingle{secular} was added to the Preamble of the Indian Constitution by the 42nd Constitutional Amendment Act of 1976.
...
Moreover, the Constitution has also abolished the old system of \index{communal representation}\footnote{The 1909, 1919, and 1935 Acts provided for \index{communal representation}.}, that is, reservation of seats in the legislature on the basis of religion. However, it provides for the temporary reservation of seats for the scheduled castes and scheduled tribes to ensure adequate representation to them.

\subsection{Universal \index{Adult Franchise}}

The Indian Constitution adopts \index{universal adult franchise} as a basis of elections to the Lok Shabha and the state legislative assemblies. Every citizen who is not less then 18 years of age has a right to vote without any discrimination of caste, race, religion, sex, literacy, wealth, and so on. The voting age was reduced to 18 years from 21 years in 1989 by the 61st Constitutional Amendment Act of 1988.

The Introduction of \index{universal adult franchise} by the Constitution-makers was bold experiment and highly remarkable in view of the vast size of the country, its huge population, high poverty, social inequality and overwhelming illiteracy.\footnote{Even in the western countries, the right to vote was extended only gradually. For example, USA gave franchise to women in 1920, Britain in 1928, USSR (now Russia) in 1936, France in 1945, Italy in 1948 and Switzerland in 1971.}
...
\renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
\begin{enumerate}
  \item National emergency on the ground of war or externam aggression or armed rebellion\footnote{The 44th Amendment Act (1978) has replaced the original term \quotesingle{internal
      disturbance} by the new term \quotesingle{armed rebellion}.} (Article 352)
...
\begin{enumerate}
  ...
  \item It added a new Part IX-B in the Constitution which is entitled as \quotedouble{The Co-operative societies} (Article 243-ZH to 243-ZT).
\end{enumerate}
...
The critics opined that the Indian Constitution contains nothing new and original. They described it as a \quotesingle{borrowed constitution} or a \quotesingle{bag of borrowings} or a \quotesingle{hotch-potch constitution} or a \quotesingle{patchwork} of several documents of the world constitutions. However, this criticism is unfair and illogical. This is because, the framers of the constitution made necessary modification in the features borrowed from other constitutions for their suitability to the Indian conditions, at the same time avoiding their faults.

While answering the above criticism in the Constituent Assembly, \gls{person:DrBRAmbedkarls6}, the Chairman of the \gls{committee:DraftingCommitteeIGI}, said: \quotedouble{One likes to ask whether there can be antthin new in Constitution framed at this hour in the history of the world. More than hundred years have rolled over when the first written constitution was drafted. It has been followed by many countries reducing their constitution to writing. What the scope of a constitution should be has long been settled. Similarly, what are the fundamentals of a constitution are recognized all over the world. Given these facts, all constitutions in thir main provision must look similar. The only new things, if there can be any, in a constitution framed so late in the day are the variations made to remove the faults and to accommodate it to the needs of country. The charge of providing a blind copy of the constitutions of other countries is based, I am sure, on an inadequate study of the Constitution}\footnote{Constituent Assembly Debates, Volume VII, pp.35-38.}.

\paragraph{A Carbon Copy of the 1935 Act}

The critics said that the framers of the constitution have included a large number of the provision of the \index{Acts!Government of India Act of 1935} into the Constitution of India. Hence, they called the constitutions a \quotedouble{Carbon Copy of the 1935 Act} or an \quotedouble{amended version of the 1935 Act}. For example, \gls{person:NShrinivasanVPV} observed that the Indian Constitution is \quotedouble{both in language and substance a close copy of the Act of 1935}. Similarly, Sir \gls{person:IvorJenningsmEO}, a British Constitutionalist, said that \quotedouble{the constitution derives directly from the \index{Acts!Government of India Act of 1935} from which, in fact, many of its provisions are copied almost textually}.

Further, \gls{person:PRDeshmukhZtf}, a member of the Constituent Assembly, commented that \quotedouble{the constitution is essentially the \index{Acts!Government of India Act of 1935} with only adult franchise added}.

The same \gls{person:DrBRAmbedkarls6} answered the above criticism in the Constituent Assembly in the following way: \quotedouble{As to the accusation that the Draft Constitution has reproduced a good part of the provision of the Government of India Act, 1935, I make no apologies. There is nothing to be ashamed of in borrowing. It involves no plagiarism. Nobody hold any patent rights in the fundamental ideas of a Constitution. What I am sorry about is that the provision taken from the Government of India Act, 1935, relate mostly to the details of administration}\footnote{Ibid.}.

\paragraph{Un-Indian or Anti-India}

According to the critics, the Indian Constitution is \quotesingle{un-Indian} or \quotesingle{anti-Indian} because it does not reflect the political tradition and the spirit of India. They said that the foreign nature of the Constitution makes it unsuitable to the Indian situation or unworkable in India. In this context, \gls{person:KHanumanthaiyaU1L}, a member of the Constituent Assembly, commented: \quotedouble{We wanted the music of Veena or Sitar, but here we have the music of an English band. That was because out constitution-makers were educated that way}\footnote{Constituent Assembly Debates, Volume XI, P.616.}. Similarly, \gls{person:KHanumanthaiyaU1L}, another member of the Constituent Assembly, criticized the constitution as \quotedouble{slavish imitation of the west, much more - a slavish surrender to the west}\footnote{Constituent Assembly Debates, Volume VII, P.242.}. Further, \gls{person:LaxminarayanSahuuxO}, also a member of Constituent Assembly, observed: \quotedouble{The ideals on which this draft constitution is framed have no manifest relation to the fundamental spirit of India. This constitution would not prove suitable and would break down soon after being brought into operation}\footnote{Constituent Assembly Debates, Volume XI, P.613.}.

\paragraph{An Un-Gandhian Constitution}

According to the critics, the Indian Constitution is Un-Gandhian because it does not contain the philosophy and ideals of \gls{person:MahatmaGandhivNF}, the father of the Indian Nation. They opined that the Constitution should have been raised and build upon village panchayats. In this context, the same member of the Constituent Assembly, \gls{person:KHanumanthaiyaU1L}, said: \quotedouble{That is exactly the kind of Constitution \gls{person:MahatmaGandhivNF} did not want and did not envisage}.\footnote{Constituent Assembly Debates, Volume XI, P.617.} \gls{person:TPrakasamKE8}, another member of the Constituent Assembly, attributed this lapse to \gls{person:DrBRAmbedkarls6}'s non-participation in the Gandhian movement and the antagonism towards Gandhian ideas\footnote{Constituent Assembly Debates, Volume VII, P.387.}.

\paragraph{Elephantine Size}

The critics stated that the Indian Constitution is too bulky and too detailed and contains some unnecessary elements. Sir \gls{person:IvorJenningsmEO}, a British Constitutionalist, observed that the provisions borrowed were not always well-selected and that the constitution, generally speaking, was too long and complicated.\footnote{\gls{person:IvorJenningsmEO}, Some Characteristics of the Indian Constitution, Oxford University Press, Madras, 1953, PP.9-16.}

In this context, \gls{person:HVKamathW3y}, a member of the Constituent Assembly, commented: \quotedouble{The emblem and the crest we have selected for our assembly is an elephant. It is perhaps in consonance with that our constitution too is the bulkiest in the world has produced}.\footnote{Constituent Assembly Debates, Volume VII, P.1042.} He also said: \quotedouble{I am sure, the House does not agree that we should make the Constitution an elephantine one}.\footnote{Constituent Assembly Debates, Volume VIII, P.127.}

\paragraph{Paradise of the Lawyers}

According to the critics, the Indian Constitution is too legalistic and very complicated. They opined that the legal language and phraseology adopted in the constitution makes it a complex document. The same Sir \gls{person:IvorJenningsmEO} called it a \quotedouble{lawyer's paradise}.

In this context, \gls{person:HKMaheswariPG1}, a member of the Constituent Assembly observed: \quotedouble{The draft tends to make people more litigious, more inclined to go to courts, less truthful and less likely to follow the methods of truth and non-violence. If I may so, the Draft is really a lawyer's paradise. It opens up vast avenues of litigation and will give our able and ingenious lawyers plenty of work to do}.\footnote{Constituent Assembly Debates, Volume VII, P.293.}

Similarly, \gls{person:PRDeshmukhZtf}, another member of the Constituent Assembly, said: \quotedouble{I should, however, like to say that the draft of the articles that have been brought before the House by \gls{person:DrBRAmbedkarls6} seems to my mind to be far too ponderous like the ponderous tomes of a law manual. A document dealing with a constitution hardly uses so much of padding and so much of verbiage. Perhaps it is difficult for them to compose a document which should be, to my mind, not a law but a socio-political document, a vibration, pulsating and life giving document. But to our misfortune, that was not to be, and we have been burdened with so much of words, words and words which could have been very easily eliminated}.\footnote{Constituent Assembly Debates, Volume IX, P.613.}
...
\begin{longtable}[c]{@{}|c|l|l|@{}}
  ...
  III & \index{Fundamental Rights} & 12 to 35 \\\midrule
...
The American Constitution was the first to begin with a Preamble. Many countries, including India, followed this practice. The term \quotesingle{preamble} refers to the introduction or preface to the Constitution. It contains the summary or essence of the Constitution. \gls{person:NAPalkivala8CA}, an eminent jurist and constitutional expert, called the Preamble as the \quotesingle{identity card of the Constitution.}

The Preamble to the Indian Constitution is based on the \quotesingle{\index{Objectives Resolution}}, draft and moved by \gls{person:JawaharlalNehruLrI}, and adopted by the Constituent Assembly\footnote{1}. It has been amended by the 42nd Constitutional Amendment Act (1976), which added three new words — socialist, secular and integrity.
...
\begin{enumerate}
  ...
  \item \textbf{Date of adoption of the Constitution}: It stipulates \gls{date:November261949Hl8} as the date.
\end{enumerate}
...
The word \quotesingle{sovereign} implies that India is neither a dependency nor a dominion of any other nation, but an independent state\footnote{2}. There is no authority above it, and it is free to conduct its own affairs (both internal and external).
...
Even before the term was added by the 42nd Amendment in 1976, the Constitution had a socialist content in the form of certain Directive Principles of State Policy. In other words, what was hitherto implicit in the Constitution has now been made explicit. Moreover, the Congress party itself adopted a resolution\footnote{5} to establish a \quotesingle{socialistic pattern of society} in its Avadi session as early as in 1955 and took measures accordingly. Notably, the Indian brand of socialism is a \quotesingle{democratic socialism} and not a \quotesingle{communistic socialism} (also known as \quotesingle{state socialism}) which involves the nationalisation of all means of production and distribution and the abolition of private property. Democratic socialism, on the other hand, holds faith in a \quotesingle{mixed economy} where both public and private sectors co-exist side by side\footnote{6}. As the Supreme Court says, \quotesingle{Democratic socialism aims to end poverty, ignorance, disease and inequality of opportunity\footnote{7}. Indian socialism is a blend of Marxism and Gandhi-ism, leaning heavily towards Gandhian socialism}. The new economic policy (1991) of liberalization, privatization and globalization has, however, diluted the socialist credentials of the Indian State.
