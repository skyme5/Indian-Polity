...
In a bid to rectify the defects of the Regulating Act of 1773\index{Acts!Regulating Act of 1773}, the British Parliament passed the Amending Act of 1781\index{Acts!Amending Act of 1781}, also known as the Act of Settlement\index{Acts!Act of Settlement}. The next important act was the Pitt's India Act\endnote{It was introduced in the British Parliament by the then Prime Minister, \gls{person:WilliamPittC17}} of 1784.
...
\paragraph{Features of the Act}
\begin{enumerate}
  \item It provided that India henceforth was to be governed by, and in the name of, Her Majesty. It changed the designation of th Governor-General of India to that of Viceroy of India. He (viceroy) was the direct representative of the British Crown in India. \gls{person:LordCanningVLN} thus became first Viceroy of India.
...
\begin{enumerate}
  ...
  \item It also provided for the establishment of new legislative councils for Bengal, \gls{NorthWesternFrontierProvinceUyA} (NWFP) and Panjab, which were established in 1862, 1866 and 1897 respectively.
  \item It empowered the Viceroy to make rules and orders for the more convenient transaction of business in the council. It also gave a recognition to the  `portfolio' system, introduced by \gls{person:LordCanningVLN}\gls{person:LordCanningVLN} in 1859. Under this, a member of the Viceroy's council was made in-charge of one or more departments of the government and was authorized to issue final orders on behalf of the council on matters of his department(s).
...
This Act is also known as Morley-Minto Reforms (Lord Morley was the then Secretary of State for India and \gls{person:LordMintoggn} was the then Viceroy of India).
\begin{enumerate}
  ...
  \item It provided (for the first time) for the association of Indians with the executive Councils of the Viceroy and Governors. \gls{person:SatyendraPrasadSinhaVIV} became the first Indian to join the Viceroy's Executive Council. He was appointed as the law member.
  \item It introduced a system of communal representation\index{communal representation} for Muslims by accepting the concept of `\gls{SeparateElectoratea8c}'. Under this, the Muslim members were to be elected only by Muslim voter. Thus, the Act `legalized communal-ism' and \gls{person:LordMintoggn} came to be known as the Father of Communal Electorate.
...
On Feburary 20, 1947\index{1947-02-20}, the British Prime Minister \gls{person:ClementAtleegVz} declared that the British rule in India would end by \gls{date:June2019488Jb}\index{1948-06-20}; after which the power would be transferred to responsible Indian hands. This announcement was followed by the agitation by the Muslim League demanding partition of the country. Again on June 03, 1947\index{1947-06-03} the British Government made it clear that any Constitution framed by the Constituent Assembly of India (formed in 1946) cannot apply to those parts of the country which were unwilling to accept it. On the same day (June 03, 1947\index{1947-06-03}), \gls{person:LordMountbettenPim}, the viceroy of India, put forth the partition plan known as the Mountbatten Plan\index{Mountbatten Plan}. The plan was accepted by the Congress and the Muslim League. Immediate effect was given to the plan by enacting the Indian Independence Act\endnote{The Indian Independence Bill was introduced in the British Parliament on July 04, 1947\index{1947-07-04} and received the Royal Assent on \gls{date:July18194764b}\index{1947-07-18}. The act came into force on \gls{date:August151947pqh}\index{1947-08-15}.} (1947).

\paragraph{Features of the Act}
\begin{enumerate}
  \item It ended the British rule in India and declared India as an independent and sovereign state from \gls{date:August151947pqh}\index{1947-08-15}.
  ...
  \item It proclaimed the lapse of British paramountcy over the Indian princely states and treaty relations with tribal areas from \gls{date:August151947pqh}\index{1947-08-15}.
  ...
  \item It discontinued the appointment to civil services and reservation of posts by the secretary of state for India. The members of the civil services appointed before \gls{date:August151947pqh}\index{1947-08-15}, would continue to enjoy all benefits that they were entitled to till that time.
\end{enumerate}

At the stroke of midnight 14-15 August, 1947, the British rule came to an end and power was transferred to the two new independent Dominions of India and Pakistan\endnote{The boundaries between the two Dominions were determined by a Boundary Commission headed by Radcliff. Pakistan included the provinces of West Punjab, Sind, Baluchistan, East Bengal, \gls{NorthWesternFrontierProvinceUyA} and the district of Sylhet in Assam. The referendum in the \gls{NorthWesternFrontierProvinceUyA} and Sylhet was in favor of Pakistan.}. \gls{person:LordMountbettenPim} became the first governor-general of the new Dominion of India. He swore in \gls{person:JawaharlalNehruRDk} as the first prime minister of independent India. The Constituent Assembly of India formed in 1946 became the Parliament of the Indian Dominion.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
  ...
  \endlastfoot
  %
  1. & \gls{person:JawaharlalNehruRDk} & External Affairs \& Commonwealth \\
     &                           & Relations \\
  2. & \gls{person:SardarVallabhbhaiPatelWiG} & Home, Information \& Broadcasting \\
  3. & \gls{person:DrRajendraPrasadOBz} & Food \& Agriculture \\
  4. & \gls{person:DrJohnMathai0Si} & Industries \& Supplies \\
  5. & \gls{person:JagjivanRamb3W} & Labor \\
  6. & \gls{person:SardarBaldevSinghvUP} & Defense \\
  7. & \gls{person:CHBhabha087} & Works, Mines \& Power \\
  8. & \gls{person:LiaquatAliKhanMpQ} & Finance \\
  9. & \gls{person:AbdurRabNishtarf3M} & Posts \& Air \\
  10. & \gls{person:AsafAliavC} & Railways \& Transport \\
  11. & \gls{person:CRajagopalachariaQC} & Education \& Arts \\
  12. & \gls{person:IIChundrigar80L} & Commerce \\
  13. & \gls{person:GhaznafarAliKhaneRD} & Health \\
  14. & \gls{person:JoginderNathMandal5pY} & Law \\* \bottomrule
\end{longtable}
\textit{\textbf{Note}}: The members of the interim government were members of the Viceroy's Executive Council. The Viceroy continues to be the head of the Council. But, \gls{person:JawaharlalNehruRDk} was designated as the Vice-President of the Council.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
	...
	\endlastfoot
	%
	1. & \gls{person:JawaharlalNehruRDk} & Prime Minister; External Affairs \& Commonwealth \\
	&                           & Relations; Scientific Research \\
	2. & \gls{person:SardarVallabhbhaiPatelWiG} & Home, Information \& Broadcasting; States \\
	3. & \gls{person:DrRajendraPrasadOBz} & Food \& Agriculture \\
	4. & \gls{person:MaulanaAbulKalamAzadrfo} & Education \\
	5. & \gls{person:DrJohnMathai0Si} & Railway \& Transport \\
	6. & \gls{person:RKShanmughamTzJ} & Finance \\
	7. & \gls{person:DrBRAmbedkarRIM} & Law \\
	8. & \gls{person:JagjivanRamb3W} & Labor \\
	9. & \gls{person:SardarBaldevSinghvUP} & Defense \\
	10. & \gls{person:RajKumariAmritKaurB8j} & Health \\
	11. & \gls{person:CHBhabha087} & Commerce \\
	12. & \gls{person:RafiAhmedKidwaiyPF} & Communication \\
	13. & \gls{person:DrShyamaPrasadMukherjiTws} & Industries \& Supplies \\
	14. & \gls{person:VNGadgiltp9} & Works, Mines \& Power \\* \bottomrule
\end{longtable}
...
It was in 1934\index{1934} that the idea of a Constituent Assembly for India was put forward for the first time by \gls{person:MNRoyVTo}, a pioneer of communist movement in India. In 1935\index{1935}, the Indian National Congress (INC), for the first time, officially demanded a Constituent Assembly to frame the Constitution of free India. In 1938\index{1938}, \gls{person:JawaharlalNehruRDk}, on behalf of the INC declared that `the Constitution of free India must be framed, without outside interference, by a Constituent Assembly elected on the basis of adult franchise'.

The demand was finally accepted in principle by the British Government in what is known as the `August Offer' of 1940. In 1942\index{1942}, \gls{person:SirStaffordCrippsYBj}, a member of the cabinet, came India with a draft proposal of the British Government on the framing of an independent Constitution to be adopted after the World War II. The Cripps Proposals were rejected by the Muslim League which wanted India to be divide into two autonomous states with two separate Constituent Assemblies. Finally, a Cabinet Mission\endnote{The Cabinet Mission consisting of three members (Lord Pethick Lawrence, \gls{person:SirStaffordCrippsYBj} and A V Alexander) arrived in India on \gls{date:March241946Qac}\index{1946-03-24}. The Cabinet Mission published its plan on \gls{date:May161946Z7X}\index{1946-05-16}.} was sent to India. While it rejected the idea of two Constituent Assemblies, it put forth a scheme for the Constituent Assembly which more or less satisfied the Muslim League.
...
Although the Constituent Assembly was not directly elected by the people of India on the basis of adult franchise, the Assembly comprised representatives of all section of Indian Society - Hindus, Muslims, Sikhs, Parsis, Anglo-Indians, Indian Christians, SCs, STs including women of all these sections. The Assembly included all important personalities of India at that time, with the exception of \gls{person:MahatmaGandhind1}.

\section{Working of the Constituent Assembly}

The Constituent Assembly held its first meeting on December 09, 1946\index{1946-12-09}. The Muslim League boycotted the meeting and insisted on a separate state of Pakistan. The meeting was thus attended by only 211 members. {\colord{}\gls{person:DrSachchidanandSinha4tS}, the oldest member, was elected as the temporary President of the Assembly, following the French practice.}

Later, \gls{person:DrRajendraPrasadOBz} was elected as the President of the Assembly. Similarly, both \gls{person:HCMukherjeekP8} and \gls{person:VTKrishnamachi5XI} were elected as the Vice-Presidents of the Assembly. In other words, the Assembly had two Vice-Presidents.

\paragraph{Objectives Resolution\index{Objectives Resolution}}

On \gls{date:December131946X8r}\index{1946-12-13}, \gls{person:JawaharlalNehruRDk} moved the historic `Objectives Resolution\index{Objectives Resolution}' in the Assembly. It laid down the fundamentals and philosophy of the constitutional structure. It read:
...
\begin{enumerate}
  ...
  \item The Assembly also became a legislative body. In other words, two separate functions were assigned to the Assembly, that is, making of a constitution for free India and enacting of ordinary laws for the country. These two tasks were to be performed on separate days. Thus, the Assembly became the first Parliament of free India (Dominion Legislature). Whenever the Assembly met as the Constituent body it was chaired by \gls{person:DrRajendraPrasadOBz} and when it met as the legislative body\endnote{For the first time, the Constituent Assembly met as Dominion Legislature on \gls{date:November171947HuY}\index{1947-11-17} and elected \gls{person:GVMavalankarmLM} as its speaker.}, it was chaired by \gls{person:GVMavalankarmLM}. These two functions continued till \gls{date:November261949B8D}\index{1949-11-26}, when the task of making the Constitution was over.
  \item The Muslim League members (hailing from the areas\endnote{These are West Punjab, East Bengal, NWFP, Sindh, Baluchistan and Sylhet District of Assam. A separate Constituent Assembly was set up for Pakistan.} included in the Pakistan) withdrew from the Constituent Assembly for India. Consequently, the total strength of the Assembly came down to 299 as against 389 originally fixed in 1946 under the Cabinet Mission Plan. The strength of the Indian provinces (formerly British Provinces) was reduced from 296 to 299 and those of the princely states from 93 to 70. The state-wise membership of the Assembly as on \gls{date:December311947uKX}\index{1947-12-31}, is shown in \ref{tab:StateWiseMemberShipAssembly} at the end of this chapter.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item It elected \gls{person:DrRajendraPrasadOBz} as the first President of India on January 24, 1950\index{1950-01-24}.
\end{enumerate}
...
On January 24, 1950\index{1950-01-24}, the Constituent Assembly held its final session. It however, did not end, and continued as the provisional parliament of India from January 26, 1950\index{1950-01-26} till the formation of new Parliament\endnote{The Provisional Parliament ceased to exist on \gls{date:April171952BtR}\index{1952-04-17}. The first elected Parliament with the two Houses came into being in 1952\index{1952-05}.} after the first general elections in 1951-52.
...
\begin{enumerate}
  \item \gls{committee:UnionPowersCommitteeALp} - \gls{person:JawaharlalNehruRDk}
  \item \gls{committee:UnionConstitutionCommitteeBXu} - \gls{person:JawaharlalNehruRDk}
  \item \gls{committee:ProvincialConstitutionCommittee6A1} - \gls{person:SardarVallabhbhaiPatelWiG}
  \item \gls{committee:DraftingCommitteebGD} - \gls{person:DrBRAmbedkarRIM}
  \item \gls{committee:AdvisoryCommittee8Sv} on Fundamental Rights\index{Fundamental Rights}, Minorities and Tribal and Excluded Areas - \gls{person:SardarVallabhbhaiPatelWiG}. This committee had the following five sub-committees:
  \begin{enumerate}
    \item \gls{committee:FundamentalRightsSubCommitteePyg} - \gls{person:JBKripalanix7H}
    \item \gls{committee:MinoritiesSubCommitteeIAA} - \gls{person:HCMukherjeekP8}
    \item \gls{committee:NorthEastFrontierTribunalAreasSubCommittee3q4} (with Assam Excluded \& Partially Excluded Areas) - \gls{person:GopinathBardoloiVH7}
    \item \gls{committee:ExcludedandPartiallyExcludedAreaspvS} Other than those in Assam Sub Committee - \gls{person:AVThakkarvNp}
    \item \gls{committee:NorthWestFrontierTribalAreasSubCommitteecby}\endnote{One of the political consequences of the British Government’s statement of May 03, 1947\index{1947-05-03}, was that following a referendum, the North-West Frontier Province and Baluchistan became part of the territory of the Dominion of Pakistan and as a result the tribal areas in this region became a concern of that Dominion. The Sub-Committee on the Tribal Areas in the North-West Frontier Province and Baluchistan was not therefore called upon to function on behalf of the Constituent Assembly of India. (B. Shiva Rao, The Framing of India’s Constitution : Select Documents, Volume III, P.681.) The members of this Sub-Committee were : Khan Abdul Ghaffar Khan, Khan Abdul Samad Khan and Mehr Chand Khanna. The information about the Chairman is not found.}
  \end{enumerate}
  
  \item \gls{committee:RulesofProcedureCommitteeRfQ} - \gls{person:DrRajendraPrasadOBz}
  \item \gls{committee:StatesCommitteeCommitteeforNegotiatingwithStates4Pv} - \gls{person:JawaharlalNehruRDk}
  \item \gls{committee:SteeringCommitteeUL6} - \gls{person:DrRajendraPrasadOBz}
\end{enumerate}

\subsection{Minor Committees}

\begin{enumerate}
  \item \gls{committee:FinanceandStaffCommitteeh1X} - \gls{person:DrRajendraPrasadOBz}
  \item \gls{committee:CredentialsCommittee3FV} - \gls{person:AlladiKrishnaswamiAyyarQDs}
  \item \gls{committee:HouseCommitteed1G} - \gls{person:BPattabhiSitaramayyaZ2n}
  \item \gls{committee:OrderofBusinessCommittee9UF} - \gls{person:DrKMMunshiVRQ}
  \item \gls{committee:AdhocCommitteeontheNationalFlag9mw} - \gls{person:DrRajendraPrasadOBz}
  \item \gls{committee:CommitteeontheFunctionsoftheConstituentAssembly2Vc} - \gls{person:GVMavalankarmLM}
  \item \gls{committee:AdhocCommitteeontheSupremeCourtldC} - \gls{person:SVaradachariTzr} (Not an Assembly Member)
  \item \gls{committee:CommitteeonChiefCommissionersProvinceswGG} - \gls{person:BPattabhiSitaramayyaZ2n}
  \item \gls{committee:ExpertCommitteeontheFinancialProvisionsoftheUnionConstitutionuBp} - \gls{person:NaliniRanjanSarkarXH4} (Not an Assembly Member)
  \item \gls{committee:LinguisticProvincesCommissionxhC} - \gls{person:SKDarcB7} (Not an Assembly Member)
  \item \gls{committee:SpecialCommitteetoExaminetheDraftConstitutionIlA} - \gls{person:JawaharlalNehruRDk}
  \item \gls{committee:PressGalleryCommittee7wg} - \gls{person:UshaNathSenMdR}
  \item \gls{committee:AdhocCommitteeonCitizenshipHpu} - \gls{person:SVaradachariTzr}
\end{enumerate}


\subsection{\gls{committee:DraftingCommitteebGD}}

Among all the committees of the Constituent Assembly, the most important committee was the \gls{committee:DraftingCommitteebGD} set up on \gls{date:August291947ZRL}\index{1947-08-29}. It was this committee that was entrusted with the task of preparing a draft of the new Constitution. It consisted of seven members. They were

\begin{enumerate}
  \item \gls{person:DrBRAmbedkarRIM} ({\colord Chairmen})
  \item \gls{person:NGopalaswamyAyyangarl6q}
  \item \gls{person:AlladiKrishnaswamiAyyarQDs}
  \item \gls{person:DrKMMunshiVRQ}
  \item \gls{person:SayedMohammadSaadullahJL5}
  \item \gls{person:NMadhavaRauTs4} (He replaced \gls{person:BLMitterpFI} who resined due to ill-health)
  \item \gls{person:TTKrishnamachariqBq} (He replaced \gls{person:DPKhaitan64w} who died in 1948)
\end{enumerate}

The \gls{committee:DraftingCommitteebGD}, after taking into consideration the proposal of the various committees, prepared the first draft of the Constitution of India, which was published in 1948\index{1948-02}. The people of India were given eight months to discuss the draft and propose amendments. In the light of the public comments, criticisms and suggestions, the \gls{committee:DraftingCommitteebGD} prepared a second draft, which was published in 1948\index{1948-10}.

The \gls{committee:DraftingCommitteebGD} took less than six months to prepare its draft. In all it say for 141 days.

\section{Enactment of the Constitution}

\gls{person:DrBRAmbedkarRIM} introduced the final draft of the Constitution in the Assembly on November 04, 1948\index{1948-11-04} (first reading). The Assembly had a general discussion on it for five days (till November 09, 1948\index{1948-11-09}).

The second reading (clause by clause consideration) started on \gls{date:November151948ogl}\index{1948-11-15} and ended on \gls{date:October171949xo6}\index{1949-10-17}. During this stage, as many as 7653 amendments were proposed and 2473 were actually discussed in the Assembly.

The third reading of the draft started on \gls{date:November141949p6k}\index{1949-11-14}. \gls{person:DrBRAmbedkarRIM} moved a motion - `the Constitution as settled by the Assembly be passed'. The motion on Draft Constitution was declared as passed on \gls{date:November261949B8D}\index{1949-11-26}, and received the signatures of the members and the president. Out of a total 299 members of the Assembly, only 284 were actually present on that day and signed the Constitution. This is also the date mentioned in the Preamble as the date on which the people of India in the Constituent Assembly adopted, enacted and gave to themselves this Constitution.

{\colord The Constitution as adopted on \gls{date:November261949B8D}\index{1949-11-26}, contained a Preamble, 395 Articles and 8 Schedules}. The Preamble was enacted after the entire Constitution was already enacted.

\gls{person:DrBRAmbedkarRIM}, the then Law Minister, piloted the Draft Constitution in the Assembly. He took a very prominent part in the deliberations of the Assembly. He was known for his logical, forceful and persuasive arguments on the floor of the Assembly. He is recognized as the `Father of the Constitution of India'. This brilliant writer, constitutional expert, undisputed leader of the scheduled castes and the `chief architech of the Constitution of India' is also known as a `Modern Manu'.

\section{Enforcement of the Constitution}

Some provisions of the Constitution pertaining to citizenship, elections, provisional parliament, temporary and transitional provisions, and short title contained in Articles 5, 6, 7, 8, 9, 60, 324, 366, 367, 379, 380, 388, 391, 392 and 393 came into force on \gls{date:November261949B8D}\index{1949-11-26}, itself.
...
\begin{enumerate}
  ...
  \item \textbf{Time Consuming}: According to the critics, the Constituent Assembly took unduly long time to make the Constitution. They stated that the framers of the American Constitution took only four months to complete their work. In this context, \gls{person:NaziruddinAhmedaAp}, a member of the Constituent Assembly, coined a new name for the \gls{committee:DraftingCommitteebGD} to show his contempt for it. He called it a \enquote{Drifting Committee}.
  \item \textbf{Dominated by Congress}: The critics charged that the Constituent Assembly was dominated by the Congress party. \gls{person:GranvilleAustinF1z}, a British Constitutional expert, remarked: `The Constituent Assembly was a one-party body in an essentially one-party country. The Assembly was the Congress and the Congress was India'\endnote{\gls{person:GranvilleAustinF1z}, The Indian Constitution—Cornerstone of a Nation, Oxford, 1966, P. 8.}.
  ...
  \item \textbf{Dominated by Hindus}: According to some critics, the Constituent Assembly was a Hindu dominated body. \gls{person:LordViscountSimon3EE} called it `a body of Hindus'. Similarly, \gls{person:WinstonChurchillPDF} commented that the Constituent Assembly represented `only one major community in India'.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \gls{person:SirBNRauX7M} was appointed as the constitutional advisor (Legal advisor) to the Constituent Assembly.
  \item \gls{person:HVRIyengar383} was the Secretary to the Constituent Assembly.
  \item \gls{person:SNMukerjeeP9X} was the chief draftsman of the constitution in the Constituent Assembly.
  \item \gls{person:PremBehariNarainRaizada6lK} was the calligrapher of the Indian Constitution. The original constitution was handwritten by him in a flowing italic style.
  \item The original version was beautified and decorated by artists from Shantiniketan including \gls{person:NandLalBoseefF} and \gls{person:BeoharRammanoharSinhamGJ}.
  \item \gls{person:BeoharRammanoharSinhamGJ} illuminated, beautified and ornamented the original Preamble calligraph-ed by \gls{person:PremBehariNarainRaizada6lK}.
  \item The calligraphy of the Hindi version of the original constitution was done by \gls{person:VasantKrishanVaidyadsV} and elegantly decorated and illuminated by \gls{person:NandLalBoseefF}.
\end{enumerate}
...
\begin{longtable}[c]{@{}|p{1cm}p{1cm}|p{6cm}|p{4cm}|@{}}
  \caption{State wise Membership of the Constituent Assembly of India as on \gls{date:December311947uKX}\index{1947-12-31}}
...
It should be notes al the outset that a number of original features of the Constitution (as adopted in 1949) have undergone a substantial change, on account of several amendments, particularly 7th, 42nd, 44th, 73rd, 74th and 97th Amendments. In fact, the 42nd Amendment Act of 1976, is known as `Mini-Constitution' due to the important and large number of changes made by it in various parts of the Constitution. However, in the {\colord \textit{\gls{person:KeshavanandaBhartiUcC}}} case\endnote{Kesavananda Bharati vs State of Kerala, (1973)} (1973), the Supreme Court rules that the constitution power of Parliament under Article 368 does not enable it to alter the `basic structure' of the Constitution.
...
The Constitution of India has borrowed most of its provisions from the constitutions of various other countries as well as from the Government of India Act\endnote{About 250 provisions of the 1935 Act have been included in the Constitution.} of 1935. \gls{person:DrBRAmbedkarRIM} proudly acclaimed that the Constitution of India has been framed after `ransacking all the known Constitution of the World\endnote{Constituent Assembly Debates, Volume VII, P. 35–38.}'.
...
Hence, the Indian Constitution has been variously described a `federal in form but unitary in spirit', `quasi-federl' by \gls{person:KCWheare8RY}, `bargaining federalism' by \gls{person:MorrisJonesTI9}, `co-operative federalism' by \gls{person:GranvilleAustinF1z}, `federation with a centralizing tendency' by \gls{person:IvorJenningsGbT}, and so on.
...
According to \gls{person:DrBRAmbedkarRIM}, the Directive Principles of State Policy is a `novel feature' of the Indian Constitution. They are enumerated in Part IV of the Constitution. They can be classified into three broad categories — socialistic, Gandhian and liberal-intellectual.
...
The original constitution did not provide for the fundamental duties of the citizens. These were added during the operation of internal emergency(1975-77) by the 42nd Constitutional Amendment Act of 1976, on the recommendation of the \gls{committee:SwaranSinghCommitteeTKc}. The 86the Constitutional Amendment Act of 2002, added one more fundamental duty.
...
While answering the above criticism in the Constituent Assembly, \gls{person:DrBRAmbedkarRIM}, the Chairman of the \gls{committee:DraftingCommitteebGD}, said: \enquote{One likes to ask whether there can be antthin new in Constitution framed at this hour in the history of the world. More than hundred years have rolled over when the first written constitution was drafted. It has been followed by many countries reducing their constitution to writing. What the scope of a constitution should be has long been settled. Similarly, what are the fundamentals of a constitution are recognized all over the world. Given these facts, all constitutions in thir main provision must look similar. The only new things, if there can be any, in a constitution framed so late in the day are the variations made to remove the faults and to accommodate it to the needs of country. The charge of providing a blind copy of the constitutions of other countries is based, I am sure, on an inadequate study of the Constitution}\endnote{Constituent Assembly Debates, Volume VII, pp.35-38.}.

\paragraph{A Carbon Copy of the 1935 Act}

The critics said that the framers of the constitution have included a large number of the provision of the Government of India Act of 1935\index{Acts!Government of India Act of 1935} into the Constitution of India. Hence, they called the constitutions a \enquote{Carbon Copy of the 1935 Act} or an \enquote{amended version of the 1935 Act}. For example, \gls{person:NShrinivasanmrb} observed that the Indian Constitution is \enquote{both in language and substance a close copy of the Act of 1935}. Similarly, Sir \gls{person:IvorJenningsGbT}, a British Constitutionalist, said that \enquote{the constitution derives directly from the Government of India Act of 1935\index{Acts!Government of India Act of 1935} from which, in fact, many of its provisions are copied almost textually}.

Further, \gls{person:PRDeshmukhfXk}, a member of the Constituent Assembly, commented that \enquote{the constitution is essentially the Government of India Act of 1935\index{Acts!Government of India Act of 1935} with only adult franchise added}.

The same \gls{person:DrBRAmbedkarRIM} answered the above criticism in the Constituent Assembly in the following way: \enquote{As to the accusation that the Draft Constitution has reproduced a good part of the provision of the Government of India Act, 1935, I make no apologies. There is nothing to be ashamed of in borrowing. It involves no plagiarism. Nobody hold any patent rights in the fundamental ideas of a Constitution. What I am sorry about is that the provision taken from the Government of India Act, 1935, relate mostly to the details of administration}\endnote{Ibid.}.

\paragraph{Un-Indian or Anti-India}

According to the critics, the Indian Constitution is `un-Indian' or `anti-Indian' because it does not reflect the political tradition and the spirit of India. They said that the foreign nature of the Constitution makes it unsuitable to the Indian situation or unworkable in India. In this context, \gls{person:KHanumanthaiyaEW8}, a member of the Constituent Assembly, commented: \enquote{We wanted the music of Veena or Sitar, but here we have the music of an English band. That was because out constitution-makers were educated that way}\endnote{Constituent Assembly Debates, Volume XI, P.616.}. Similarly, \gls{person:KHanumanthaiyaEW8}, another member of the Constituent Assembly, criticized the constitution as \enquote{slavish imitation of the west, much more - a slavish surrender to the west}\endnote{Constituent Assembly Debates, Volume VII, P.242.}. Further, \gls{person:LaxminarayanSahuqns}, also a member of Constituent Assembly, observed: \enquote{The ideals on which this draft constitution is framed have no manifest relation to the fundamental spirit of India. This constitution would not prove suitable and would break down soon after being brought into operation}\endnote{Constituent Assembly Debates, Volume XI, P.613.}.

\paragraph{An Un-Gandhian Constitution}

According to the critics, the Indian Constitution is Un-Gandhian because it does not contain the philosophy and ideals of \gls{person:MahatmaGandhind1}, the father of the Indian Nation. They opined that the Constitution should have been raised and build upon village panchayats. In this context, the same member of the Constituent Assembly, \gls{person:KHanumanthaiyaEW8}, said: \enquote{That is exactly the kind of Constitution \gls{person:MahatmaGandhind1} did not want and did not envisage}.\endnote{Constituent Assembly Debates, Volume XI, P.617.} \gls{person:TPrakasamIWG}, another member of the Constituent Assembly, attributed this lapse to \gls{person:DrBRAmbedkarRIM}'s non-participation in the Gandhian movement and the antagonism towards Gandhian ideas\endnote{Constituent Assembly Debates, Volume VII, P.387.}.

\paragraph{Elephantine Size}

The critics stated that the Indian Constitution is too bulky and too detailed and contains some unnecessary elements. Sir \gls{person:IvorJenningsGbT}, a British Constitutionalist, observed that the provisions borrowed were not always well-selected and that the constitution, generally speaking, was too long and complicated.\endnote{\gls{person:IvorJenningsGbT}, Some Characteristics of the Indian Constitution, Oxford University Press, Madras, 1953, PP.9-16.}

In this context, \gls{person:HVKamathMXm}, a member of the Constituent Assembly, commented: \enquote{The emblem and the crest we have selected for our assembly is an elephant. It is perhaps in consonance with that our constitution too is the bulkiest in the world has produced}.\endnote{Constituent Assembly Debates, Volume VII, P.1042.} He also said: \enquote{I am sure, the House does not agree that we should make the Constitution an elephantine one}.\endnote{Constituent Assembly Debates, Volume VIII, P.127.}

\paragraph{Paradise of the Lawyers}

According to the critics, the Indian Constitution is too legalistic and very complicated. They opined that the legal language and phraseology adopted in the constitution makes it a complex document. The same Sir \gls{person:IvorJenningsGbT} called it a \enquote{lawyer's paradise}.

In this context, \gls{person:HKMaheswariPON}, a member of the Constituent Assembly observed: \enquote{The draft tends to make people more litigious, more inclined to go to courts, less truthful and less likely to follow the methods of truth and non-violence. If I may so, the Draft is really a lawyer's paradise. It opens up vast avenues of litigation and will give our able and ingenious lawyers plenty of work to do}.\endnote{Constituent Assembly Debates, Volume VII, P.293.}

Similarly, \gls{person:PRDeshmukhfXk}, another member of the Constituent Assembly, said: \enquote{I should, however, like to say that the draft of the articles that have been brought before the House by \gls{person:DrBRAmbedkarRIM} seems to my mind to be far too ponderous like the ponderous tomes of a law manual. A document dealing with a constitution hardly uses so much of padding and so much of verbiage. Perhaps it is difficult for them to compose a document which should be, to my mind, not a law but a socio-political document, a vibration, pulsating and life giving document. But to our misfortune, that was not to be, and we have been burdened with so much of words, words and words which could have been very easily eliminated}.\endnote{Constituent Assembly Debates, Volume IX, P.613.}
...
The American Constitution was the first to begin with a Preamble. Many countries, including India, followed this practice. The term `preamble' refers to the introduction or preface to the Constitution. It contains the summary or essence of the Constitution. \gls{person:NAPalkivala5xz}, an eminent jurist and constitutional expert, called the Preamble as the `identity card of the Constitution'.

The Preamble to the Indian Constitution is based on the `Objectives Resolution\index{Objectives Resolution}', draft and moved by \gls{person:JawaharlalNehruRDk}, and adopted by the Constituent Assembly\endnote{1}. It has been amended by the 42nd Constitutional Amendment Act of 1976, which added three new words — socialist, secular and integrity.
...
\begin{enumerate}
  ...
  \item \textbf{Date of adoption of the Constitution}: It stipulates \gls{date:November261949B8D}\index{1949-11-26}, as the date.
\end{enumerate}
