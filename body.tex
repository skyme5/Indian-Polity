...
The British came to India in 1600 as traders, in the form of East India Company, which had the exclusive right of trading in India under a chapter granted by \gls{person:QueenElizabethITJ8}. In 1764, the Company, which till now had purely trading functions obtained the \quotesingle{diwani}\hspace{4pt}(i.e., rights over revenue and civil justice) of Bengal, Bihar and Orissa
\endnote{The Mughal Emperor, \gls{person:ShahAlamg3y}, granted \quotesingle{Diwani} to the Company after its victory in the Battle of Buxar (1764)}. This started its career as a territorial power. In 1858, in the wake of the \quotesingle{Sepoy mutiny\index{Sepoy mutiny}}, the British Crown assumed direct responsibility for the governance of India. This rule continued until India was granted independence on \gls{date:August151947mRj}.

With Independence came the need of a Constitution. As suggested by \gls{person:MNRoyRI1} (a pioneer of communist movement in India and an advocate of Radical Democrat-ism) in 1934, a Constituent Assembly was formed for this purpose in 1946 and on January 26, 1950, the Constitution and polity have their roots in the British rule. There are certain events in the British rule that laid down the legal framework for the organization and functioning of government and administration in British India. These events have greatly influenced out contribution and polity. They are explained here in a chronological order:
...
In a bid to rectify the defects of the Regulating Act of 1773\index{Acts!Regulating Act of 1773}, the British Parliament passed the Amending Act of 1781\index{Acts!Amending Act of 1781}, also known as the Act of Settlement\index{Acts!Act of Settlement}. The next important act was the Pitt's India Act\endnote{It was introduced in the British Parliament by the then Prime Minister, \gls{person:WilliamPittGkD}} of 1784.
...
\begin{enumerate}
  ...
  \item It also provided for the establishment of new legislative councils for Bengal, \gls{NorthWesternFrontierProvinceQDA} (NWFP) and Panjab, which were established in 1862, 1866 and 1897 respectively.
  \item It empowered the Viceroy to make rules and orders for the more convenient transaction of business in the council. It also gave a recognition to the  \quotesingle{portfolio} system, introduced by \gls{person:LordCanninggUX}\gls{person:LordCanninggUX} in 1859. Under this, a member of the Viceroy's council was made in-charge of one or more departments of the government and was authorized to issue final orders on behalf of the council on matters of his department(s).
...
This Act is also known as Morley-Minto Reforms (Lord Morley was the then Secretary of State for India and \gls{person:LordMintoBfi} was the then Viceroy of India).
\begin{enumerate}
  ...
  \item It provided (for the first time) for the association of Indians with the executive Councils of the Viceroy and Governors. \gls{person:SatyendraPrasadSinhaGMs} became the first Indian to join the Viceroy's Executive Council. He was appointed as the law member.
  \item It introduced a system of communal representation\index{communal representation} for Muslims by accepting the concept of \quotesingle{\gls{SeparateElectorateZ3T}}. Under this, the Muslim members were to be elected only by Muslim voter. Thus, the Act \quotesingle{legalized communal-ism} and \gls{person:LordMintoBfi} came to be known as the Father of Communal Electorate.
...
On February 20, 1947, the British Prime Minister \gls{person:ClementAtleeBd8} declared that the British rule in India would end by \gls{date:June201948K8T}; after which the power would be transferred to responsible Indian hands. This announcement was followed by the agitation by the Muslim League demanding partition of the country. Again on \gls{date:June31947VQg}, the British Government made it clear that any Constitution framed by the Constituent Assembly of India (formed in 1946) cannot apply to those parts of the country which were unwilling to accept it. On the same day (\gls{date:June31947VQg}), \gls{person:LordMountbettenRoP}, the viceroy of India, put forth the partition plan known as the Mountbatten Plan\index{Mountbatten Plan}. The plan was accepted by the Congress and the Muslim League. Immediate effect was given to the plan by enacting the Indian Independence Act\endnote{The Indian Independence Bill was introduced in the British Parliament on \gls{date:July41947FgB} and received the Royal Assent on \gls{date:July181947uY0}. The act came into force on \gls{date:August151947mRj}.} (1947).

\paragraph{Features of the Act}
\begin{enumerate}
  \item It ended the British rule in India and declared India as an independent and sovereign state from \gls{date:August151947mRj}.
  ...
  \item It proclaimed the lapse of British paramountcy over the Indian princely states and treaty relations with tribal areas from \gls{date:August151947mRj}.
  ...
  \item It discontinued the appointment to civil services and reservation of posts by the secretary of state for India. The members of the civil services appointed before \gls{date:August151947mRj} would continue to enjoy all benefits that they were entitled to till that time.
\end{enumerate}

At the stroke of midnight 14-15 August, 1947, the British rule came to an end and power was transferred to the two new independent Dominions of India and Pakistan\endnote{The boundaries between the two Dominions were determined by a Boundary Commission headed by Radcliff. Pakistan included the provinces of West Punjab, Sind, Baluchistan, East Bengal, \gls{NorthWesternFrontierProvinceQDA} and the district of Sylhet in Assam. The referendum in the \gls{NorthWesternFrontierProvinceQDA} and Sylhet was in favor of Pakistan.}. \gls{person:LordMountbettenRoP} became the first governor-general of the new Dominion of India. He swore in \gls{person:JawaharlalNehrutnj} as the first prime minister of independent India. The Constituent Assembly of India formed in 1946 became the Parliament of the Indian Dominion.
...
\begin{longtable}[c]{@{}|l|l|l|@{}}
  ...
  \endlastfoot
  %
  1. & \gls{person:JawaharlalNehrutnj} & External Affairs \& Commonwealth Relations \\
  2. & \gls{person:SardarVallabhbhaiPatelhya} & Home, Information \& Broadcasting \\
  3. & \gls{person:DrRajendraPrasadkNV} & Food \& Agriculture \\
  4. & \gls{person:DrJohnMathaiyYX} & Industries \& Supplies \\
  5. & \gls{person:JagjivanRamJxh} & Labor \\
  6. & \gls{person:SardarBaldevSinghT3e} & Defense \\
  7. & \gls{person:CHBhabhaltk} & Works, Mines \& Power \\
  8. & \gls{person:LiaquatAliKhanN5i} & Finance \\
  9. & \gls{person:AbdurRabNishtarmSI} & Posts \& Air \\
  10. & \gls{person:AsafAliz4J} & Railways \& Transport \\
  11. & \gls{person:CRajagopalacharik6r} & Education \& Arts \\
  12. & \gls{person:IIChundrigarWxZ} & Commerce \\
  13. & \gls{person:GhaznafarAliKhan5WX} & Health \\
  14. & \gls{person:JoginderNathMandal0wx} & Law \\* \bottomrule
\end{longtable}
\textit{\textbf{Note}}: The members of the interim government were members of the Viceroy's Executive Council. The Viceroy continues to be the head of the Council. But, \gls{person:JawaharlalNehrutnj} was designated as the Vice-President of the Council.
...
\begin{longtable}[c]{@{}|p{.7cm}|p{5cm}|p{5cm}|@{}}
	...
	\endlastfoot
	%
	1. & \gls{person:JawaharlalNehrutnj} & Prime Minister; External Affairs \& Commonwealth Relations; Scientific Research \\
	2. & \gls{person:SardarVallabhbhaiPatelhya} & Home, Information \& Broadcasting; States \\
	3. & \gls{person:DrRajendraPrasadkNV} & Food \& Agriculture \\
	4. & \gls{person:MaulanaAbulKalamAzaddr7} & Education \\
	5. & \gls{person:DrJohnMathaiyYX} & Railway \& Transport \\
	6. & \gls{person:RKShanmughamTC3} & Finance \\
	7. & \gls{person:DrBRAmbedkarhKR} & Law \\
	8. & \gls{person:JagjivanRamJxh} & Labor \\
	9. & \gls{person:SardarBaldevSinghT3e} & Defense \\
	10. & \gls{person:RajKumariAmritKaurp1O} & Health \\
	11. & \gls{person:CHBhabhaltk} & Commerce \\
	12. & \gls{person:RafiAhmedKidwaiANM} & Communication \\
	13. & \gls{person:DrShyamaPrasadMukherji0gP} & Industries \& Supplies \\
	14. & \gls{person:VNGadgilyI3} & Works, Mines \& Power \\* \bottomrule
\end{longtable}
...
Although the Constituent Assembly was not directly elected by the people of India on the basis of adult franchise, the Assembly comprised representatives of all section of Indian Society - Hindus, Muslims, Sikhs, Parsis, Anglo-Indians, Indian Christians, SCs, STs including women of all these sections. The Assembly included all important personalities of India at that time, with the exception of \gls{person:MahatmaGandhie1D}.

\section{Working of the Constituent Assembly}

The Constituent Assembly held its first meeting on \gls{date:December91946twD}. The Muslim League boycotted the meeting and insisted on a separate state of Pakistan. The meeting was thus attended by only 211 members. {\colord{}\gls{person:DrSachchidanandSinhaJH8}, the oldest member, was elected as the temporary President of the Assembly, following the French practice.}

Later, \gls{person:DrRajendraPrasadkNV} was elected as the President of the Assembly. Similarly, both \gls{person:HCMukherjeeh6s} and \gls{person:VTKrishnamachiyi2} were elected as the Vice-Presidents of the Assembly. In other words, the Assembly had two Vice-Presidents.

\paragraph{Objectives Resolution\index{Objectives Resolution}}

On \gls{date:December131946UCN}, \gls{person:JawaharlalNehrutnj} moved the historic \quotesingle{Objectives Resolution\index{Objectives Resolution}} in the Assembly. It laid down the fundamentals and philosophy of the constitutional structure. It read:
...
The representatives of the princely states, who had stayed awat from the Constituent Assembly, gradually joined in. On \gls{date:April281947Elz}, representatives of the six states\endnote{These include Baroda, Bikaner, Jaipur, Patiala, Rewa and Udaipur.} were part of the Assembly. After the acceptance of Mountbatten Plan\index{Mountbatten Plan} of \gls{date:June31947VQg} for a partition of the country, the representatives of most of the other princely states took their seats in the Assembly. The members of the Muslim League from the Indian Dominion also entered the Assembly.
...
\begin{enumerate}
  ...
  \item It elected \gls{person:DrRajendraPrasadkNV} as the first President of India on January 24, 1950.
\end{enumerate}
...
On January 24, 1950, the Constituent Assembly held its final session. It however, did not end, and continued as the provisional parliament of India from January 26, 1950 till the formation of new Parliament\endnote{The Provisional Parliament ceased to exist on \gls{date:April171952dBp}. The first elected Parliament with the two Houses came into being in May 1952.} after the first general elections in 1951-52.
...
\begin{enumerate}
  \item \gls{committee:UnionPowersCommittee46X} - \gls{person:JawaharlalNehrutnj}
  \item \gls{committee:UnionConstitutionCommitteej0G} - \gls{person:JawaharlalNehrutnj}
  \item \gls{committee:ProvincialConstitutionCommitteetQZ} - \gls{person:SardarVallabhbhaiPatelhya}
  \item \gls{committee:DraftingCommitteeF4d} - \gls{person:DrBRAmbedkarhKR}
  \item \gls{committee:AdvisoryCommitteeicl} on Fundamental Rights\index{Fundamental Rights}, Minorities and Tribal and Excluded Areas - \gls{person:SardarVallabhbhaiPatelhya}. This committee had the following five sub-committees:
  \begin{enumerate}
    \item \gls{committee:FundamentalRightsSubCommitteervM} - \gls{person:JBKripalaniovq}
    \item \gls{committee:MinoritiesSubCommitteeQey} - \gls{person:HCMukherjeeh6s}
    \item \gls{committee:NorthEastFrontierTribunalAreasSubCommitteecU2} (with Assam Excluded \& Partially Excluded Areas) - \gls{person:GopinathBardoloisxS}
    \item \gls{committee:ExcludedandPartiallyExcludedAreasceq} Other than those in Assam Sub Committee - \gls{person:AVThakkar9B2}
    \item \gls{committee:NorthWestFrontierTribalAreasSubCommitteemZk}\endnote{One of the political consequences of the British Government’s statement of \gls{date:June31947VQg}, was that following a referendum, the North-West Frontier Province and Baluchistan became part of the territory of the Dominion of Pakistan and as a result the tribal areas in this region became a concern of that Dominion. The Sub-Committee on the Tribal Areas in the North-West Frontier Province and Baluchistan was not therefore called upon to function on behalf of the Constituent Assembly of India. (B. Shiva Rao, The Framing of India’s Constitution : Select Documents, Volume III, P.681.) The members of this Sub-Committee were : Khan Abdul Ghaffar Khan, Khan Abdul Samad Khan and Mehr Chand Khanna. The information about the Chairman is not found.}
  \end{enumerate}
  
  \item \gls{committee:RulesofProcedureCommitteeYgE} - \gls{person:DrRajendraPrasadkNV}
  \item \gls{committee:StatesCommitteeCommitteeforNegotiatingwithStatestLC} - \gls{person:JawaharlalNehrutnj}
  \item \gls{committee:SteeringCommitteep9k} - \gls{person:DrRajendraPrasadkNV}
\end{enumerate}

\subsection{Minor Committees}

\begin{enumerate}
  \item \gls{committee:FinanceandStaffCommitteeMXU} - \gls{person:DrRajendraPrasadkNV}
  \item \gls{committee:CredentialsCommitteeheE} - \gls{person:AlladiKrishnaswamiAyyarVw7}
  \item \gls{committee:HouseCommitteekCo} - \gls{person:BPattabhiSitaramayyaQYG}
  \item \gls{committee:OrderofBusinessCommitteeOXf} - \gls{person:DrKMMunshiMKm}
  \item \gls{committee:AdhocCommitteeontheNationalFlagziu} - \gls{person:DrRajendraPrasadkNV}
  \item \gls{committee:CommitteeontheFunctionsoftheConstituentAssemblyUC3} - \gls{person:GVMavalankarVg4}
  \item \gls{committee:AdhocCommitteeontheSupremeCourtKlW} - \gls{person:SVaradachariEpD} (Not an Assembly Member)
  \item \gls{committee:CommitteeonChiefCommissionersProvincesVrj} - \gls{person:BPattabhiSitaramayyaQYG}
  \item \gls{committee:ExpertCommitteeontheFinancialProvisionsoftheUnionConstitutionzBJ} - \gls{person:NaliniRanjanSarkarPqG} (Not an Assembly Member)
  \item \gls{committee:LinguisticProvincesCommissionIap} - \gls{person:SKDarfFz} (Not an Assembly Member)
  \item \gls{committee:SpecialCommitteetoExaminetheDraftConstitutionM08} - \gls{person:JawaharlalNehrutnj}
  \item \gls{committee:PressGalleryCommittee50c} - \gls{person:UshaNathSenJbL}
  \item \gls{committee:AdhocCommitteeonCitizenship3MN} - \gls{person:SVaradachariEpD}
\end{enumerate}


\subsection{\gls{committee:DraftingCommitteeF4d}}

Among all the committees of the Constituent Assembly, the most important committee was the \gls{committee:DraftingCommitteeF4d} set up on \gls{date:August291947OxY}. It was this committee that was entrusted with the task of preparing a draft of the new Constitution. It consisted of seven members. They were

\begin{enumerate}
  \item \gls{person:DrBRAmbedkarhKR} ({\colord Chairmen})
  \item \gls{person:NGopalaswamyAyyangarkcI}
  \item \gls{person:AlladiKrishnaswamiAyyarVw7}
  \item \gls{person:DrKMMunshiMKm}
  \item \gls{person:SayedMohammadSaadullahH6Y}
  \item \gls{person:NMadhavaRauKHx} (He replaced \gls{person:BLMitter0vt} who resined due to ill-health)
  \item \gls{person:TTKrishnamachariIeO} (He replaced \gls{person:DPKhaitan5RO} who died in 1948)
\end{enumerate}

The \gls{committee:DraftingCommitteeF4d}, after taking into consideration the proposal of the various committees, prepared the first draft of the Constitution of India, which was published in February 1948. The people of India were given eight months to discuss the draft and propose amendments. In the light of the public comments, criticisms and suggestions, the \gls{committee:DraftingCommitteeF4d} prepared a second draft, which was published in October 1948.

The \gls{committee:DraftingCommitteeF4d} took less than six months to prepare its draft. In all it say for 141 days.

\section{Enactment of the Constitution}

\gls{person:DrBRAmbedkarhKR} introduced the final draft of the Constitution in the Assembly on \gls{date:November419486t8} (first reading). The Assembly had a general discussion on it for five days (till \gls{date:November91948XYM}).

The second reading (clause by clause consideration) started on \gls{date:November1519482Cu} and ended on \gls{date:October171949dgu}. During this stage, as many as 7653 amendments were proposed and 2473 were actually discussed in the Assembly.

The third reading of the draft started on \gls{date:November141949kMe}. \gls{person:DrBRAmbedkarhKR} moved a motion - \quotesingle{the Constitution as settled by the Assembly be passed}. The motion on Draft Constitution was declared as passed on \gls{date:November261949kno}, and received the signatures of the members and the president. Out of a total 299 members of the Assembly, only 284 were actually present on that day and signed the Constitution. This is also the date mentioned in the Preamble as the date on which the people of India in the Constituent Assembly adopted, enacted and gave to themselves this Constitution.

{\colord The Constitution as adopted on \gls{date:November261949kno}, contained a Preamble, 395 Articles and 8 Schedules}. The Preamble was enacted after the entire Constitution was already enacted.

\gls{person:DrBRAmbedkarhKR}, the then Law Minister, piloted the Draft Constitution in the Assembly. He took a very prominent part in the deliberations of the Assembly. He was known for his logical, forceful and persuasive arguments on the floor of the Assembly. He is recognized as the \quotesingle{Father of the Constitution of India}. This brilliant writer, constitutional expert, undisputed leader of the scheduled castes and the \quotesingle{chief architech of the Constitution of India} is also known as a \quotesingle{Modern Manu}.

\section{Enforcement of the Constitution}

Some provisions of the Constitution pertaining to citizenship, elections, provisional parliament, temporary and transitional provisions, and short title contained in Articles 5, 6, 7, 8, 9, 60, 324, 366, 367, 379, 380, 388, 391, 392 and 393 came into force on \gls{date:November261949kno} itself.
...
\begin{enumerate}
  ...
  \item \textbf{Time Consuming}: According to the critics, the Constituent Assembly took unduly long time to make the Constitution. They stated that the framers of the American Constitution took only four months to complete their work. In this context, \gls{person:NaziruddinAhmedWJW}, a member of the Constituent Assembly, coined a new name for the \gls{committee:DraftingCommitteeF4d} to show his contempt for it. He called it a \quotedouble{Drifting Committee}.
  \item \textbf{Dominated by Congress}: The critics charged that the Constituent Assembly was dominated by the Congress party. \gls{person:GranvilleAustinBJW}, a British Constitutional expert, remarked: \quotesingle{The Constituent Assembly was a one-party body in an essentially one-party country. The Assembly was the Congress and the Congress was India}\endnote{\gls{person:GranvilleAustinBJW}, The Indian Constitution—Cornerstone of a Nation, Oxford, 1966, P. 8.}.
  ...
  \item \textbf{Dominated by Hindus}: According to some critics, the Constituent Assembly was a Hindu dominated body. \gls{person:LordViscountSimon6iq} called it \quotesingle{a body of Hindus}. Similarly, \gls{person:WinstonChurchillvY3} commented that the Constituent Assembly represented \quotesingle{only one major community in India}.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \gls{person:SirBNRauARg} was appointed as the constitutional advisor (Legal advisor) to the Constituent Assembly.
  \item \gls{person:HVRIyengarwW6} was the Secretary to the Constituent Assembly.
  \item \gls{person:SNMukerjee9HT} was the chief draftsman of the constitution in the Constituent Assembly.
  \item \gls{person:PremBehariNarainRaizadavGv} was the calligrapher of the Indian Constitution. The original constitution was handwritten by him in a flowing italic style.
  \item The original version was beautified and decorated by artists from Shantiniketan including \gls{person:NandLalBoseRVx} and \gls{person:BeoharRammanoharSinhaHUa}.
  \item \gls{person:BeoharRammanoharSinhaHUa} illuminated, beautified and ornamented the original Preamble calligraph-ed by \gls{person:PremBehariNarainRaizadavGv}.
  \item The calligraphy of the Hindi version of the original constitution was done by \gls{person:VasantKrishanVaidyaBi3} and elegantly decorated and illuminated by \gls{person:NandLalBoseRVx}.
\end{enumerate}
...
\begin{longtable}[c]{@{}|ll|l|c|@{}}
  \caption{State wise Membership of the Constituent Assembly of India as on \gls{date:December311947XU8}}
...
It should be notes al the outset that a number of original features of the Constitution (as adopted in 1949) have undergone a substantial change, on account of several amendments, particularly 7th, 42nd, 44th, 73rd, 74th and 97th Amendments. In fact, the 42nd Amendment Act (1976) is known as \quotesingle{Mini-Constitution} due to the important and large number of changes made by it in various parts of the Constitution. However, in the {\colord \textit{\gls{person:KeshavanandaBhartiv7z}}} case\endnote{Kesavananda Bharati vs State of Kerala, (1973)} (1973), the Supreme Court rules that the constitution power of Parliament under Article 368 does not enable it to alter the \quotesingle{basic structure} of the Constitution.
...
The Constitution of India has borrowed most of its provisions from the constitutions of various other countries as well as from the Government of India Act\endnote{About 250 provisions of the 1935 Act have been included in the Constitution.} of 1935. \gls{person:DrBRAmbedkarhKR} proudly acclaimed that the Constitution of India has been framed after \quotesingle{ransacking all the known Constitution of the World\endnote{Constituent Assembly Debates, Volume VII, P. 35–38.}}.
...
Hence, the Indian Constitution has been variously described a \quotesingle{federal in form but unitary in spirit}, \quotesingle{quasi-federl} by \gls{person:KCWheare5ai}, \quotesingle{bargaining federalism} by \gls{person:MorrisJoneszwV}, \quotesingle{co-operative federalism} by \gls{person:GranvilleAustinBJW}, \quotesingle{federation with a centralizing tendency} by \gls{person:IvorJenningsVkz}, and so on.
...
According to \gls{person:DrBRAmbedkarhKR}, the Directive Principles of State Policy is a \quotesingle{novel feature} of the Indian Constitution. They are enumerated in Part IV of the Constitution. They can be classified into three broad categories — socialistic, Gandhian and liberal-intellectual.

The directive principles are meant for promoting the idea of social and economic democracy. They seek to establish a \quotesingle{welfare state} in India. However, unlike the Fundamental Rights\index{Fundamental Rights}, the directives are non-justifiable in nature, that is, they are not enforceable by the courts for their violation. Yet, the Constitution itself declares that \quotesingle{these principles are fundamental in the governance of the country and it shall be the duty of the state to apply these principles in making laws}. Hence, they impose a moral obligation on the state authorities for their application. But, the real force (sanction) behind them is political, that is, public opinion.

In the {\colord \textit{Minerva Mills}} case\endnote{Minerva Mills v.Union of India, (1980).} (1980), the Supreme Court held that \quotesingle{the Indian Constitution is founded on the bedrock of the balance between the Fundamental Rights\index{Fundamental Rights} and the Directive Principles}.

\subsection{Fundamental Duties}

The original constitution did not provide for the fundamental duties of the citizens. These were added during the operation of internal emergency(1975-77) by the 42nd Constitutional Amendment Act of 1976 on the recommendation of the \gls{committee:SwaranSinghCommitteexSe}. The 86the Constitutional Amendment Act of 2002 added one more fundamental duty.
...
\renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
\begin{enumerate}
  \item National emergency on the ground of war or externam aggression or armed rebellion\endnote{The 44th Amendment Act (1978) has replaced the original term \quotesingle{internal
...
While answering the above criticism in the Constituent Assembly, \gls{person:DrBRAmbedkarhKR}, the Chairman of the \gls{committee:DraftingCommitteeF4d}, said: \quotedouble{One likes to ask whether there can be antthin new in Constitution framed at this hour in the history of the world. More than hundred years have rolled over when the first written constitution was drafted. It has been followed by many countries reducing their constitution to writing. What the scope of a constitution should be has long been settled. Similarly, what are the fundamentals of a constitution are recognized all over the world. Given these facts, all constitutions in thir main provision must look similar. The only new things, if there can be any, in a constitution framed so late in the day are the variations made to remove the faults and to accommodate it to the needs of country. The charge of providing a blind copy of the constitutions of other countries is based, I am sure, on an inadequate study of the Constitution}\endnote{Constituent Assembly Debates, Volume VII, pp.35-38.}.

\paragraph{A Carbon Copy of the 1935 Act}

The critics said that the framers of the constitution have included a large number of the provision of the Government of India Act of 1935\index{Acts!Government of India Act of 1935} into the Constitution of India. Hence, they called the constitutions a \quotedouble{Carbon Copy of the 1935 Act} or an \quotedouble{amended version of the 1935 Act}. For example, \gls{person:NShrinivasantx0} observed that the Indian Constitution is \quotedouble{both in language and substance a close copy of the Act of 1935}. Similarly, Sir \gls{person:IvorJenningsVkz}, a British Constitutionalist, said that \quotedouble{the constitution derives directly from the Government of India Act of 1935\index{Acts!Government of India Act of 1935} from which, in fact, many of its provisions are copied almost textually}.

Further, \gls{person:PRDeshmukhN7P}, a member of the Constituent Assembly, commented that \quotedouble{the constitution is essentially the Government of India Act of 1935\index{Acts!Government of India Act of 1935} with only adult franchise added}.

The same \gls{person:DrBRAmbedkarhKR} answered the above criticism in the Constituent Assembly in the following way: \quotedouble{As to the accusation that the Draft Constitution has reproduced a good part of the provision of the Government of India Act, 1935, I make no apologies. There is nothing to be ashamed of in borrowing. It involves no plagiarism. Nobody hold any patent rights in the fundamental ideas of a Constitution. What I am sorry about is that the provision taken from the Government of India Act, 1935, relate mostly to the details of administration}\endnote{Ibid.}.

\paragraph{Un-Indian or Anti-India}

According to the critics, the Indian Constitution is \quotesingle{un-Indian} or \quotesingle{anti-Indian} because it does not reflect the political tradition and the spirit of India. They said that the foreign nature of the Constitution makes it unsuitable to the Indian situation or unworkable in India. In this context, \gls{person:KHanumanthaiyat3z}, a member of the Constituent Assembly, commented: \quotedouble{We wanted the music of Veena or Sitar, but here we have the music of an English band. That was because out constitution-makers were educated that way}\endnote{Constituent Assembly Debates, Volume XI, P.616.}. Similarly, \gls{person:KHanumanthaiyat3z}, another member of the Constituent Assembly, criticized the constitution as \quotedouble{slavish imitation of the west, much more - a slavish surrender to the west}\endnote{Constituent Assembly Debates, Volume VII, P.242.}. Further, \gls{person:LaxminarayanSahuHTU}, also a member of Constituent Assembly, observed: \quotedouble{The ideals on which this draft constitution is framed have no manifest relation to the fundamental spirit of India. This constitution would not prove suitable and would break down soon after being brought into operation}\endnote{Constituent Assembly Debates, Volume XI, P.613.}.

\paragraph{An Un-Gandhian Constitution}

According to the critics, the Indian Constitution is Un-Gandhian because it does not contain the philosophy and ideals of \gls{person:MahatmaGandhie1D}, the father of the Indian Nation. They opined that the Constitution should have been raised and build upon village panchayats. In this context, the same member of the Constituent Assembly, \gls{person:KHanumanthaiyat3z}, said: \quotedouble{That is exactly the kind of Constitution \gls{person:MahatmaGandhie1D} did not want and did not envisage}.\endnote{Constituent Assembly Debates, Volume XI, P.617.} \gls{person:TPrakasamJPY}, another member of the Constituent Assembly, attributed this lapse to \gls{person:DrBRAmbedkarhKR}'s non-participation in the Gandhian movement and the antagonism towards Gandhian ideas\endnote{Constituent Assembly Debates, Volume VII, P.387.}.

\paragraph{Elephantine Size}

The critics stated that the Indian Constitution is too bulky and too detailed and contains some unnecessary elements. Sir \gls{person:IvorJenningsVkz}, a British Constitutionalist, observed that the provisions borrowed were not always well-selected and that the constitution, generally speaking, was too long and complicated.\endnote{\gls{person:IvorJenningsVkz}, Some Characteristics of the Indian Constitution, Oxford University Press, Madras, 1953, PP.9-16.}

In this context, \gls{person:HVKamathHnM}, a member of the Constituent Assembly, commented: \quotedouble{The emblem and the crest we have selected for our assembly is an elephant. It is perhaps in consonance with that our constitution too is the bulkiest in the world has produced}.\endnote{Constituent Assembly Debates, Volume VII, P.1042.} He also said: \quotedouble{I am sure, the House does not agree that we should make the Constitution an elephantine one}.\endnote{Constituent Assembly Debates, Volume VIII, P.127.}

\paragraph{Paradise of the Lawyers}

According to the critics, the Indian Constitution is too legalistic and very complicated. They opined that the legal language and phraseology adopted in the constitution makes it a complex document. The same Sir \gls{person:IvorJenningsVkz} called it a \quotedouble{lawyer's paradise}.

In this context, \gls{person:HKMaheswariFO0}, a member of the Constituent Assembly observed: \quotedouble{The draft tends to make people more litigious, more inclined to go to courts, less truthful and less likely to follow the methods of truth and non-violence. If I may so, the Draft is really a lawyer's paradise. It opens up vast avenues of litigation and will give our able and ingenious lawyers plenty of work to do}.\endnote{Constituent Assembly Debates, Volume VII, P.293.}

Similarly, \gls{person:PRDeshmukhN7P}, another member of the Constituent Assembly, said: \quotedouble{I should, however, like to say that the draft of the articles that have been brought before the House by \gls{person:DrBRAmbedkarhKR} seems to my mind to be far too ponderous like the ponderous tomes of a law manual. A document dealing with a constitution hardly uses so much of padding and so much of verbiage. Perhaps it is difficult for them to compose a document which should be, to my mind, not a law but a socio-political document, a vibration, pulsating and life giving document. But to our misfortune, that was not to be, and we have been burdened with so much of words, words and words which could have been very easily eliminated}.\endnote{Constituent Assembly Debates, Volume IX, P.613.}
...
The American Constitution was the first to begin with a Preamble. Many countries, including India, followed this practice. The term \quotesingle{preamble} refers to the introduction or preface to the Constitution. It contains the summary or essence of the Constitution. \gls{person:NAPalkivalaWR7}, an eminent jurist and constitutional expert, called the Preamble as the \quotesingle{identity card of the Constitution.}

The Preamble to the Indian Constitution is based on the \quotesingle{Objectives Resolution\index{Objectives Resolution}}, draft and moved by \gls{person:JawaharlalNehrutnj}, and adopted by the Constituent Assembly\endnote{1}. It has been amended by the 42nd Constitutional Amendment Act (1976), which added three new words — socialist, secular and integrity.
...
\begin{enumerate}
  ...
  \item \textbf{Date of adoption of the Constitution}: It stipulates \gls{date:November261949kno} as the date.
\end{enumerate}
