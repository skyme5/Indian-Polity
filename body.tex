...
The British came to India in 1600 as traders, in the form of East India Company, which had the exclusive right of trading in India under a chapter granted by \gls{person:QueenElizabethItxD}. In 1764, the Company, which till now had purely trading functions obtained the `diwani' (i.e., rights over revenue and civil justice) of Bengal, Bihar and Orissa
\endnote{The Mughal Emperor, \gls{person:ShahAlamvgE}, granted `Diwani' to the Company after its victory in the Battle of Buxar (1764)}. This started its career as a territorial power. In 1858\index{Year!1858}, in the wake of the `Sepoy mutiny\index{Sepoy mutiny}', the British Crown assumed direct responsibility for the governance of India. This rule continued until India was granted independence on \gls{date:August151947Ytp}\index{Date!\gls{date:August151947Ytp}}.

With Independence came the need of a Constitution. As suggested by \gls{person:MNRoy4WD} (a pioneer of communist movement in India and an advocate of Radical Democrat-ism) in 1934\index{Year!1934}, a Constituent Assembly was formed for this purpose in 1946\index{Year!1946} and on January 26, 1950\index{Date!January 26, 1950}, the Constitution and polity have their roots in the British rule. There are certain events in the British rule that laid down the legal framework for the organization and functioning of government and administration in British India. These events have greatly influenced out contribution and polity. They are explained here in a chronological order:
...
In a bid to rectify the defects of the Regulating Act of 1773\index{Acts!Regulating Act of 1773}, the British Parliament passed the Amending Act of 1781\index{Acts!Amending Act of 1781}, also known as the Act of Settlement\index{Acts!Act of Settlement}. The next important act was the Pitt's India Act\endnote{It was introduced in the British Parliament by the then Prime Minister, \gls{person:WilliamPittlMk}} of 1784.
...
\begin{enumerate}
  ...
  \item The Charter Act of 1833\index{Acts!Charter Act of 1833} attempted to introduce a system of open competition for civil servants\index{civil servants}, and stated that the Indians should not be debarred from holding any place, office and employment under the Company. However, this provision negated after opposition from the Courts of Directors.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item It introduced an open competition system of selection and recruitment of civil servants\index{civil servants}\endnote{At that time, the Civil Services of the company were classified into covenanted civil services (higher civil services) and uncovenanted civil services (lower civil services). The former was created by a law of the Company, while the lated was created otherwise.} was thus thrown open to Indians also. Accordingly, the Macaulay Committee (the Committee on the Indian Civil Services) was appointed in 1854.
...
\begin{enumerate}
  ...
  \end{list}
\end{enumerate}
`The act made a limited and indirect provision for the use of election in filling up some of the non-official seats both in the Central and provincial legislative councils. The word \enquote{election} was, however not used in the act. The process was described as nomination made on the recommendation of certain bodies\endnote{V. N. Shukla, The Constitution of India, Esatern Book Company, 10th Edition, 2001, P. A-10.}.'

\paragraph{Features of the Act of 1909}
This Act is also known as Morley-Minto Reforms (Lord Morley was the then Secretary of State for India and \gls{person:LordMinto4Bc} was the then Viceroy of India).
\begin{enumerate}
  ...
  \item It provided (for the first time) for the association of Indians with the executive Councils of the Viceroy and Governors. \gls{person:SatyendraPrasadSinhadDC} became the first Indian to join the Viceroy's Executive Council. He was appointed as the law member.
  \item It introduced a system of communal representation\index{communal representation} for Muslims by accepting the concept of `\gls{SeparateElectorateLST}'. Under this, the Muslim members were to be elected only by Muslim voter. Thus, the Act `legalized communal-ism' and \gls{person:LordMinto4Bc} came to be known as the Father of Communal Electorate.
...
On \gls{date:August2019170AQ}\index{Date!\gls{date:August2019170AQ}}, the British Government declared, for the first time, that its objective was the gradual introduction of responsible government in India\endnote{The declaration this stated: `The policy of His Majesty's Government is that of the increasing association of Indians in every branch of the administration, and the gradual development of self-government institutions, with a view to the progressive realization of responsible government in India as an integral part of the British Empire'.}.

The Government of India Act of 1919\index{Acts!Government of India Act of 1919}\index{Year!1919} was thus enacted, which came into force in 1921\index{Year!1921}. This Act is also known as \gls{person:MontaguexX}-\gls{person:Chelmsfordq4G} Reforms (\gls{person:MontaguexX} was the Secretary of State for India and \gls{person:Chelmsfordq4G} was the Viceroy of India).
...
\begin{enumerate}
  ...
  \item It extended the principle of communal representation\index{communal representation} by providing separate electorate\index{separate electorate}s for Sikhs, Indian Christias, Anglo-Indians and Europeans.
  ...
  \item It provided for the establishment of a public service commission\index{public service commission}. Hence, a Central Public Service Commission was set up in 1926\index{Year!1926} for recruiting civil servants\index{civil servants}\endnote{This was done on the recommendation of the Lee Commission on Superior Civil Services in India (1923–24).}.
...
\paragraph{Simon Commission\index{Simon Commission}}

In 1927\index{Date!1927}, itself (i.e. 2 years before the schedule), the British Government announced the appointment of a seven member statutory commission under the chairmanship of \gls{person:SirJohnSimonqKX} to report on the condition of India under its new Constitution. All the members of the commission were British and hence, all the parties boycotted the commission, The commission submitted its report in 1930 and recommended the abolition of dyarchy, extension of responsible government in the provinces, establishment of a federation of British India and princely states, continuation of communal electorate and so on. To consider the proposal of the commission, the British Government convened three round table conferences of the representatives of the British Government, British India and Indian princely state. On the basis of these discussions, a `White Paper on Constitutional Reforms' was prepared and submitted for the consideration of the Joint Select Committee of the British Parliament. The recommendations of this committee were incorporated (with certain changes) in the next Government of India Act of 1935\index{Acts!Government of India Act of 1935}.

\paragraph{Communal Award\index{Communal Award}}
In 1932\index{Date!1932}, \gls{person:RamsayMacDonaldK3o}, the British Prime Minister, announced a scheme of representation of the minorities, which came to be known as the Communal Award\index{Communal Award}. The award not only continued separate electorate\index{separate electorate}s for the Muslims, Sikhs, Indian Christians, Anglo-Indians and Europeans but also extended it to the depressed classes (schedules castes). \gls{person:MahatmaGandhi5Y9} was distressed over this extension of the principle of communal representation\index{communal representation} to the depressed classes and undertook fast unto death in Yervada Jail\index{Yervada Jail} (Poona) to get the award modified. At last, there was an agreement between the leaders of the Congress and the depressed classes. The agreement, known and Poona Pact\index{Poona Pact}, retained the Hindu joint electorate and gave reserved seats to the depressed classes.
...
\begin{enumerate}
  ...
  \item It introduced bicameralism\index{bicameralism} in six out of eleven provinces. Thus, the legislature of Bengal, Bombay, Madras, Bihar, Assam and the United Provinces were made bicameral consisting of a legislative council (upper house) and a legislative assembly (lower house). However, many restrictions were placed on them.
  \item It further extended the principle of communal representation\index{communal representation} by providing separate electorate\index{separate electorate}s for depressed classes (schedules castes), women and labor (workers).
  ...
  \item It provided for the establishment of Reserve Bank of India\index{Reserve Bank of India} to control the currency and credit of the country.
...
On Feburary 20, 1947\index{Date!Feburary 20, 1947}, the British Prime Minister \gls{person:ClementAtlee9p0} declared that the British rule in India would end by \gls{date:June201948LMT}\index{Date!\gls{date:June201948LMT}}; after which the power would be transferred to responsible Indian hands. This announcement was followed by the agitation by the Muslim League demanding partition of the country. Again on June 03, 1947\index{Date!June 03, 1947} the British Government made it clear that any Constitution framed by the Constituent Assembly of India (formed in 1946) cannot apply to those parts of the country which were unwilling to accept it. On the same day (June 03, 1947\index{Date!June 03, 1947}), \gls{person:LordMountbettendxp}, the viceroy of India, put forth the partition plan known as the Mountbatten Plan\index{Mountbatten Plan}. The plan was accepted by the Congress and the Muslim League. Immediate effect was given to the plan by enacting the Indian Independence Act\endnote{The Indian Independence Bill was introduced in the British Parliament on July 04, 1947\index{Date!July 04, 1947} and received the Royal Assent on \gls{date:July181947ida}\index{Date!\gls{date:July181947ida}}. The act came into force on \gls{date:August151947Ytp}\index{Date!\gls{date:August151947Ytp}}.} (1947).

\paragraph{Features of the Act}
\begin{enumerate}
  \item It ended the British rule in India and declared India as an independent and sovereign state from \gls{date:August151947Ytp}\index{Date!\gls{date:August151947Ytp}}.
  \item It provided for the partition of India and creation of two independent dominions of India and Pakistan with the right to secede from the British Commonwealth\index{British Commonwealth}.
  ...
  \item It proclaimed the lapse of British paramountcy over the Indian princely states and treaty relations with tribal areas from \gls{date:August151947Ytp}\index{Date!\gls{date:August151947Ytp}}.
  ...
  \item It discontinued the appointment to civil services and reservation of posts by the secretary of state for India. The members of the civil services appointed before \gls{date:August151947Ytp}\index{Date!\gls{date:August151947Ytp}}, would continue to enjoy all benefits that they were entitled to till that time.
\end{enumerate}

At the stroke of midnight 14-15 August, 1947, the British rule came to an end and power was transferred to the two new independent Dominions of India and Pakistan\endnote{The boundaries between the two Dominions were determined by a Boundary Commission headed by Radcliff. Pakistan included the provinces of West Punjab, Sind, Baluchistan, East Bengal, \gls{NorthWesternFrontierProvinceVwx} and the district of Sylhet in Assam. The referendum in the \gls{NorthWesternFrontierProvinceVwx} and Sylhet was in favor of Pakistan.}. \gls{person:LordMountbettendxp} became the first governor-general of the new Dominion of India. He swore in \gls{person:JawaharlalNehruTDZ} as the first prime minister of independent India. The Constituent Assembly of India formed in 1946 became the Parliament of the Indian Dominion.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
  ...
  \endlastfoot
  %
  1. & \gls{person:JawaharlalNehruTDZ} & External Affairs \& Commonwealth \\
     &                           & Relations \\
  2. & \gls{person:SardarVallabhbhaiPatelVeT} & Home, Information \& Broadcasting \\
  3. & \gls{person:DrRajendraPrasadgT6} & Food \& Agriculture \\
  4. & \gls{person:DrJohnMathaiolO} & Industries \& Supplies \\
  5. & \gls{person:JagjivanRam1In} & Labor \\
  6. & \gls{person:SardarBaldevSingh9CW} & Defense \\
  7. & \gls{person:CHBhabhab5X} & Works, Mines \& Power \\
  8. & \gls{person:LiaquatAliKhanwcn} & Finance \\
  9. & \gls{person:AbdurRabNishtardzK} & Posts \& Air \\
  10. & \gls{person:AsafAli2tz} & Railways \& Transport \\
  11. & \gls{person:CRajagopalachariK5l} & Education \& Arts \\
  12. & \gls{person:IIChundrigarXaD} & Commerce \\
  13. & \gls{person:GhaznafarAliKhanDnC} & Health \\
  14. & \gls{person:JoginderNathMandal89c} & Law \\* \bottomrule
\end{longtable}
\textit{\textbf{Note}}: The members of the interim government were members of the Viceroy's Executive Council. The Viceroy continues to be the head of the Council. But, \gls{person:JawaharlalNehruTDZ} was designated as the Vice-President of the Council.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
	...
	\endlastfoot
	%
	1. & \gls{person:JawaharlalNehruTDZ} & Prime Minister; External Affairs \& Commonwealth \\
	&                           & Relations; Scientific Research \\
	2. & \gls{person:SardarVallabhbhaiPatelVeT} & Home, Information \& Broadcasting; States \\
	3. & \gls{person:DrRajendraPrasadgT6} & Food \& Agriculture \\
	4. & \gls{person:MaulanaAbulKalamAzadFt7} & Education \\
	5. & \gls{person:DrJohnMathaiolO} & Railway \& Transport \\
	6. & \gls{person:RKShanmughamRZ0} & Finance \\
	7. & \gls{person:DrBRAmbedkarzWS} & Law \\
	8. & \gls{person:JagjivanRam1In} & Labor \\
	9. & \gls{person:SardarBaldevSingh9CW} & Defense \\
	10. & \gls{person:RajKumariAmritKaurGu3} & Health \\
	11. & \gls{person:CHBhabhab5X} & Commerce \\
	12. & \gls{person:RafiAhmedKidwaigsE} & Communication \\
	13. & \gls{person:DrShyamaPrasadMukherjiyIF} & Industries \& Supplies \\
	14. & \gls{person:VNGadgilkqo} & Works, Mines \& Power \\* \bottomrule
\end{longtable}
...
It was in 1934\index{Year!1934} that the idea of a Constituent Assembly for India was put forward for the first time by \gls{person:MNRoy4WD}, a pioneer of communist movement in India. In 1935\index{Year!1935}, the Indian National Congress (INC), for the first time, officially demanded a Constituent Assembly to frame the Constitution of free India. In 1938\index{Year!1938}, \gls{person:JawaharlalNehruTDZ}, on behalf of the INC declared that `the Constitution of free India must be framed, without outside interference, by a Constituent Assembly elected on the basis of adult franchise'.

The demand was finally accepted in principle by the British Government in what is known as the `August Offer' of 1940. In 1942\index{Year!1942}, \gls{person:SirStaffordCrippsPxt}, a member of the cabinet, came India with a draft proposal of the British Government on the framing of an independent Constitution to be adopted after the World War II. The Cripps Proposals were rejected by the Muslim League which wanted India to be divide into two autonomous states with two separate Constituent Assemblies. Finally, a Cabinet Mission\endnote{The Cabinet Mission consisting of three members (Lord Pethick Lawrence, \gls{person:SirStaffordCrippsPxt} and A V Alexander) arrived in India on \gls{date:March241946rmc}\index{Date!\gls{date:March241946rmc}}. The Cabinet Mission published its plan on \gls{date:May161946ajm}\index{Date!\gls{date:May161946ajm}}.} was sent to India. While it rejected the idea of two Constituent Assemblies, it put forth a scheme for the Constituent Assembly which more or less satisfied the Muslim League.

\section{Composition of the Constituent Assembly}

The Constituent Assembly was constituted in 1946\index{Date!1946} under the scheme formulated by the Cabinet Mission Plan. The features of the scheme were
...
Although the Constituent Assembly was not directly elected by the people of India on the basis of adult franchise, the Assembly comprised representatives of all section of Indian Society - Hindus, Muslims, Sikhs, Parsis, Anglo-Indians, Indian Christians, SCs, STs including women of all these sections. The Assembly included all important personalities of India at that time, with the exception of \gls{person:MahatmaGandhi5Y9}.

\section{Working of the Constituent Assembly}

The Constituent Assembly held its first meeting on December 09, 1946\index{Date!December 09, 1946}. The Muslim League boycotted the meeting and insisted on a separate state of Pakistan. The meeting was thus attended by only 211 members. {\colord{}\gls{person:DrSachchidanandSinhaYom}, the oldest member, was elected as the temporary President of the Assembly, following the French practice.}

Later, \gls{person:DrRajendraPrasadgT6} was elected as the President of the Assembly. Similarly, both \gls{person:HCMukherjeejgr} and \gls{person:VTKrishnamachiWG7} were elected as the Vice-Presidents of the Assembly. In other words, the Assembly had two Vice-Presidents.

\paragraph{Objectives Resolution\index{Objectives Resolution}}

On \gls{date:December131946PiU}\index{Date!\gls{date:December131946PiU}}, \gls{person:JawaharlalNehruTDZ} moved the historic `Objectives Resolution\index{Objectives Resolution}' in the Assembly. It laid down the fundamentals and philosophy of the constitutional structure. It read:
...
This Resolution was unanimously adopted by the Assembly on January 22, 1947\index{Date!January 22, 1947}. It influenced the eventual shaping of the constitution through all its subsequent stages. Its modified version forms the Preamble of the present Constitution.

\section{Changes by the Independence Act}

The representatives of the princely states, who had stayed awat from the Constituent Assembly, gradually joined in. On \gls{date:April281947YKS}\index{Date!\gls{date:April281947YKS}}, representatives of the six states\endnote{These include Baroda, Bikaner, Jaipur, Patiala, Rewa and Udaipur.} were part of the Assembly. After the acceptance of Mountbatten Plan\index{Mountbatten Plan} of June 03, 1947\index{Date!June 03, 1947} for a partition of the country, the representatives of most of the other princely states took their seats in the Assembly. The members of the Muslim League from the Indian Dominion also entered the Assembly.
...
\begin{enumerate}
  ...
  \item The Assembly also became a legislative body. In other words, two separate functions were assigned to the Assembly, that is, making of a constitution for free India and enacting of ordinary laws for the country. These two tasks were to be performed on separate days. Thus, the Assembly became the first Parliament of free India (Dominion Legislature). Whenever the Assembly met as the Constituent body it was chaired by \gls{person:DrRajendraPrasadgT6} and when it met as the legislative body\endnote{For the first time, the Constituent Assembly met as Dominion Legislature on \gls{date:November171947mre}\index{Date!\gls{date:November171947mre}} and elected \gls{person:GVMavalankarqvU} as its speaker.}, it was chaired by \gls{person:GVMavalankarqvU}. These two functions continued till \gls{date:November261949Ak7}\index{Date!\gls{date:November261949Ak7}}, when the task of making the Constitution was over.
  \item The Muslim League members (hailing from the areas\endnote{These are West Punjab, East Bengal, NWFP, Sindh, Baluchistan and Sylhet District of Assam. A separate Constituent Assembly was set up for Pakistan.} included in the Pakistan) withdrew from the Constituent Assembly for India. Consequently, the total strength of the Assembly came down to 299 as against 389 originally fixed in 1946 under the Cabinet Mission Plan. The strength of the Indian provinces (formerly British Provinces) was reduced from 296 to 299 and those of the princely states from 93 to 70. The state-wise membership of the Assembly as on \gls{date:December311947bco}\index{Date!\gls{date:December311947bco}}, is shown in \ref{tab:StateWiseMemberShipAssembly} at the end of this chapter.
\end{enumerate}
...
\begin{enumerate}
  \item It ratified the India's membership of the Commonwealth in 1949\index{Date!1949}.
  \item It adopted the national flag on January 24, 1950\index{Date!January 24, 1950}.
  \item It adopted the national anthem on January 24, 1950\index{Date!January 24, 1950}.
  \item It adopted the national song on January 24, 1950\index{Date!January 24, 1950}.
  \item It elected \gls{person:DrRajendraPrasadgT6} as the first President of India on January 24, 1950\index{Date!January 24, 1950}.
\end{enumerate}
...
On January 24, 1950\index{Date!January 24, 1950}, the Constituent Assembly held its final session. It however, did not end, and continued as the provisional parliament of India from January 26, 1950\index{Date!January 26, 1950} till the formation of new Parliament\endnote{The Provisional Parliament ceased to exist on \gls{date:April171952ily}\index{Date!\gls{date:April171952ily}}. The first elected Parliament with the two Houses came into being in 1952\index{Date!1952}.} after the first general elections in 1951-52.
...
\begin{enumerate}
  \item \gls{committee:UnionPowersCommitteecWL} - \gls{person:JawaharlalNehruTDZ}
  \item \gls{committee:UnionConstitutionCommitteeftm} - \gls{person:JawaharlalNehruTDZ}
  \item \gls{committee:ProvincialConstitutionCommitteeo0T} - \gls{person:SardarVallabhbhaiPatelVeT}
  \item \gls{committee:DraftingCommitteeThE} - \gls{person:DrBRAmbedkarzWS}
  \item \gls{committee:AdvisoryCommitteetLg} on Fundamental Rights\index{Fundamental Rights}, Minorities and Tribal and Excluded Areas - \gls{person:SardarVallabhbhaiPatelVeT}. This committee had the following five sub-committees:
  \begin{enumerate}
    \item \gls{committee:FundamentalRightsSubCommitteeaDO} - \gls{person:JBKripalaniZCb}
    \item \gls{committee:MinoritiesSubCommitteenc7} - \gls{person:HCMukherjeejgr}
    \item \gls{committee:NorthEastFrontierTribunalAreasSubCommitteeNqj} (with Assam Excluded \& Partially Excluded Areas) - \gls{person:GopinathBardoloi9TZ}
    \item \gls{committee:ExcludedandPartiallyExcludedAreas6LK} Other than those in Assam Sub Committee - \gls{person:AVThakkar25d}
    \item \gls{committee:NorthWestFrontierTribalAreasSubCommitteekl7}\endnote{One of the political consequences of the British Government’s statement of May 03, 1947\index{Date!May 03, 1947}, was that following a referendum, the North-West Frontier Province and Baluchistan became part of the territory of the Dominion of Pakistan and as a result the tribal areas in this region became a concern of that Dominion. The Sub-Committee on the Tribal Areas in the North-West Frontier Province and Baluchistan was not therefore called upon to function on behalf of the Constituent Assembly of India. (B. Shiva Rao, The Framing of India’s Constitution : Select Documents, Volume III, P.681.) The members of this Sub-Committee were : Khan Abdul Ghaffar Khan, Khan Abdul Samad Khan and Mehr Chand Khanna. The information about the Chairman is not found.}
  \end{enumerate}
  
  \item \gls{committee:RulesofProcedureCommitteefRs} - \gls{person:DrRajendraPrasadgT6}
  \item \gls{committee:StatesCommitteeCommitteeforNegotiatingwithStatesIXI} - \gls{person:JawaharlalNehruTDZ}
  \item \gls{committee:SteeringCommittee1vQ} - \gls{person:DrRajendraPrasadgT6}
\end{enumerate}

\subsection{Minor Committees}

\begin{enumerate}
  \item \gls{committee:FinanceandStaffCommitteeIQn} - \gls{person:DrRajendraPrasadgT6}
  \item \gls{committee:CredentialsCommitteexdq} - \gls{person:AlladiKrishnaswamiAyyarWx2}
  \item \gls{committee:HouseCommitteeyKx} - \gls{person:BPattabhiSitaramayyabkr}
  \item \gls{committee:OrderofBusinessCommitteeSq5} - \gls{person:DrKMMunshikVt}
  \item \gls{committee:AdhocCommitteeontheNationalFlagdI2} - \gls{person:DrRajendraPrasadgT6}
  \item \gls{committee:CommitteeontheFunctionsoftheConstituentAssemblykJq} - \gls{person:GVMavalankarqvU}
  \item \gls{committee:AdhocCommitteeontheSupremeCourt4FH} - \gls{person:SVaradachariDSM} (Not an Assembly Member)
  \item \gls{committee:CommitteeonChiefCommissionersProvinces02l} - \gls{person:BPattabhiSitaramayyabkr}
  \item \gls{committee:ExpertCommitteeontheFinancialProvisionsoftheUnionConstitutionVEn} - \gls{person:NaliniRanjanSarkarS9D} (Not an Assembly Member)
  \item \gls{committee:LinguisticProvincesCommissionHlh} - \gls{person:SKDartUU} (Not an Assembly Member)
  \item \gls{committee:SpecialCommitteetoExaminetheDraftConstitution8Qm} - \gls{person:JawaharlalNehruTDZ}
  \item \gls{committee:PressGalleryCommitteeddP} - \gls{person:UshaNathSen6of}
  \item \gls{committee:AdhocCommitteeonCitizenship5Qh} - \gls{person:SVaradachariDSM}
\end{enumerate}


\subsection{\gls{committee:DraftingCommitteeThE}}

Among all the committees of the Constituent Assembly, the most important committee was the \gls{committee:DraftingCommitteeThE} set up on \gls{date:August291947hNb}\index{Date!\gls{date:August291947hNb}}. It was this committee that was entrusted with the task of preparing a draft of the new Constitution. It consisted of seven members. They were

\begin{enumerate}
  \item \gls{person:DrBRAmbedkarzWS} ({\colord Chairmen})
  \item \gls{person:NGopalaswamyAyyangarzCT}
  \item \gls{person:AlladiKrishnaswamiAyyarWx2}
  \item \gls{person:DrKMMunshikVt}
  \item \gls{person:SayedMohammadSaadullahEkc}
  \item \gls{person:NMadhavaRaubZ7} (He replaced \gls{person:BLMittern6a} who resined due to ill-health)
  \item \gls{person:TTKrishnamacharizos} (He replaced \gls{person:DPKhaitanInY} who died in 1948)
\end{enumerate}

The \gls{committee:DraftingCommitteeThE}, after taking into consideration the proposal of the various committees, prepared the first draft of the Constitution of India, which was published in 1948\index{Date!1948}. The people of India were given eight months to discuss the draft and propose amendments. In the light of the public comments, criticisms and suggestions, the \gls{committee:DraftingCommitteeThE} prepared a second draft, which was published in 1948\index{Date!1948}.

The \gls{committee:DraftingCommitteeThE} took less than six months to prepare its draft. In all it say for 141 days.

\section{Enactment of the Constitution}

\gls{person:DrBRAmbedkarzWS} introduced the final draft of the Constitution in the Assembly on November 04, 1948\index{Date!November 04, 1948} (first reading). The Assembly had a general discussion on it for five days (till November 09, 1948\index{Date!November 09, 1948}).

The second reading (clause by clause consideration) started on \gls{date:November151948gtS}\index{Date!\gls{date:November151948gtS}} and ended on \gls{date:October171949DsJ}\index{Date!\gls{date:October171949DsJ}}. During this stage, as many as 7653 amendments were proposed and 2473 were actually discussed in the Assembly.

The third reading of the draft started on \gls{date:November141949OVh}\index{Date!\gls{date:November141949OVh}}. \gls{person:DrBRAmbedkarzWS} moved a motion - `the Constitution as settled by the Assembly be passed'. The motion on Draft Constitution was declared as passed on \gls{date:November261949Ak7}\index{Date!\gls{date:November261949Ak7}}, and received the signatures of the members and the president. Out of a total 299 members of the Assembly, only 284 were actually present on that day and signed the Constitution. This is also the date mentioned in the Preamble as the date on which the people of India in the Constituent Assembly adopted, enacted and gave to themselves this Constitution.

{\colord The Constitution as adopted on \gls{date:November261949Ak7}\index{Date!\gls{date:November261949Ak7}}, contained a Preamble, 395 Articles and 8 Schedules}. The Preamble was enacted after the entire Constitution was already enacted.

\gls{person:DrBRAmbedkarzWS}, the then Law Minister, piloted the Draft Constitution in the Assembly. He took a very prominent part in the deliberations of the Assembly. He was known for his logical, forceful and persuasive arguments on the floor of the Assembly. He is recognized as the `Father of the Constitution of India'. This brilliant writer, constitutional expert, undisputed leader of the scheduled castes and the `chief architech of the Constitution of India' is also known as a `Modern Manu'.

\section{Enforcement of the Constitution}

Some provisions of the Constitution pertaining to citizenship, elections, provisional parliament, temporary and transitional provisions, and short title contained in Articles 5, 6, 7, 8, 9, 60, 324, 366, 367, 379, 380, 388, 391, 392 and 393 came into force on \gls{date:November261949Ak7}\index{Date!\gls{date:November261949Ak7}}, itself.

The remaining provisions(the major part) of the Constitution came into force on January 26, 1950\index{Date!January 26, 1950}. This day is referred to in the Constitution as the `date of it commencement', and celebrated as the Republic Day.
...
\begin{enumerate}
  \item \textbf{Not a Representative Body}: The critics have argued that the Constituent  Assembly was not a representative body as its members were not directly elected by the people of India on the basis of universal adult franchise\index{universal adult franchise}.
  ...
  \item \textbf{Time Consuming}: According to the critics, the Constituent Assembly took unduly long time to make the Constitution. They stated that the framers of the American Constitution took only four months to complete their work. In this context, \gls{person:NaziruddinAhmedetw}, a member of the Constituent Assembly, coined a new name for the \gls{committee:DraftingCommitteeThE} to show his contempt for it. He called it a \enquote{Drifting Committee}.
  \item \textbf{Dominated by Congress}: The critics charged that the Constituent Assembly was dominated by the Congress party. \gls{person:GranvilleAustinuHu}, a British Constitutional expert, remarked: `The Constituent Assembly was a one-party body in an essentially one-party country. The Assembly was the Congress and the Congress was India'\endnote{\gls{person:GranvilleAustinuHu}, The Indian Constitution—Cornerstone of a Nation, Oxford, 1966, P. 8.}.
  ...
  \item \textbf{Dominated by Hindus}: According to some critics, the Constituent Assembly was a Hindu dominated body. \gls{person:LordViscountSimonTPR} called it `a body of Hindus'. Similarly, \gls{person:WinstonChurchillQUM} commented that the Constituent Assembly represented `only one major community in India'.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \gls{person:SirBNRauOkG} was appointed as the constitutional advisor (Legal advisor) to the Constituent Assembly.
  \item \gls{person:HVRIyengarFcO} was the Secretary to the Constituent Assembly.
  \item \gls{person:SNMukerjeeIHU} was the chief draftsman of the constitution in the Constituent Assembly.
  \item \gls{person:PremBehariNarainRaizadal3O} was the calligrapher of the Indian Constitution. The original constitution was handwritten by him in a flowing italic style.
  \item The original version was beautified and decorated by artists from Shantiniketan including \gls{person:NandLalBosemIR} and \gls{person:BeoharRammanoharSinharYT}.
  \item \gls{person:BeoharRammanoharSinharYT} illuminated, beautified and ornamented the original Preamble calligraph-ed by \gls{person:PremBehariNarainRaizadal3O}.
  \item The calligraphy of the Hindi version of the original constitution was done by \gls{person:VasantKrishanVaidya091} and elegantly decorated and illuminated by \gls{person:NandLalBosemIR}.
\end{enumerate}
...
\begin{longtable}[c]{@{}|p{1cm}p{1cm}|p{6cm}|p{4cm}|@{}}
  \caption{State wise Membership of the Constituent Assembly of India as on \gls{date:December311947bco}\index{Date!\gls{date:December311947bco}}}
...
It should be notes al the outset that a number of original features of the Constitution (as adopted in 1949) have undergone a substantial change, on account of several amendments, particularly 7th, 42nd, 44th, 73rd, 74th and 97th Amendments. In fact, the 42nd Amendment Act of 1976, is known as `Mini-Constitution' due to the important and large number of changes made by it in various parts of the Constitution. However, in the {\colord \textit{\gls{person:KeshavanandaBhartiiYC}}} case\endnote{Kesavananda Bharati vs State of Kerala, (1973)} (1973), the Supreme Court rules that the constitution power of Parliament under Article 368 does not enable it to alter the `basic structure' of the Constitution.
...
The Constitution of India has borrowed most of its provisions from the constitutions of various other countries as well as from the Government of India Act\endnote{About 250 provisions of the 1935 Act have been included in the Constitution.} of 1935. \gls{person:DrBRAmbedkarzWS} proudly acclaimed that the Constitution of India has been framed after `ransacking all the known Constitution of the World\endnote{Constituent Assembly Debates, Volume VII, P. 35–38.}'.
...
The Constitution of India establishes a federal system of government. It contains all the usual features of a federation, viz., two government, division of powers, written Constitution, supremacy of Constitution, rigidity of Constitution, independent judiciary and bicameralism\index{bicameralism}.
...
Hence, the Indian Constitution has been variously described a `federal in form but unitary in spirit', `quasi-federl' by \gls{person:KCWheareTb5}, `bargaining federalism' by \gls{person:MorrisJonesVrO}, `co-operative federalism' by \gls{person:GranvilleAustinuHu}, `federation with a centralizing tendency' by \gls{person:IvorJennings2hd}, and so on.
...
However, the Fundamental Rights\index{Fundamental Rights} are not absolute the subject to reasonable restrictions. Further, they are not sacrosanct and can be curtailed or repealed by the Parliament through a constitutional amendment act. They can also be suspended during the operation of National Emergency except the rights guaranteed by Article 20 and 21.

\subsection{Directive Principles of State Policy}

According to \gls{person:DrBRAmbedkarzWS}, the Directive Principles of State Policy is a `novel feature' of the Indian Constitution. They are enumerated in Part IV of the Constitution. They can be classified into three broad categories — socialistic, Gandhian and liberal-intellectual.
...
In the {\colord \textit{Minerva Mills}} case\endnote{Minerva Mills v.Union of India, (1980).} (1980), the Supreme Court held that `the Indian Constitution is founded on the bedrock of the balance between the Fundamental Rights\index{Fundamental Rights} and the Directive Principles'.

\subsection{Fundamental Duties}

The original constitution did not provide for the fundamental duties of the citizens. These were added during the operation of internal emergency(1975-77) by the 42nd Constitutional Amendment Act of 1976, on the recommendation of the \gls{committee:SwaranSinghCommittee20t}. The 86the Constitutional Amendment Act of 2002, added one more fundamental duty.
...
Moreover, the Constitution has also abolished the old system of communal representation\index{communal representation}\endnote{The 1909, 1919, and 1935 Acts provided for communal representation\index{communal representation}.}, that is, reservation of seats in the legislature on the basis of religion. However, it provides for the temporary reservation of seats for the scheduled castes and scheduled tribes to ensure adequate representation to them.

\subsection{Universal Adult Franchise\index{Adult Franchise}}

The Indian Constitution adopts universal adult franchise\index{universal adult franchise} as a basis of elections to the Lok Shabha and the state legislative assemblies. Every citizen who is not less then 18 years of age has a right to vote without any discrimination of caste, race, religion, sex, literacy, wealth, and so on. The voting age was reduced to 18 years from 21 years in 1989 by the 61st Constitutional Amendment Act of 1988.

The Introduction of universal adult franchise\index{universal adult franchise} by the Constitution-makers was bold experiment and highly remarkable in view of the vast size of the country, its huge population, high poverty, social inequality and overwhelming illiteracy.\endnote{Even in the western countries, the right to vote was extended only gradually. For example, USA gave franchise to women in 1920, Britain in 1928, USSR (now Russia) in 1936, France in 1945, Italy in 1948 and Switzerland in 1971.}
...
\renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
\begin{enumerate}
  \item National emergency on the ground of war or externam aggression or armed rebellion\endnote{The 44th Amendment Act of 1978, has replaced the original term `internal disturbance' by the new term `armed rebellion'.} (Article 352)
...
\begin{enumerate}
  ...
  \item It added a new Part IX-B in the Constitution which is entitled as \enquote{The Co-operative societies} (Article 243-ZH to 243-ZT).
\end{enumerate}
...
While answering the above criticism in the Constituent Assembly, \gls{person:DrBRAmbedkarzWS}, the Chairman of the \gls{committee:DraftingCommitteeThE}, said: \enquote{One likes to ask whether there can be antthin new in Constitution framed at this hour in the history of the world. More than hundred years have rolled over when the first written constitution was drafted. It has been followed by many countries reducing their constitution to writing. What the scope of a constitution should be has long been settled. Similarly, what are the fundamentals of a constitution are recognized all over the world. Given these facts, all constitutions in thir main provision must look similar. The only new things, if there can be any, in a constitution framed so late in the day are the variations made to remove the faults and to accommodate it to the needs of country. The charge of providing a blind copy of the constitutions of other countries is based, I am sure, on an inadequate study of the Constitution}\endnote{Constituent Assembly Debates, Volume VII, pp.35-38.}.

\paragraph{A Carbon Copy of the 1935 Act}

The critics said that the framers of the constitution have included a large number of the provision of the Government of India Act of 1935\index{Acts!Government of India Act of 1935} into the Constitution of India. Hence, they called the constitutions a \enquote{Carbon Copy of the 1935 Act} or an \enquote{amended version of the 1935 Act}. For example, \gls{person:NShrinivasan4P9} observed that the Indian Constitution is \enquote{both in language and substance a close copy of the Act of 1935}. Similarly, Sir \gls{person:IvorJennings2hd}, a British Constitutionalist, said that \enquote{the constitution derives directly from the Government of India Act of 1935\index{Acts!Government of India Act of 1935} from which, in fact, many of its provisions are copied almost textually}.

Further, \gls{person:PRDeshmukhvIc}, a member of the Constituent Assembly, commented that \enquote{the constitution is essentially the Government of India Act of 1935\index{Acts!Government of India Act of 1935} with only adult franchise added}.

The same \gls{person:DrBRAmbedkarzWS} answered the above criticism in the Constituent Assembly in the following way: \enquote{As to the accusation that the Draft Constitution has reproduced a good part of the provision of the Government of India Act, 1935, I make no apologies. There is nothing to be ashamed of in borrowing. It involves no plagiarism. Nobody hold any patent rights in the fundamental ideas of a Constitution. What I am sorry about is that the provision taken from the Government of India Act, 1935, relate mostly to the details of administration}\endnote{Ibid.}.

\paragraph{Un-Indian or Anti-India}

According to the critics, the Indian Constitution is `un-Indian' or `anti-Indian' because it does not reflect the political tradition and the spirit of India. They said that the foreign nature of the Constitution makes it unsuitable to the Indian situation or unworkable in India. In this context, \gls{person:KHanumanthaiyahdv}, a member of the Constituent Assembly, commented: \enquote{We wanted the music of Veena or Sitar, but here we have the music of an English band. That was because out constitution-makers were educated that way}\endnote{Constituent Assembly Debates, Volume XI, P.616.}. Similarly, \gls{person:KHanumanthaiyahdv}, another member of the Constituent Assembly, criticized the constitution as \enquote{slavish imitation of the west, much more - a slavish surrender to the west}\endnote{Constituent Assembly Debates, Volume VII, P.242.}. Further, \gls{person:LaxminarayanSahuRBb}, also a member of Constituent Assembly, observed: \enquote{The ideals on which this draft constitution is framed have no manifest relation to the fundamental spirit of India. This constitution would not prove suitable and would break down soon after being brought into operation}\endnote{Constituent Assembly Debates, Volume XI, P.613.}.

\paragraph{An Un-Gandhian Constitution}

According to the critics, the Indian Constitution is Un-Gandhian because it does not contain the philosophy and ideals of \gls{person:MahatmaGandhi5Y9}, the father of the Indian Nation. They opined that the Constitution should have been raised and build upon village panchayats. In this context, the same member of the Constituent Assembly, \gls{person:KHanumanthaiyahdv}, said: \enquote{That is exactly the kind of Constitution \gls{person:MahatmaGandhi5Y9} did not want and did not envisage}.\endnote{Constituent Assembly Debates, Volume XI, P.617.} \gls{person:TPrakasam9YR}, another member of the Constituent Assembly, attributed this lapse to \gls{person:DrBRAmbedkarzWS}'s non-participation in the Gandhian movement and the antagonism towards Gandhian ideas\endnote{Constituent Assembly Debates, Volume VII, P.387.}.

\paragraph{Elephantine Size}

The critics stated that the Indian Constitution is too bulky and too detailed and contains some unnecessary elements. Sir \gls{person:IvorJennings2hd}, a British Constitutionalist, observed that the provisions borrowed were not always well-selected and that the constitution, generally speaking, was too long and complicated.\endnote{\gls{person:IvorJennings2hd}, Some Characteristics of the Indian Constitution, Oxford University Press, Madras, 1953, PP.9-16.}

In this context, \gls{person:HVKamathYD7}, a member of the Constituent Assembly, commented: \enquote{The emblem and the crest we have selected for our assembly is an elephant. It is perhaps in consonance with that our constitution too is the bulkiest in the world has produced}.\endnote{Constituent Assembly Debates, Volume VII, P.1042.} He also said: \enquote{I am sure, the House does not agree that we should make the Constitution an elephantine one}.\endnote{Constituent Assembly Debates, Volume VIII, P.127.}

\paragraph{Paradise of the Lawyers}

According to the critics, the Indian Constitution is too legalistic and very complicated. They opined that the legal language and phraseology adopted in the constitution makes it a complex document. The same Sir \gls{person:IvorJennings2hd} called it a \enquote{lawyer's paradise}.

In this context, \gls{person:HKMaheswaripYD}, a member of the Constituent Assembly observed: \enquote{The draft tends to make people more litigious, more inclined to go to courts, less truthful and less likely to follow the methods of truth and non-violence. If I may so, the Draft is really a lawyer's paradise. It opens up vast avenues of litigation and will give our able and ingenious lawyers plenty of work to do}.\endnote{Constituent Assembly Debates, Volume VII, P.293.}

Similarly, \gls{person:PRDeshmukhvIc}, another member of the Constituent Assembly, said: \enquote{I should, however, like to say that the draft of the articles that have been brought before the House by \gls{person:DrBRAmbedkarzWS} seems to my mind to be far too ponderous like the ponderous tomes of a law manual. A document dealing with a constitution hardly uses so much of padding and so much of verbiage. Perhaps it is difficult for them to compose a document which should be, to my mind, not a law but a socio-political document, a vibration, pulsating and life giving document. But to our misfortune, that was not to be, and we have been burdened with so much of words, words and words which could have been very easily eliminated}.\endnote{Constituent Assembly Debates, Volume IX, P.613.}
...
\begin{longtable}[c]{@{}|p{1cm}|p{7cm}|p{4cm}|@{}}
  ...
  III & Fundamental Rights\index{Fundamental Rights} & 12 to 35 \\\midrule
...
The American Constitution was the first to begin with a Preamble. Many countries, including India, followed this practice. The term `preamble' refers to the introduction or preface to the Constitution. It contains the summary or essence of the Constitution. \gls{person:NAPalkivalavLj}, an eminent jurist and constitutional expert, called the Preamble as the `identity card of the Constitution'.

The Preamble to the Indian Constitution is based on the `Objectives Resolution\index{Objectives Resolution}', draft and moved by \gls{person:JawaharlalNehruTDZ}, and adopted by the Constituent Assembly\endnote{1}. It has been amended by the 42nd Constitutional Amendment Act of 1976, which added three new words — socialist, secular and integrity.
...
\end{list}
\textbf{IN OUR CONSTITUENT ASSEMBLY} this twenty-sixth day of 1949\index{Date!1949}, do \textbf{HEREBY ADOPT, ENACT AND GIVE TO OURSELVES THIS CONSTITUTION}.\textquotedblright
...
\begin{enumerate}
  ...
  \item \textbf{Date of adoption of the Constitution}: It stipulates \gls{date:November261949Ak7}\index{Date!\gls{date:November261949Ak7}}, as the date.
\end{enumerate}
...
The word `sovereign' implies that India is neither a dependency nor a dominion of any other nation, but an independent state\endnote{2}. There is no authority above it, and it is free to conduct its own affairs (both internal and external).
...
Even before the term was added by the 42nd Amendment of 1976, the Constitution had a socialist content in the form of certain Directive Principles of State Policy. In other words, what was hitherto implicit in the Constitution has now been made explicit. Moreover, the Congress party itself adopted a resolution\endnote{5} to establish a `socialistic pattern of society' in its Avadi session as early as in 1955 and took measures accordingly. Notably, the Indian brand of socialism is a `democratic socialism' and not a `communistic socialism' (also known as `state socialism') which involves the nationalisation of all means of production and distribution and the abolition of private property. Democratic socialism, on the other hand, holds faith in a `mixed economy' where both public and private sectors co-exist side by side\endnote{6}. As the Supreme Court says, `Democratic socialism aims to end poverty, ignorance, disease and inequality of opportunity\endnote{7}. Indian socialism is a blend of Marxism and Gandhi-ism, leaning heavily towards Gandhian socialism'. The new economic policy (1991) of liberalization, privatization and globalization has, however, diluted the socialist credentials of the Indian State.
