...
In a bid to rectify the defects of the Regulating Act of 1773, the British Parliament passed the Amending Act of 1781, also known as the Act of Settlement. The next important act was the Pitt's India Act\footnote{It was introduced in the British Parliament by the then Prime Minister, \gls{person:WilliamPitt44D}} of 1784.
...
\paragraph{Features of the Act}
\begin{enumerate}
  \item It provided that India henceforth was to be governed by, and in the name of, Her Majesty. It changed the designation of th Governor-General of India to that of Viceroy of India. He (viceroy) was the direct representative of the British Crown in India. \gls{person:LordCanning1PN} thus became first Viceroy of India.
...
\begin{enumerate}
  ...
  \item It also provided for the establishment of new legislative councils for Bengal, \gls{NorthWesternFrontierProvinceaag} (NWFP) and Panjab, which were established in 1862, 1866 and 1897 respectively.
  \item It empowered the Viceroy to make rules and orders for the more convenient transaction of business in the council. It also gave a recognition to the  \quotesingle{portfolio} system, introduced by \gls{person:LordCanning1PN}\gls{person:LordCanning1PN} in 1859. Under this, a member of the Viceroy's council was made in-charge of one or more departments of the government and was authorized to issue final orders on behalf of the council on matters of his department(s).
...
This Act is also known as Morley-Minto Reforms (Lord Morley was the then Secretary of State for India and \gls{person:LordMintoDxi} was the then Viceroy of India).
\begin{enumerate}
  ...
  \item It provided (for the first time) for the association of Indians with the executive Councils of the Viceroy and Governors. \gls{person:SatyendraPrasadSinhaXBU} became the first Indian to join the Viceroy's Executive Council. He was appointed as the law member.
  \item It introduced a system of communal representation for Muslims by accepting the concept of \quotesingle{\gls{SeparateElectoratebtS}}. Under this, the Muslim members were to be elected only by Muslim voter. Thus, the Act \quotesingle{legalized communal-ism} and \gls{person:LordMintoDxi} came to be known as the Father of Communal Electorate.
...
On Feburary 20, 1947, the British Prime Minister \gls{person:ClementAtleeOtp} declared that the British rule in India would end by \gls{date:June201948FcI}; after which the power would be transferred to responsible Indian hands. This announcement was followed by the agitation by the Muslim League demanding partition of the country. Again on \gls{date:June31947fgq}, the British Government made it clear that any Constitution framed by the Constituent Assembly of India (formed in 1946) cannot apply to those parts of the country which were unwilling to accept it. On the same day (\gls{date:June31947fgq}), \gls{person:LordMountbettenYou}, the viceroy of India, put forth the partition plan known as the Mountbatten Plan. The plan was accepted by the Congress and the Muslim League. Immediate effect was given to the plan by enacting the Indian Independence Act\footnote{The Indian Independence Bill was introduced in the British Parliament on \gls{date:July41947h8h} and received the Royal Assent on \gls{date:July1819472q5}. The act came into force on \gls{date:August1519477FM}.} (1947).

\paragraph{Features of the Act}
\begin{enumerate}
  \item It ended the British rule in India and declared India as an independent and sovereign state from \gls{date:August1519477FM}.
  ...
  \item It proclaimed the lapse of British paramountcy over the Indian princely states and treaty relations with tribal areas from \gls{date:August1519477FM}.
  ...
  \item It discontinued the appointment to civil services and reservation of posts by the secretary of state for India. The members of the civil services appointed before \gls{date:August1519477FM} would continue to enjoy all benefits that they were entitled to till that time.
\end{enumerate}

At the stroke of midnight 14-15 August, 1947, the British rule came to an end and power was transferred to the two new independent Dominions of India and Pakistan\footnote{The boundaries between the two Dominions were determined by a Boundary Commission headed by Radcliff. Pakistan included the provinces of West Punjab, Sind, Baluchistan, East Bengal, \gls{NorthWesternFrontierProvinceaag} and the district of Sylhet in Assam. The referendum in the \gls{NorthWesternFrontierProvinceaag} and Sylhet was in favor of Pakistan.}. \gls{person:LordMountbettenYou} became the first governor-general of the new Dominion of India. He swore in \gls{person:JawaharlalNehrul1w} as the first prime minister of independent India. The Constituent Assembly of India formed in 1946 became the Parliament of the Indian Dominion.
...
\begin{longtable}[c]{@{}|l|l|l|@{}}
  ...
  \endlastfoot
  %
  1. & \gls{person:JawaharlalNehrul1w} & External Affairs \& Commonwealth \\
     &                           & Relations \\
  2. & \gls{person:SardarVallabhbhaiPateljHC} & Home, Information \& Broadcasting \\
  3. & \gls{person:DrRajendraPrasadvtO} & Food \& Agriculture \\
  4. & \gls{person:DrJohnMathaivn7} & Industries \& Supplies \\
  5. & \gls{person:JagjivanRampXY} & Labor \\
  6. & \gls{person:SardarBaldevSinghHiy} & Defense \\
  7. & \gls{person:CHBhabhavbO} & Works, Mines \& Power \\
  8. & \gls{person:LiaquatAliKhanQea} & Finance \\
  9. & \gls{person:AbdurRabNishtar8ZY} & Posts \& Air \\
  10. & \gls{person:AsafAli7sv} & Railways \& Transport \\
  11. & \gls{person:CRajagopalachariH3H} & Education \& Arts \\
  12. & \gls{person:IIChundrigargux} & Commerce \\
  13. & \gls{person:GhaznafarAliKhanW41} & Health \\
  14. & \gls{person:JoginderNathMandalM3E} & Law \\* \bottomrule
\end{longtable}
\textit{\textbf{Note}}: The members of the interim government were members of the Viceroy's Executive Council. The Viceroy continues to be the head of the Council. But, \gls{person:JawaharlalNehrul1w} was designated as the Vice-President of the Council.
...
\begin{longtable}[c]{@{}|l|l|l|@{}}
	...
	\endlastfoot
	%
	1. & \gls{person:JawaharlalNehrul1w} & Prime Minister; External Affairs \& Commonwealth \\
	&                           & Relations; Scientific Research \\
	2. & \gls{person:SardarVallabhbhaiPateljHC} & Home, Information \& Broadcasting; States \\
	3. & \gls{person:DrRajendraPrasadvtO} & Food \& Agriculture \\
	4. & \gls{person:MaulanaAbulKalamAzadCNw} & Education \\
	5. & \gls{person:DrJohnMathaivn7} & Railway \& Transport \\
	6. & \gls{person:RKShanmughamIhL} & Finance \\
	7. & \gls{person:DrBRAmbedkarCQc} & Law \\
	8. & \gls{person:JagjivanRampXY} & Labor \\
	9. & \gls{person:SardarBaldevSinghHiy} & Defense \\
	10. & \gls{person:RajKumariAmritKaurdWa} & Health \\
	11. & \gls{person:CHBhabhavbO} & Commerce \\
	12. & \gls{person:RafiAhmedKidwaiHnJ} & Communication \\
	13. & \gls{person:DrShyamaPrasadMukherjif5W} & Industries \& Supplies \\
	14. & \gls{person:VNGadgilooM} & Works, Mines \& Power \\* \bottomrule
\end{longtable}
...
Although the Constituent Assembly was not directly elected by the people of India on the basis of adult franchise, the Assembly comprised representatives of all section of Indian Society - Hindus, Muslims, Sikhs, Parsis, Anglo-Indians, Indian Christians, SCs, STs including women of all these sections. The Assembly included all important personalities of India at that time, with the exception of \gls{person:MahatmaGandhiCch}.

\section{Working of the Constituent Assembly}

The Constituent Assembly held its first meeting on \gls{date:December91946zPs}. The Muslim League boycotted the meeting and insisted on a separate state of Pakistan. The meeting was thus attended by only 211 members. {\colord{}\gls{person:DrSachchidanandSinhaMuK}, the oldest member, was elected as the temporary President of the Assembly, following the French practice.}

Later, \gls{person:DrRajendraPrasadvtO} was elected as the President of the Assembly. Similarly, both \gls{person:HCMukherjee5Tt} and \gls{person:VTKrishnamachiIXJ} were elected as the Vice-Presidents of the Assembly. In other words, the Assembly had two Vice-Presidents.

\paragraph{Objectives Resolution}

On \gls{date:December131946q21}, \gls{person:JawaharlalNehrul1w} moved the historic \quotesingle{Objectives Resolution} in the Assembly. It laid down the fundamentals and philosophy of the constitutional structure. It read:
...
The representatives of the princely states, who had stayed awat from the Constituent Assembly, gradually joined in. On \gls{date:April2819478i2}, representatives of the six states\footnote{These include Baroda, Bikaner, Jaipur, Patiala, Rewa and Udaipur.} were part of the Assembly. After the acceptance of Mountbatten Plan of \gls{date:June31947fgq} for a partition of the country, the representatives of most of the other princely states took their seats in the Assembly. The members of the Muslim League from the Indian Dominion also entered the Assembly.
...
\begin{enumerate}
  ...
  \item The Assembly also became a legislative body. In other words, two separate functions were assigned to the Assembly, that is, making of a constitution for free India and enacting of ordinary laws for the country. These two tasks were to be performed on separate days. Thus, the Assembly became the first Parliament of free India (Dominion Legislature). Whenever the Assembly met as the Constituent body it was chaired by \gls{person:DrRajendraPrasadvtO} and when it met as the legislative body\footnote{For the first time, the Constituent Assembly met as Dominion Legislature on \gls{date:November171947weI} and elected \gls{person:GVMavalankartkW} as its speaker.}, it was chaired by \gls{person:GVMavalankartkW}. These two functions continued till \gls{date:November261949Esr}, when the task of making the Constitution was over.
  \item The Muslim League members (hailing from the areas\footnote{These are West Punjab, East Bengal, NWFP, Sindh, Baluchistan and Sylhet District of Assam. A separate Constituent Assembly was set up for Pakistan.} included in the Pakistan) withdrew from the Constituent Assembly for India. Consequently, the total strength of the Assembly came down to 299 as against 389 originally fixed in 1946 under the Cabinet Mission Plan. The strength of the Indian provinces (formerly British Provinces) was reduced from 296 to 299 and those of the princely states from 93 to 70. The state-wise membership of the Assembly as on \gls{date:December311947hLv}, is shown in \ref{tab:StateWiseMemberShipAssembly} at the end of this chapter.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item It elected \gls{person:DrRajendraPrasadvtO} as the first President of India on January 24, 1950.
\end{enumerate}
...
On January 24, 1950, the Constituent Assembly held its final session. It however, did not end, and continued as the provisional parliament of India from January 26, 1950 till the formation of new Parliament\footnote{The Provisional Parliament ceased to exist on \gls{date:April171952q5v}. The first elected Parliament with the two Houses came into being in May 1952.} after the first general elections in 1951-52.
...
\begin{enumerate}
  \item \gls{committee:UnionPowersCommitteePzk} - \gls{person:JawaharlalNehrul1w}
  \item \gls{committee:UnionConstitutionCommitteeSd1} - \gls{person:JawaharlalNehrul1w}
  \item \gls{committee:ProvincialConstitutionCommitteeN7H} - \gls{person:SardarVallabhbhaiPateljHC}
  \item \gls{committee:DraftingCommitteezzK} - \gls{person:DrBRAmbedkarCQc}
  \item \gls{committee:AdvisoryCommitteew1l} on Fundamental Rights, Minorities and Tribal and Excluded Areas - \gls{person:SardarVallabhbhaiPateljHC}. This committee had the following five sub-committees:
  \begin{enumerate}
    \item \gls{committee:FundamentalRightsSubCommitteePIx} - \gls{person:JBKripalaninct}
    \item \gls{committee:MinoritiesSubCommitteej2R} - \gls{person:HCMukherjee5Tt}
    \item \gls{committee:NorthEastFrontierTribunalAreasSubCommitteeXIz} (with Assam Excluded \& Partially Excluded Areas) - \gls{person:GopinathBardoloikQY}
    \item \gls{committee:ExcludedandPartiallyExcludedAreasQCg} Other than those in Assam Sub Committee - \gls{person:AVThakkarblq}
    \item \gls{committee:NorthWestFrontierTribalAreasSubCommitteeIkM}\footnote{One of the political consequences of the British Government’s statement of \gls{date:June31947fgq}, was that following a referendum, the North-West Frontier Province and Baluchistan became part of the territory of the Dominion of Pakistan and as a result the tribal areas in this region became a concern of that Dominion. The Sub-Committee on the Tribal Areas in the North-West Frontier Province and Baluchistan was not therefore called upon to function on behalf of the Constituent Assembly of India. (B. Shiva Rao, The Framing of India’s Constitution : Select Documents, Volume III, P.681.) The members of this Sub-Committee were : Khan Abdul Ghaffar Khan, Khan Abdul Samad Khan and Mehr Chand Khanna. The information about the Chairman is not found.}
  \end{enumerate}
  
  \item \gls{committee:RulesofProcedureCommittee9Gg} - \gls{person:DrRajendraPrasadvtO}
  \item \gls{committee:StatesCommitteeCommitteeforNegotiatingwithStatesLIq} - \gls{person:JawaharlalNehrul1w}
  \item \gls{committee:SteeringCommitteex9G} - \gls{person:DrRajendraPrasadvtO}
\end{enumerate}

\subsection{Minor Committees}

\begin{enumerate}
  \item \gls{committee:FinanceandStaffCommittee7RP} - \gls{person:DrRajendraPrasadvtO}
  \item \gls{committee:CredentialsCommitteeOXj} - \gls{person:AlladiKrishnaswamiAyyar3Xu}
  \item \gls{committee:HouseCommitteedEe} - \gls{person:BPattabhiSitaramayya6ai}
  \item \gls{committee:OrderofBusinessCommitteemE2} - \gls{person:DrKMMunshiIfu}
  \item \gls{committee:AdhocCommitteeontheNationalFlagzGS} - \gls{person:DrRajendraPrasadvtO}
  \item \gls{committee:CommitteeontheFunctionsoftheConstituentAssemblyS4q} - \gls{person:GVMavalankartkW}
  \item \gls{committee:AdhocCommitteeontheSupremeCourtQ5D} - \gls{person:SVaradacharijJH} (Not an Assembly Member)
  \item \gls{committee:CommitteeonChiefCommissionersProvincesERB} - \gls{person:BPattabhiSitaramayya6ai}
  \item \gls{committee:ExpertCommitteeontheFinancialProvisionsoftheUnionConstitutionFoz} - \gls{person:NaliniRanjanSarkarTPq} (Not an Assembly Member)
  \item \gls{committee:LinguisticProvincesCommissionZGQ} - \gls{person:SKDarbLN} (Not an Assembly Member)
  \item \gls{committee:SpecialCommitteetoExaminetheDraftConstitution1U6} - \gls{person:JawaharlalNehrul1w}
  \item \gls{committee:PressGalleryCommitteeAWc} - \gls{person:UshaNathSenxyK}
  \item \gls{committee:AdhocCommitteeonCitizenshipdyi} - \gls{person:SVaradacharijJH}
\end{enumerate}


\subsection{\gls{committee:DraftingCommitteezzK}}

Among all the committees of the Constituent Assembly, the most important committee was the \gls{committee:DraftingCommitteezzK} set up on \gls{date:August291947vIS}. It was this committee that was entrusted with the task of preparing a draft of the new Constitution. It consisted of seven members. They were

\begin{enumerate}
  \item \gls{person:DrBRAmbedkarCQc} ({\colord Chairmen})
  \item \gls{person:NGopalaswamyAyyangaroy8}
  \item \gls{person:AlladiKrishnaswamiAyyar3Xu}
  \item \gls{person:DrKMMunshiIfu}
  \item \gls{person:SayedMohammadSaadullahvyt}
  \item \gls{person:NMadhavaRauvAZ} (He replaced \gls{person:BLMitterUJT} who resined due to ill-health)
  \item \gls{person:TTKrishnamachari75o} (He replaced \gls{person:DPKhaitan17g} who died in 1948)
\end{enumerate}

The \gls{committee:DraftingCommitteezzK}, after taking into consideration the proposal of the various committees, prepared the first draft of the Constitution of India, which was published in February 1948. The people of India were given eight months to discuss the draft and propose amendments. In the light of the public comments, criticisms and suggestions, the \gls{committee:DraftingCommitteezzK} prepared a second draft, which was published in October 1948.

The \gls{committee:DraftingCommitteezzK} took less than six months to prepare its draft. In all it say for 141 days.

\section{Enactment of the Constitution}

\gls{person:DrBRAmbedkarCQc} introduced the final draft of the Constitution in the Assembly on \gls{date:November41948SLL} (first reading). The Assembly had a general discussion on it for five days (till \gls{date:November91948iyl}).

The second reading (clause by clause consideration) started on \gls{date:November151948OXt} and ended on \gls{date:October171949dfN}. During this stage, as many as 7653 amendments were proposed and 2473 were actually discussed in the Assembly.

The third reading of the draft started on \gls{date:November141949esh}. \gls{person:DrBRAmbedkarCQc} moved a motion - \quotesingle{the Constitution as settled by the Assembly be passed}. The motion on Draft Constitution was declared as passed on \gls{date:November261949Esr}, and received the signatures of the members and the president. Out of a total 299 members of the Assembly, only 284 were actually present on that day and signed the Constitution. This is also the date mentioned in the Preamble as the date on which the people of India in the Constituent Assembly adopted, enacted and gave to themselves this Constitution.

{\colord The Constitution as adopted on \gls{date:November261949Esr}, contained a Preamble, 395 Articles and 8 Schedules}. The Preamble was enacted after the entire Constitution was already enacted.

\gls{person:DrBRAmbedkarCQc}, the then Law Minister, piloted the Draft Constitution in the Assembly. He took a very prominent part in the deliberations of the Assembly. He was known for his logical, forceful and persuasive arguments on the floor of the Assembly. He is recognized as the \quotesingle{Father of the Constitution of India}. This brilliant writer, constitutional expert, undisputed leader of the scheduled castes and the \quotesingle{chief architech of the Constitution of India} is also known as a \quotesingle{Modern Manu}.

\section{Enforcement of the Constitution}

Some provisions of the Constitution pertaining to citizenship, elections, provisional parliament, temporary and transitional provisions, and short title contained in Articles 5, 6, 7, 8, 9, 60, 324, 366, 367, 379, 380, 388, 391, 392 and 393 came into force on \gls{date:November261949Esr} itself.
...
\begin{enumerate}
  ...
  \item \textbf{Time Consuming}: According to the critics, the Constituent Assembly took unduly long time to make the Constitution. They stated that the framers of the American Constitution took only four months to complete their work. In this context, \gls{person:NaziruddinAhmedd2m}, a member of the Constituent Assembly, coined a new name for the \gls{committee:DraftingCommitteezzK} to show his contempt for it. He called it a \quotedouble{Drifting Committee}.
  \item \textbf{Dominated by Congress}: The critics charged that the Constituent Assembly was dominated by the Congress party. \gls{person:GranvilleAustinu6N}, a British Constitutional expert, remarked: \quotesingle{The Constituent Assembly was a one-party body in an essentially one-party country. The Assembly was the Congress and the Congress was India}\footnote{\gls{person:GranvilleAustinu6N}, The Indian Constitution—Cornerstone of a Nation, Oxford, 1966, P. 8.}.
  ...
  \item \textbf{Dominated by Hindus}: According to some critics, the Constituent Assembly was a Hindu dominated body. \gls{person:LordViscountSimonrA3} called it \quotesingle{a body of Hindus}. Similarly, \gls{person:WinstonChurchillU7L} commented that the Constituent Assembly represented \quotesingle{only one major community in India}.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \gls{person:SirBNRau2ag} was appointed as the constitutional advisor (Legal advisor) to the Constituent Assembly.
  \item \gls{person:HVRIyengarNg5} was the Secretary to the Constituent Assembly.
  \item \gls{person:SNMukerjeerDM} was the chief draftsman of the constitution in the Constituent Assembly.
  \item \gls{person:PremBehariNarainRaizadaqcf} was the calligrapher of the Indian Constitution. The original constitution was handwritten by him in a flowing italic style.
  \item The original version was beautified and decorated by artists from Shantiniketan including \gls{person:NandLalBose9Av} and \gls{person:BeoharRammanoharSinhatV1}.
  \item \gls{person:BeoharRammanoharSinhatV1} illuminated, beautified and ornamented the original Preamble calligraph-ed by \gls{person:PremBehariNarainRaizadaqcf}.
  \item The calligraphy of the Hindi version of the original constitution was done by \gls{person:VasantKrishanVaidyalA5} and elegantly decorated and illuminated by \gls{person:NandLalBose9Av}.
\end{enumerate}
...
\begin{longtable}[c]{@{}|ll|l|c|@{}}
  \caption{State wise Membership of the Constituent Assembly of India as on \gls{date:December311947hLv}}
...
It should be notes al the outset that a number of original features of the Constitution (as adopted in 1949) have undergone a substantial change, on account of several amendments, particularly 7th, 42nd, 44th, 73rd, 74th and 97th Amendments. In fact, the 42nd Amendment Act (1976) is known as \quotesingle{Mini-Constitution} due to the important and large number of changes made by it in various parts of the Constitution. However, in the {\colord \textit{\gls{person:KeshavanandaBhartigwf}}} case\footnote{Kesavananda Bharati vs State of Kerala, (1973)} (1973), the Supreme Court rules that the constitution power of Parliament under Article 368 does not enable it to alter the \quotesingle{basic structure} of the Constitution.
...
The Constitution of India has borrowed most of its provisions from the constitutions of various other countries as well as from the Government of India Act\footnote{About 250 provisions of the 1935 Act have been included in the Constitution.} of 1935. \gls{person:DrBRAmbedkarCQc} proudly acclaimed that the Constitution of India has been framed after \quotesingle{ransacking all the known Constitution of the World\footnote{Constituent Assembly Debates, Volume VII, P. 35–38.}}.
...
Hence, the Indian Constitution has been variously described a \quotesingle{federal in form but unitary in spirit}, \quotesingle{quasi-federl} by \gls{person:KCWhearejQS}, \quotesingle{bargaining federalism} by \gls{person:MorrisJonesnLd}, \quotesingle{co-operative federalism} by \gls{person:GranvilleAustinu6N}, \quotesingle{federation with a centralizing tendency} by \gls{person:IvorJenningsh9Z}, and so on.
...
According to \gls{person:DrBRAmbedkarCQc}, the Directive Principles of State Policy is a \quotesingle{novel feature} of the Indian Constitution. They are enumerated in Part IV of the Constitution. They can be classified into three broad categories — socialistic, Gandhian and liberal-intellectual.
...
The original constitution did not provide for the fundamental duties of the citizens. These were added during the operation of internal emergency(1975-77) by the 42nd Constitutional Amendment Act of 1976 on the recommendation of the \gls{committee:SwaranSinghCommitteeOVE}. The 86the Constitutional Amendment Act of 2002 added one more fundamental duty.
...
While answering the above criticism in the Constituent Assembly, \gls{person:DrBRAmbedkarCQc}, the Chairman of the \gls{committee:DraftingCommitteezzK}, said: \quotedouble{One likes to ask whether there can be antthin new in Constitution framed at this hour in the history of the world. More than hundred years have rolled over when the first written constitution was drafted. It has been followed by many countries reducing their constitution to writing. What the scope of a constitution should be has long been settled. Similarly, what are the fundamentals of a constitution are recognized all over the world. Given these facts, all constitutions in thir main provision must look similar. The only new things, if there can be any, in a constitution framed so late in the day are the variations made to remove the faults and to accommodate it to the needs of country. The charge of providing a blind copy of the constitutions of other countries is based, I am sure, on an inadequate study of the Constitution}\footnote{Constituent Assembly Debates, Volume VII, pp.35-38.}.

\paragraph{A Carbon Copy of the 1935 Act}

The critics said that the framers of the constitution have included a large number of the provision of the Government of India Act of 1935 into the Constitution of India. Hence, they called the constitutions a \quotedouble{Carbon Copy of the 1935 Act} or an \quotedouble{amended version of the 1935 Act}. For example, \gls{person:NShrinivasanasp} observed that the Indian Constitution is \quotedouble{both in language and substance a close copy of the Act of 1935}. Similarly, Sir \gls{person:IvorJenningsh9Z}, a British Constitutionalist, said that \quotedouble{the constitution derives directly from the Government of India Act of 1935 from which, in fact, many of its provisions are copied almost textually}.

Further, \gls{person:PRDeshmukhVrd}, a member of the Constituent Assembly, commented that \quotedouble{the constitution is essentially the Government of India Act of 1935 with only adult franchise added}.

The same \gls{person:DrBRAmbedkarCQc} answered the above criticism in the Constituent Assembly in the following way: \quotedouble{As to the accusation that the Draft Constitution has reproduced a good part of the provision of the Government of India Act, 1935, I make no apologies. There is nothing to be ashamed of in borrowing. It involves no plagiarism. Nobody hold any patent rights in the fundamental ideas of a Constitution. What I am sorry about is that the provision taken from the Government of India Act, 1935, relate mostly to the details of administration}\footnote{Ibid.}.

\paragraph{Un-Indian or Anti-India}

According to the critics, the Indian Constitution is \quotesingle{un-Indian} or \quotesingle{anti-Indian} because it does not reflect the political tradition and the spirit of India. They said that the foreign nature of the Constitution makes it unsuitable to the Indian situation or unworkable in India. In this context, \gls{person:KHanumanthaiyaTUm}, a member of the Constituent Assembly, commented: \quotedouble{We wanted the music of Veena or Sitar, but here we have the music of an English band. That was because out constitution-makers were educated that way}\footnote{Constituent Assembly Debates, Volume XI, P.616.}. Similarly, \gls{person:KHanumanthaiyaTUm}, another member of the Constituent Assembly, criticized the constitution as \quotedouble{slavish imitation of the west, much more - a slavish surrender to the west}\footnote{Constituent Assembly Debates, Volume VII, P.242.}. Further, \gls{person:LaxminarayanSahuW7X}, also a member of Constituent Assembly, observed: \quotedouble{The ideals on which this draft constitution is framed have no manifest relation to the fundamental spirit of India. This constitution would not prove suitable and would break down soon after being brought into operation}\footnote{Constituent Assembly Debates, Volume XI, P.613.}.

\paragraph{An Un-Gandhian Constitution}

According to the critics, the Indian Constitution is Un-Gandhian because it does not contain the philosophy and ideals of \gls{person:MahatmaGandhiCch}, the father of the Indian Nation. They opined that the Constitution should have been raised and build upon village panchayats. In this context, the same member of the Constituent Assembly, \gls{person:KHanumanthaiyaTUm}, said: \quotedouble{That is exactly the kind of Constitution \gls{person:MahatmaGandhiCch} did not want and did not envisage}.\footnote{Constituent Assembly Debates, Volume XI, P.617.} \gls{person:TPrakasamaaS}, another member of the Constituent Assembly, attributed this lapse to \gls{person:DrBRAmbedkarCQc}'s non-participation in the Gandhian movement and the antagonism towards Gandhian ideas\footnote{Constituent Assembly Debates, Volume VII, P.387.}.

\paragraph{Elephantine Size}

The critics stated that the Indian Constitution is too bulky and too detailed and contains some unnecessary elements. Sir \gls{person:IvorJenningsh9Z}, a British Constitutionalist, observed that the provisions borrowed were not always well-selected and that the constitution, generally speaking, was too long and complicated.\footnote{\gls{person:IvorJenningsh9Z}, Some Characteristics of the Indian Constitution, Oxford University Press, Madras, 1953, PP.9-16.}

In this context, \gls{person:HVKamathEST}, a member of the Constituent Assembly, commented: \quotedouble{The emblem and the crest we have selected for our assembly is an elephant. It is perhaps in consonance with that our constitution too is the bulkiest in the world has produced}.\footnote{Constituent Assembly Debates, Volume VII, P.1042.} He also said: \quotedouble{I am sure, the House does not agree that we should make the Constitution an elephantine one}.\footnote{Constituent Assembly Debates, Volume VIII, P.127.}

\paragraph{Paradise of the Lawyers}

According to the critics, the Indian Constitution is too legalistic and very complicated. They opined that the legal language and phraseology adopted in the constitution makes it a complex document. The same Sir \gls{person:IvorJenningsh9Z} called it a \quotedouble{lawyer's paradise}.

In this context, \gls{person:HKMaheswariNHf}, a member of the Constituent Assembly observed: \quotedouble{The draft tends to make people more litigious, more inclined to go to courts, less truthful and less likely to follow the methods of truth and non-violence. If I may so, the Draft is really a lawyer's paradise. It opens up vast avenues of litigation and will give our able and ingenious lawyers plenty of work to do}.\footnote{Constituent Assembly Debates, Volume VII, P.293.}

Similarly, \gls{person:PRDeshmukhVrd}, another member of the Constituent Assembly, said: \quotedouble{I should, however, like to say that the draft of the articles that have been brought before the House by \gls{person:DrBRAmbedkarCQc} seems to my mind to be far too ponderous like the ponderous tomes of a law manual. A document dealing with a constitution hardly uses so much of padding and so much of verbiage. Perhaps it is difficult for them to compose a document which should be, to my mind, not a law but a socio-political document, a vibration, pulsating and life giving document. But to our misfortune, that was not to be, and we have been burdened with so much of words, words and words which could have been very easily eliminated}.\footnote{Constituent Assembly Debates, Volume IX, P.613.}
...
The American Constitution was the first to begin with a Preamble. Many countries, including India, followed this practice. The term \quotesingle{preamble} refers to the introduction or preface to the Constitution. It contains the summary or essence of the Constitution. \gls{person:NAPalkivalaAW6}, an eminent jurist and constitutional expert, called the Preamble as the \quotesingle{identity card of the Constitution.}

The Preamble to the Indian Constitution is based on the \quotesingle{Objectives Resolution}, draft and moved by \gls{person:JawaharlalNehrul1w}, and adopted by the Constituent Assembly\footnote{1}. It has been amended by the 42nd Constitutional Amendment Act (1976), which added three new words — socialist, secular and integrity.
...
\begin{enumerate}
  ...
  \item \textbf{Date of adoption of the Constitution}: It stipulates \gls{date:November261949Esr} as the date.
\end{enumerate}
