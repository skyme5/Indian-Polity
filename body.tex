...
\begin{enumerate}
  ...
  \item Single Constitution for both the Center and the states except Jammu and Kashmir\endnote{The State of Jammu and Kashmir has its own Constitution and thus, enjoys a special status by virtue of \gls{article:ARTICLE-370-370} of the Constitution of India.}.
...
The Constitution of India is neither rigid nor flexible but a synthesis of both. \gls{article:ARTICLE-368-368} provides for two types of amendments
...
At the same time, some provisions of the Constitution can be amended by a simple majority of the Parliament in the manner of ordinary legislative process. Notable, these amendments do not come under \gls{article:ARTICLE-368-368}.
...
Moreover, the term `Federation' has nowhere been used in the Constitution. \gls{article:ARTICLE-1-1}, on the other hand, describes India as a `Union of States' which implies two things: one, Indian Federation is not the result of an agreement by the states; and two, no state has the right to secede from the federation.
...
Just as the Indian parliamentary system differs from the British system, the scope of judicial review power of the Supreme Court in India is narrower than that of what exists in US. This is because the American Constitution provides for `due process of law' against that of `procedure established by law' contained in the Indian Constitution (\gls{article:ARTICLE-21-21}).
...
Part III of the Indian Constitution guarantees six\endnote{Originally, the Constitution provided for seven Fundamental Rights\index{default!Fundamental Rights}. However, the Rightto Property (\gls{article:ARTICLE-31-31}) was deleted fromthe list of Fundamental Rights\index{default!Fundamental Rights} by the 44th Amendment Act of 1978. It is made a legal right under \gls{article:ARTICLE-300-A-300-A} in Part XII of the constitution.} fundamental rights to all the citizens

\renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
\begin{enumerate}
  \item Right to Equality (\gls{article:ARTICLE-14-18-14-18}),
  \item Right to Freedom (\gls{article:ARTICLE-19-22-19-22}),
  \item Right against Exploitation (\gls{article:ARTICLE-23-24-23-24}),
  \item Right to Freedom of Religion (\gls{article:ARTICLE-25-28-25-28}),
  \item Cultural and Educational Right (\gls{article:ARTICLE-29-30-29-30}), and
  \item Right to Constitutional Remedies (\gls{article:ARTICLE-32-32})
\end{enumerate}
...
\begin{enumerate}
  ...
  \item The State shall not deny to any person equality before the law or equal protection of the laws (\gls{article:ARTICLE-14-14}).
  \item The State shall not discriminate against any citizen on the ground of religion (\gls{article:ARTICLE-15-15}).
  \item Equality of opportunity for all citizens in matters of public employment (\gls{article:ARTICLE-16-16}).
  \item All persons are equally entitled to freedom of conscience and the right to freely profess, practice and propagate any religion (\gls{article:ARTICLE-26-26}).
  \item Every religious denomination or any of its section shall have the right to manage its religious affairs (\gls{article:ARTICLE-26-26}).
  \item No person shall be compelled to pay any taxes for the promotion of particular religion (\gls{article:ARTICLE-27-27}).
  \item No religious instruction shall be provided in any educational institution maintained by the state (\gls{article:ARTICLE-28-28}).
  \item Any section of the citizens shall have the right to conserve its distinct language, script or culture (\gls{article:ARTICLE-29-29}).
  \item All minorities shall have the right to establish and administer educational institutions of their choice (\gls{article:ARTICLE-30-30}).
  \item The State shall endeavor to secure for all the citizens a Uniform Civil Code (\gls{article:ARTICLE-44-44}).
\end{enumerate}
...
\renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
\begin{enumerate}
  \item National emergency on the ground of war or externam aggression or armed rebellion\endnote{The 44th Amendment Act (1978) has replaced the original term ‘internal disturbance’ by the new term ‘armed rebellion’.} (\gls{article:ARTICLE-352-352})
  \item State emergency (President's Rule) on the ground of failure of Constitutional machinery in the states (\gls{article:ARTICLE-356-356}) or failure to comply with directions of the Centre (\gls{article:ARTICLE-365-365}); and
  \item Financial emergency on the ground of threat to the financial stability or credit of India (\gls{article:ARTICLE-360-360}).
\end{enumerate}
...
\begin{enumerate}
  \item It made the right to form co-operative societies a fundamental right (\gls{article:ARTICLE-19-19}).
  \item It include a new Directive Principle of State Policy on promotion of co-operative societies (\gls{article:ARTICLE-43-B-43-B}).
  \item It added a new Part IX-B in the Constitution which is entitled as ``The Co-operative societies'' (\gls{article:ARTICLE-243-ZH-243-ZH} to \gls{article:ARTICLE-243-ZT-243-ZT}).
\end{enumerate}
