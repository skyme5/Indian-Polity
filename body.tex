...
The British came to India in 1600 as traders, in the form of East India Company, which had the exclusive right of trading in India under a chapter granted by \gls{person:QueenElizabethI2TD}. In 1764, the Company, which till now had purely trading functions obtained the `diwani' (i.e., rights over revenue and civil justice) of Bengal, Bihar and Orissa
\endnote{The Mughal Emperor, \gls{person:ShahAlambXi}, granted `Diwani' to the Company after its victory in the Battle of Buxar (1764)}. This started its career as a territorial power. In 1858\index{1858}, in the wake of the `Sepoy mutiny\index{Sepoy mutiny}', the British Crown assumed direct responsibility for the governance of India. This rule continued until India was granted independence on \gls{date:August1519479d9}\index{1947-08-15}.

With Independence came the need of a Constitution. As suggested by \gls{person:MNRoys4P} (a pioneer of communist movement in India and an advocate of Radical Democrat-ism) in 1934\index{1934}, a Constituent Assembly was formed for this purpose in 1946\index{1946} and on January 26, 1950\index{1950-01-26}, the Constitution and polity have their roots in the British rule. There are certain events in the British rule that laid down the legal framework for the organization and functioning of government and administration in British India. These events have greatly influenced out contribution and polity. They are explained here in a chronological order:
...
In a bid to rectify the defects of the Regulating Act of 1773\index{Acts!Regulating Act of 1773}, the British Parliament passed the Amending Act of 1781\index{Acts!Amending Act of 1781}, also known as the Act of Settlement\index{Acts!Act of Settlement}. The next important act was the Pitt's India Act\endnote{It was introduced in the British Parliament by the then Prime Minister, \gls{person:WilliamPittk6U}} of 1784.
...
\paragraph{Features of the Act}
\begin{enumerate}
  \item It provided that India henceforth was to be governed by, and in the name of, Her Majesty. It changed the designation of th Governor-General of India to that of Viceroy of India. He (viceroy) was the direct representative of the British Crown in India. \gls{person:LordCanningpwC} thus became first Viceroy of India.
...
\begin{enumerate}
  ...
  \item It also provided for the establishment of new legislative councils for Bengal, \gls{NorthWesternFrontierProvincef3l} (NWFP) and Panjab, which were established in 1862, 1866 and 1897 respectively.
  \item It empowered the Viceroy to make rules and orders for the more convenient transaction of business in the council. It also gave a recognition to the  `portfolio' system, introduced by \gls{person:LordCanningpwC}\gls{person:LordCanningpwC} in 1859. Under this, a member of the Viceroy's council was made in-charge of one or more departments of the government and was authorized to issue final orders on behalf of the council on matters of his department(s).
...
This Act is also known as Morley-Minto Reforms (Lord Morley was the then Secretary of State for India and \gls{person:LordMintoCKI} was the then Viceroy of India).
\begin{enumerate}
  ...
  \item It provided (for the first time) for the association of Indians with the executive Councils of the Viceroy and Governors. \gls{person:SatyendraPrasadSinha289} became the first Indian to join the Viceroy's Executive Council. He was appointed as the law member.
  \item It introduced a system of communal representation\index{communal representation} for Muslims by accepting the concept of `\gls{SeparateElectorateQC5}'. Under this, the Muslim members were to be elected only by Muslim voter. Thus, the Act `legalized communal-ism' and \gls{person:LordMintoCKI} came to be known as the Father of Communal Electorate.
...
On Feburary 20, 1947\index{1947-02-20}, the British Prime Minister \gls{person:ClementAtleeUEg} declared that the British rule in India would end by \gls{date:June201948PNf}\index{1948-06-20}; after which the power would be transferred to responsible Indian hands. This announcement was followed by the agitation by the Muslim League demanding partition of the country. Again on June 03, 1947\index{1947-06-03} the British Government made it clear that any Constitution framed by the Constituent Assembly of India (formed in 1946) cannot apply to those parts of the country which were unwilling to accept it. On the same day (June 03, 1947\index{1947-06-03}), \gls{person:LordMountbettenB3y}, the viceroy of India, put forth the partition plan known as the Mountbatten Plan\index{Mountbatten Plan}. The plan was accepted by the Congress and the Muslim League. Immediate effect was given to the plan by enacting the Indian Independence Act\endnote{The Indian Independence Bill was introduced in the British Parliament on July 04, 1947\index{1947-07-04} and received the Royal Assent on \gls{date:July181947JZ8}\index{1947-07-18}. The act came into force on \gls{date:August1519479d9}\index{1947-08-15}.} (1947).

\paragraph{Features of the Act}
\begin{enumerate}
  \item It ended the British rule in India and declared India as an independent and sovereign state from \gls{date:August1519479d9}\index{1947-08-15}.
  ...
  \item It proclaimed the lapse of British paramountcy over the Indian princely states and treaty relations with tribal areas from \gls{date:August1519479d9}\index{1947-08-15}.
  ...
  \item It discontinued the appointment to civil services and reservation of posts by the secretary of state for India. The members of the civil services appointed before \gls{date:August1519479d9}\index{1947-08-15}, would continue to enjoy all benefits that they were entitled to till that time.
\end{enumerate}

At the stroke of midnight 14-15 August, 1947, the British rule came to an end and power was transferred to the two new independent Dominions of India and Pakistan\endnote{The boundaries between the two Dominions were determined by a Boundary Commission headed by Radcliff. Pakistan included the provinces of West Punjab, Sind, Baluchistan, East Bengal, \gls{NorthWesternFrontierProvincef3l} and the district of Sylhet in Assam. The referendum in the \gls{NorthWesternFrontierProvincef3l} and Sylhet was in favor of Pakistan.}. \gls{person:LordMountbettenB3y} became the first governor-general of the new Dominion of India. He swore in \gls{person:JawaharlalNehruhHS} as the first prime minister of independent India. The Constituent Assembly of India formed in 1946 became the Parliament of the Indian Dominion.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
  ...
  \endlastfoot
  %
  1. & \gls{person:JawaharlalNehruhHS} & External Affairs \& Commonwealth \\
     &                           & Relations \\
  2. & \gls{person:SardarVallabhbhaiPatelOAh} & Home, Information \& Broadcasting \\
  3. & \gls{person:DrRajendraPrasadL6H} & Food \& Agriculture \\
  4. & \gls{person:DrJohnMathaie1D} & Industries \& Supplies \\
  5. & \gls{person:JagjivanRamYfb} & Labor \\
  6. & \gls{person:SardarBaldevSingh036} & Defense \\
  7. & \gls{person:CHBhabha8LS} & Works, Mines \& Power \\
  8. & \gls{person:LiaquatAliKhanxv6} & Finance \\
  9. & \gls{person:AbdurRabNishtarhxI} & Posts \& Air \\
  10. & \gls{person:AsafAliEy2} & Railways \& Transport \\
  11. & \gls{person:CRajagopalacharivLy} & Education \& Arts \\
  12. & \gls{person:IIChundrigarfnG} & Commerce \\
  13. & \gls{person:GhaznafarAliKhanqqc} & Health \\
  14. & \gls{person:JoginderNathMandalsKt} & Law \\* \bottomrule
\end{longtable}
\textit{\textbf{Note}}: The members of the interim government were members of the Viceroy's Executive Council. The Viceroy continues to be the head of the Council. But, \gls{person:JawaharlalNehruhHS} was designated as the Vice-President of the Council.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
	...
	\endlastfoot
	%
	1. & \gls{person:JawaharlalNehruhHS} & Prime Minister; External Affairs \& Commonwealth \\
	&                           & Relations; Scientific Research \\
	2. & \gls{person:SardarVallabhbhaiPatelOAh} & Home, Information \& Broadcasting; States \\
	3. & \gls{person:DrRajendraPrasadL6H} & Food \& Agriculture \\
	4. & \gls{person:MaulanaAbulKalamAzadmaI} & Education \\
	5. & \gls{person:DrJohnMathaie1D} & Railway \& Transport \\
	6. & \gls{person:RKShanmughamUIH} & Finance \\
	7. & \gls{person:DrBRAmbedkarSpV} & Law \\
	8. & \gls{person:JagjivanRamYfb} & Labor \\
	9. & \gls{person:SardarBaldevSingh036} & Defense \\
	10. & \gls{person:RajKumariAmritKaurwX9} & Health \\
	11. & \gls{person:CHBhabha8LS} & Commerce \\
	12. & \gls{person:RafiAhmedKidwaiYcb} & Communication \\
	13. & \gls{person:DrShyamaPrasadMukherjinSw} & Industries \& Supplies \\
	14. & \gls{person:VNGadgilr81} & Works, Mines \& Power \\* \bottomrule
\end{longtable}
...
It was in 1934\index{1934} that the idea of a Constituent Assembly for India was put forward for the first time by \gls{person:MNRoys4P}, a pioneer of communist movement in India. In 1935\index{1935}, the Indian National Congress (INC), for the first time, officially demanded a Constituent Assembly to frame the Constitution of free India. In 1938\index{1938}, \gls{person:JawaharlalNehruhHS}, on behalf of the INC declared that `the Constitution of free India must be framed, without outside interference, by a Constituent Assembly elected on the basis of adult franchise'.

The demand was finally accepted in principle by the British Government in what is known as the `August Offer' of 1940. In 1942\index{1942}, \gls{person:SirStaffordCripps9If}, a member of the cabinet, came India with a draft proposal of the British Government on the framing of an independent Constitution to be adopted after the World War II. The Cripps Proposals were rejected by the Muslim League which wanted India to be divide into two autonomous states with two separate Constituent Assemblies. Finally, a Cabinet Mission\endnote{The Cabinet Mission consisting of three members (Lord Pethick Lawrence, \gls{person:SirStaffordCripps9If} and A V Alexander) arrived in India on \gls{date:March241946cco}\index{1946-03-24}. The Cabinet Mission published its plan on \gls{date:May16194642y}\index{1946-05-16}.} was sent to India. While it rejected the idea of two Constituent Assemblies, it put forth a scheme for the Constituent Assembly which more or less satisfied the Muslim League.

\section{Composition of the Constituent Assembly}

The Constituent Assembly was constituted in 1946\index{1946-11} under the scheme formulated by the Cabinet Mission Plan. The features of the scheme were
...
Although the Constituent Assembly was not directly elected by the people of India on the basis of adult franchise, the Assembly comprised representatives of all section of Indian Society - Hindus, Muslims, Sikhs, Parsis, Anglo-Indians, Indian Christians, SCs, STs including women of all these sections. The Assembly included all important personalities of India at that time, with the exception of \gls{person:MahatmaGandhiD5B}.

\section{Working of the Constituent Assembly}

The Constituent Assembly held its first meeting on December 09, 1946\index{1946-12-09}. The Muslim League boycotted the meeting and insisted on a separate state of Pakistan. The meeting was thus attended by only 211 members. {\colord{}\gls{person:DrSachchidanandSinhaf2M}, the oldest member, was elected as the temporary President of the Assembly, following the French practice.}

Later, \gls{person:DrRajendraPrasadL6H} was elected as the President of the Assembly. Similarly, both \gls{person:HCMukherjeePFq} and \gls{person:VTKrishnamachijdU} were elected as the Vice-Presidents of the Assembly. In other words, the Assembly had two Vice-Presidents.

\paragraph{Objectives Resolution\index{Objectives Resolution}}

On \gls{date:December131946fVB}\index{1946-12-13}, \gls{person:JawaharlalNehruhHS} moved the historic `Objectives Resolution\index{Objectives Resolution}' in the Assembly. It laid down the fundamentals and philosophy of the constitutional structure. It read:
...
This Resolution was unanimously adopted by the Assembly on January 22, 1947\index{1947-01-22}. It influenced the eventual shaping of the constitution through all its subsequent stages. Its modified version forms the Preamble of the present Constitution.

\section{Changes by the Independence Act}

The representatives of the princely states, who had stayed awat from the Constituent Assembly, gradually joined in. On \gls{date:April281947CwZ}\index{1947-04-28}, representatives of the six states\endnote{These include Baroda, Bikaner, Jaipur, Patiala, Rewa and Udaipur.} were part of the Assembly. After the acceptance of Mountbatten Plan\index{Mountbatten Plan} of June 03, 1947\index{1947-06-03} for a partition of the country, the representatives of most of the other princely states took their seats in the Assembly. The members of the Muslim League from the Indian Dominion also entered the Assembly.
...
\begin{enumerate}
  \item It ratified the India's membership of the Commonwealth in 1949\index{1949-05}.
  \item It adopted the national flag on January 24, 1950\index{1950-01-24}.
  \item It adopted the national anthem on January 24, 1950\index{1950-01-24}.
  \item It adopted the national song on January 24, 1950\index{1950-01-24}.
  \item It elected \gls{person:DrRajendraPrasadL6H} as the first President of India on January 24, 1950\index{1950-01-24}.
\end{enumerate}
...
On January 24, 1950\index{1950-01-24}, the Constituent Assembly held its final session. It however, did not end, and continued as the provisional parliament of India from January 26, 1950\index{1950-01-26} till the formation of new Parliament\endnote{The Provisional Parliament ceased to exist on \gls{date:April171952LrQ}\index{1952-04-17}. The first elected Parliament with the two Houses came into being in 1952\index{1952-05}.} after the first general elections in 1951-52.
...
\begin{enumerate}
  \item \gls{committee:UnionPowersCommitteeIAs} - \gls{person:JawaharlalNehruhHS}
  \item \gls{committee:UnionConstitutionCommitteeKKl} - \gls{person:JawaharlalNehruhHS}
  \item \gls{committee:ProvincialConstitutionCommitteeo7q} - \gls{person:SardarVallabhbhaiPatelOAh}
  \item \gls{committee:DraftingCommitteeVCV} - \gls{person:DrBRAmbedkarSpV}
  \item \gls{committee:AdvisoryCommitteeoxY} on Fundamental Rights\index{Fundamental Rights}, Minorities and Tribal and Excluded Areas - \gls{person:SardarVallabhbhaiPatelOAh}. This committee had the following five sub-committees:
  \begin{enumerate}
    \item \gls{committee:FundamentalRightsSubCommitteeIbM} - \gls{person:JBKripalani6Ik}
    \item \gls{committee:MinoritiesSubCommittee6tV} - \gls{person:HCMukherjeePFq}
    \item \gls{committee:NorthEastFrontierTribunalAreasSubCommitteeUEN} (with Assam Excluded \& Partially Excluded Areas) - \gls{person:GopinathBardoloiqIJ}
    \item \gls{committee:ExcludedandPartiallyExcludedAreasIAO} Other than those in Assam Sub Committee - \gls{person:AVThakkarogV}
    \item \gls{committee:NorthWestFrontierTribalAreasSubCommitteerlp}\endnote{One of the political consequences of the British Government’s statement of May 03, 1947\index{1947-05-03}, was that following a referendum, the North-West Frontier Province and Baluchistan became part of the territory of the Dominion of Pakistan and as a result the tribal areas in this region became a concern of that Dominion. The Sub-Committee on the Tribal Areas in the North-West Frontier Province and Baluchistan was not therefore called upon to function on behalf of the Constituent Assembly of India. (B. Shiva Rao, The Framing of India’s Constitution : Select Documents, Volume III, P.681.) The members of this Sub-Committee were : Khan Abdul Ghaffar Khan, Khan Abdul Samad Khan and Mehr Chand Khanna. The information about the Chairman is not found.}
  \end{enumerate}
  
  \item \gls{committee:RulesofProcedureCommitteeyyD} - \gls{person:DrRajendraPrasadL6H}
  \item \gls{committee:StatesCommitteeCommitteeforNegotiatingwithStatesIIK} - \gls{person:JawaharlalNehruhHS}
  \item \gls{committee:SteeringCommitteeBZl} - \gls{person:DrRajendraPrasadL6H}
\end{enumerate}

\subsection{Minor Committees}

\begin{enumerate}
  \item \gls{committee:FinanceandStaffCommitteefgz} - \gls{person:DrRajendraPrasadL6H}
  \item \gls{committee:CredentialsCommitteeoHa} - \gls{person:AlladiKrishnaswamiAyyarJzn}
  \item \gls{committee:HouseCommittee35R} - \gls{person:BPattabhiSitaramayyah2y}
  \item \gls{committee:OrderofBusinessCommitteecrp} - \gls{person:DrKMMunshiGZE}
  \item \gls{committee:AdhocCommitteeontheNationalFlagkNJ} - \gls{person:DrRajendraPrasadL6H}
  \item \gls{committee:CommitteeontheFunctionsoftheConstituentAssemblyxW4} - \gls{person:GVMavalankar9Fu}
  \item \gls{committee:AdhocCommitteeontheSupremeCourt7pt} - \gls{person:SVaradacharidQB} (Not an Assembly Member)
  \item \gls{committee:CommitteeonChiefCommissionersProvinces6j2} - \gls{person:BPattabhiSitaramayyah2y}
  \item \gls{committee:ExpertCommitteeontheFinancialProvisionsoftheUnionConstitutionR0D} - \gls{person:NaliniRanjanSarkarMIH} (Not an Assembly Member)
  \item \gls{committee:LinguisticProvincesCommissionJH7} - \gls{person:SKDarJSY} (Not an Assembly Member)
  \item \gls{committee:SpecialCommitteetoExaminetheDraftConstitutionMQ6} - \gls{person:JawaharlalNehruhHS}
  \item \gls{committee:PressGalleryCommitteelWy} - \gls{person:UshaNathSenlU4}
  \item \gls{committee:AdhocCommitteeonCitizenshipiyO} - \gls{person:SVaradacharidQB}
\end{enumerate}


\subsection{\gls{committee:DraftingCommitteeVCV}}

Among all the committees of the Constituent Assembly, the most important committee was the \gls{committee:DraftingCommitteeVCV} set up on \gls{date:August291947Hx3}\index{1947-08-29}. It was this committee that was entrusted with the task of preparing a draft of the new Constitution. It consisted of seven members. They were

\begin{enumerate}
  \item \gls{person:DrBRAmbedkarSpV} ({\colord Chairmen})
  \item \gls{person:NGopalaswamyAyyangarR1Q}
  \item \gls{person:AlladiKrishnaswamiAyyarJzn}
  \item \gls{person:DrKMMunshiGZE}
  \item \gls{person:SayedMohammadSaadullahpLV}
  \item \gls{person:NMadhavaRauU7T} (He replaced \gls{person:BLMitterodr} who resined due to ill-health)
  \item \gls{person:TTKrishnamachariK77} (He replaced \gls{person:DPKhaitanWl3} who died in 1948)
\end{enumerate}

The \gls{committee:DraftingCommitteeVCV}, after taking into consideration the proposal of the various committees, prepared the first draft of the Constitution of India, which was published in 1948\index{1948-02}. The people of India were given eight months to discuss the draft and propose amendments. In the light of the public comments, criticisms and suggestions, the \gls{committee:DraftingCommitteeVCV} prepared a second draft, which was published in 1948\index{1948-10}.

The \gls{committee:DraftingCommitteeVCV} took less than six months to prepare its draft. In all it say for 141 days.

\section{Enactment of the Constitution}

\gls{person:DrBRAmbedkarSpV} introduced the final draft of the Constitution in the Assembly on November 04, 1948\index{1948-11-04} (first reading). The Assembly had a general discussion on it for five days (till November 09, 1948\index{1948-11-09}).

The second reading (clause by clause consideration) started on \gls{date:November151948J0i}\index{1948-11-15} and ended on \gls{date:October1719492tK}\index{1949-10-17}. During this stage, as many as 7653 amendments were proposed and 2473 were actually discussed in the Assembly.

The third reading of the draft started on \gls{date:November141949VJR}\index{1949-11-14}. \gls{person:DrBRAmbedkarSpV} moved a motion - `the Constitution as settled by the Assembly be passed'. The motion on Draft Constitution was declared as passed on \gls{date:November261949deK}\index{1949-11-26}, and received the signatures of the members and the president. Out of a total 299 members of the Assembly, only 284 were actually present on that day and signed the Constitution. This is also the date mentioned in the Preamble as the date on which the people of India in the Constituent Assembly adopted, enacted and gave to themselves this Constitution.

{\colord The Constitution as adopted on \gls{date:November261949deK}\index{1949-11-26}, contained a Preamble, 395 Articles and 8 Schedules}. The Preamble was enacted after the entire Constitution was already enacted.

\gls{person:DrBRAmbedkarSpV}, the then Law Minister, piloted the Draft Constitution in the Assembly. He took a very prominent part in the deliberations of the Assembly. He was known for his logical, forceful and persuasive arguments on the floor of the Assembly. He is recognized as the `Father of the Constitution of India'. This brilliant writer, constitutional expert, undisputed leader of the scheduled castes and the `chief architech of the Constitution of India' is also known as a `Modern Manu'.

\section{Enforcement of the Constitution}

Some provisions of the Constitution pertaining to citizenship, elections, provisional parliament, temporary and transitional provisions, and short title contained in Articles 5, 6, 7, 8, 9, 60, 324, 366, 367, 379, 380, 388, 391, 392 and 393 came into force on \gls{date:November261949deK}\index{1949-11-26}, itself.

The remaining provisions(the major part) of the Constitution came into force on January 26, 1950\index{1950-01-26}. This day is referred to in the Constitution as the `date of it commencement', and celebrated as the Republic Day.
...
\begin{enumerate}
  ...
  \item \textbf{Time Consuming}: According to the critics, the Constituent Assembly took unduly long time to make the Constitution. They stated that the framers of the American Constitution took only four months to complete their work. In this context, \gls{person:NaziruddinAhmedIJa}, a member of the Constituent Assembly, coined a new name for the \gls{committee:DraftingCommitteeVCV} to show his contempt for it. He called it a \enquote{Drifting Committee}.
  \item \textbf{Dominated by Congress}: The critics charged that the Constituent Assembly was dominated by the Congress party. \gls{person:GranvilleAustinV0w}, a British Constitutional expert, remarked: `The Constituent Assembly was a one-party body in an essentially one-party country. The Assembly was the Congress and the Congress was India'\endnote{\gls{person:GranvilleAustinV0w}, The Indian Constitution—Cornerstone of a Nation, Oxford, 1966, P. 8.}.
  ...
  \item \textbf{Dominated by Hindus}: According to some critics, the Constituent Assembly was a Hindu dominated body. \gls{person:LordViscountSimonR98} called it `a body of Hindus'. Similarly, \gls{person:WinstonChurchillNnu} commented that the Constituent Assembly represented `only one major community in India'.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \gls{person:SirBNRau7NN} was appointed as the constitutional advisor (Legal advisor) to the Constituent Assembly.
  \item \gls{person:HVRIyengargSP} was the Secretary to the Constituent Assembly.
  \item \gls{person:SNMukerjeemL9} was the chief draftsman of the constitution in the Constituent Assembly.
  \item \gls{person:PremBehariNarainRaizadapN9} was the calligrapher of the Indian Constitution. The original constitution was handwritten by him in a flowing italic style.
  \item The original version was beautified and decorated by artists from Shantiniketan including \gls{person:NandLalBose2yG} and \gls{person:BeoharRammanoharSinhaYgf}.
  \item \gls{person:BeoharRammanoharSinhaYgf} illuminated, beautified and ornamented the original Preamble calligraph-ed by \gls{person:PremBehariNarainRaizadapN9}.
  \item The calligraphy of the Hindi version of the original constitution was done by \gls{person:VasantKrishanVaidyav29} and elegantly decorated and illuminated by \gls{person:NandLalBose2yG}.
\end{enumerate}
...
\begin{longtable}[c]{@{}|p{1cm}p{1cm}|p{6cm}|p{4cm}|@{}}
  \caption{State wise Membership of the Constituent Assembly of India as on \gls{date:December311947gIH}\index{1947-12-31}}
...
It should be notes al the outset that a number of original features of the Constitution (as adopted in 1949) have undergone a substantial change, on account of several amendments, particularly 7th, 42nd, 44th, 73rd, 74th and 97th Amendments. In fact, the 42nd Amendment Act of 1976, is known as `Mini-Constitution' due to the important and large number of changes made by it in various parts of the Constitution. However, in the {\colord \textit{\gls{person:KeshavanandaBhartiI7D}}} case\endnote{Kesavananda Bharati vs State of Kerala, (1973)} (1973), the Supreme Court rules that the constitution power of Parliament under Article 368 does not enable it to alter the `basic structure' of the Constitution.
...
The Constitution of India has borrowed most of its provisions from the constitutions of various other countries as well as from the Government of India Act\endnote{About 250 provisions of the 1935 Act have been included in the Constitution.} of 1935. \gls{person:DrBRAmbedkarSpV} proudly acclaimed that the Constitution of India has been framed after \quotesingle{ransacking all the known Constitution of the World\endnote{Constituent Assembly Debates, Volume VII, P. 35–38.}}.
...
Hence, the Indian Constitution has been variously described a `federal in form but unitary in spirit', `quasi-federl' by \gls{person:KCWhearen9e}, `bargaining federalism' by \gls{person:MorrisJonesgaY}, `co-operative federalism' by \gls{person:GranvilleAustinV0w}, `federation with a centralizing tendency' by \gls{person:IvorJenningsIvn}, and so on.
...
According to \gls{person:DrBRAmbedkarSpV}, the Directive Principles of State Policy is a `novel feature' of the Indian Constitution. They are enumerated in Part IV of the Constitution. They can be classified into three broad categories — socialistic, Gandhian and liberal-intellectual.
...
The original constitution did not provide for the fundamental duties of the citizens. These were added during the operation of internal emergency(1975-77) by the 42nd Constitutional Amendment Act of 1976, on the recommendation of the \gls{committee:SwaranSinghCommitteeIKM}. The 86the Constitutional Amendment Act of 2002, added one more fundamental duty.
...
\renewcommand{\labelenumi}{\textbf{(\alph{enumi})}}
\begin{enumerate}
  \item National emergency on the ground of war or externam aggression or armed rebellion\endnote{The 44th Amendment Act of 1978, has replaced the original term \quotesingle{internal
      disturbance} by the new term `armed rebellion'.} (Article 352)
...
While answering the above criticism in the Constituent Assembly, \gls{person:DrBRAmbedkarSpV}, the Chairman of the \gls{committee:DraftingCommitteeVCV}, said: \quotedouble{One likes to ask whether there can be antthin new in Constitution framed at this hour in the history of the world. More than hundred years have rolled over when the first written constitution was drafted. It has been followed by many countries reducing their constitution to writing. What the scope of a constitution should be has long been settled. Similarly, what are the fundamentals of a constitution are recognized all over the world. Given these facts, all constitutions in thir main provision must look similar. The only new things, if there can be any, in a constitution framed so late in the day are the variations made to remove the faults and to accommodate it to the needs of country. The charge of providing a blind copy of the constitutions of other countries is based, I am sure, on an inadequate study of the Constitution}\endnote{Constituent Assembly Debates, Volume VII, pp.35-38.}.

\paragraph{A Carbon Copy of the 1935 Act}

The critics said that the framers of the constitution have included a large number of the provision of the Government of India Act of 1935\index{Acts!Government of India Act of 1935} into the Constitution of India. Hence, they called the constitutions a \quotedouble{Carbon Copy of the 1935 Act} or an \quotedouble{amended version of the 1935 Act}. For example, \gls{person:NShrinivasanpXF} observed that the Indian Constitution is \quotedouble{both in language and substance a close copy of the Act of 1935}. Similarly, Sir \gls{person:IvorJenningsIvn}, a British Constitutionalist, said that \quotedouble{the constitution derives directly from the Government of India Act of 1935\index{Acts!Government of India Act of 1935} from which, in fact, many of its provisions are copied almost textually}.

Further, \gls{person:PRDeshmukh33w}, a member of the Constituent Assembly, commented that \quotedouble{the constitution is essentially the Government of India Act of 1935\index{Acts!Government of India Act of 1935} with only adult franchise added}.

The same \gls{person:DrBRAmbedkarSpV} answered the above criticism in the Constituent Assembly in the following way: \quotedouble{As to the accusation that the Draft Constitution has reproduced a good part of the provision of the Government of India Act, 1935, I make no apologies. There is nothing to be ashamed of in borrowing. It involves no plagiarism. Nobody hold any patent rights in the fundamental ideas of a Constitution. What I am sorry about is that the provision taken from the Government of India Act, 1935, relate mostly to the details of administration}\endnote{Ibid.}.

\paragraph{Un-Indian or Anti-India}

According to the critics, the Indian Constitution is `un-Indian' or `anti-Indian' because it does not reflect the political tradition and the spirit of India. They said that the foreign nature of the Constitution makes it unsuitable to the Indian situation or unworkable in India. In this context, \gls{person:KHanumanthaiyabLJ}, a member of the Constituent Assembly, commented: \quotedouble{We wanted the music of Veena or Sitar, but here we have the music of an English band. That was because out constitution-makers were educated that way}\endnote{Constituent Assembly Debates, Volume XI, P.616.}. Similarly, \gls{person:KHanumanthaiyabLJ}, another member of the Constituent Assembly, criticized the constitution as \quotedouble{slavish imitation of the west, much more - a slavish surrender to the west}\endnote{Constituent Assembly Debates, Volume VII, P.242.}. Further, \gls{person:LaxminarayanSahu7En}, also a member of Constituent Assembly, observed: \quotedouble{The ideals on which this draft constitution is framed have no manifest relation to the fundamental spirit of India. This constitution would not prove suitable and would break down soon after being brought into operation}\endnote{Constituent Assembly Debates, Volume XI, P.613.}.

\paragraph{An Un-Gandhian Constitution}

According to the critics, the Indian Constitution is Un-Gandhian because it does not contain the philosophy and ideals of \gls{person:MahatmaGandhiD5B}, the father of the Indian Nation. They opined that the Constitution should have been raised and build upon village panchayats. In this context, the same member of the Constituent Assembly, \gls{person:KHanumanthaiyabLJ}, said: \quotedouble{That is exactly the kind of Constitution \gls{person:MahatmaGandhiD5B} did not want and did not envisage}.\endnote{Constituent Assembly Debates, Volume XI, P.617.} \gls{person:TPrakasamErk}, another member of the Constituent Assembly, attributed this lapse to \gls{person:DrBRAmbedkarSpV}'s non-participation in the Gandhian movement and the antagonism towards Gandhian ideas\endnote{Constituent Assembly Debates, Volume VII, P.387.}.

\paragraph{Elephantine Size}

The critics stated that the Indian Constitution is too bulky and too detailed and contains some unnecessary elements. Sir \gls{person:IvorJenningsIvn}, a British Constitutionalist, observed that the provisions borrowed were not always well-selected and that the constitution, generally speaking, was too long and complicated.\endnote{\gls{person:IvorJenningsIvn}, Some Characteristics of the Indian Constitution, Oxford University Press, Madras, 1953, PP.9-16.}

In this context, \gls{person:HVKamathjrk}, a member of the Constituent Assembly, commented: \quotedouble{The emblem and the crest we have selected for our assembly is an elephant. It is perhaps in consonance with that our constitution too is the bulkiest in the world has produced}.\endnote{Constituent Assembly Debates, Volume VII, P.1042.} He also said: \quotedouble{I am sure, the House does not agree that we should make the Constitution an elephantine one}.\endnote{Constituent Assembly Debates, Volume VIII, P.127.}

\paragraph{Paradise of the Lawyers}

According to the critics, the Indian Constitution is too legalistic and very complicated. They opined that the legal language and phraseology adopted in the constitution makes it a complex document. The same Sir \gls{person:IvorJenningsIvn} called it a \quotedouble{lawyer's paradise}.

In this context, \gls{person:HKMaheswariAOK}, a member of the Constituent Assembly observed: \quotedouble{The draft tends to make people more litigious, more inclined to go to courts, less truthful and less likely to follow the methods of truth and non-violence. If I may so, the Draft is really a lawyer's paradise. It opens up vast avenues of litigation and will give our able and ingenious lawyers plenty of work to do}.\endnote{Constituent Assembly Debates, Volume VII, P.293.}

Similarly, \gls{person:PRDeshmukh33w}, another member of the Constituent Assembly, said: \quotedouble{I should, however, like to say that the draft of the articles that have been brought before the House by \gls{person:DrBRAmbedkarSpV} seems to my mind to be far too ponderous like the ponderous tomes of a law manual. A document dealing with a constitution hardly uses so much of padding and so much of verbiage. Perhaps it is difficult for them to compose a document which should be, to my mind, not a law but a socio-political document, a vibration, pulsating and life giving document. But to our misfortune, that was not to be, and we have been burdened with so much of words, words and words which could have been very easily eliminated}.\endnote{Constituent Assembly Debates, Volume IX, P.613.}
...
The American Constitution was the first to begin with a Preamble. Many countries, including India, followed this practice. The term `preamble' refers to the introduction or preface to the Constitution. It contains the summary or essence of the Constitution. \gls{person:NAPalkivalanPB}, an eminent jurist and constitutional expert, called the Preamble as the \quotesingle{identity card of the Constitution.}

The Preamble to the Indian Constitution is based on the `Objectives Resolution\index{Objectives Resolution}', draft and moved by \gls{person:JawaharlalNehruhHS}, and adopted by the Constituent Assembly\endnote{1}. It has been amended by the 42nd Constitutional Amendment Act of 1976, which added three new words — socialist, secular and integrity.
...
\end{list}
\textbf{IN OUR CONSTITUENT ASSEMBLY} this twenty-sixth day of 1949\index{1949-11}, do \textbf{HEREBY ADOPT, ENACT AND GIVE TO OURSELVES THIS CONSTITUTION}.\textquotedblright
...
\begin{enumerate}
  ...
  \item \textbf{Date of adoption of the Constitution}: It stipulates \gls{date:November261949deK}\index{1949-11-26}, as the date.
\end{enumerate}
