...
In a bid to rectify the defects of the Regulating Act of 1773\index{Acts!Regulating Act of 1773}, the British Parliament passed the Amending Act of 1781\index{Acts!Amending Act of 1781}, also known as the Act of Settlement\index{Acts!Act of Settlement}. The next important act was the Pitt's India Act\endnote{It was introduced in the British Parliament by the then Prime Minister,\gls{person:WilliamPittQPL}} of 1784.
...
\paragraph{Features of the Act}
\begin{enumerate}
  \item It provided that India henceforth was to be governed by, and in the name of, Her Majesty. It changed the designation of th Governor-General of India to that of Viceroy of India. He (viceroy) was the direct representative of the British Crown in India.\gls{person:LordCanningOYP} thus became first Viceroy of India.
...
\begin{enumerate}
  ...
  \item It also provided for the establishment of new legislative councils for Bengal,\gls{NorthWesternFrontierProvincetDC} (NWFP) and Panjab, which were established in 1862, 1866 and 1897 respectively.
  \item It empowered the Viceroy to make rules and orders for the more convenient transaction of business in the council. It also gave a recognition to the  `portfolio' system, introduced by\gls{person:LordCanningOYP}Lord Canning in 1859. Under this, a member of the Viceroy's council was made in-charge of one or more departments of the government and was authorized to issue final orders on behalf of the council on matters of his department(s).
...
This Act is also known as Morley-Minto Reforms (Lord Morley was the then Secretary of State for India and\gls{person:LordMintoCYk} was the then Viceroy of India).
\begin{enumerate}
  ...
  \item It provided (for the first time) for the association of Indians with the executive Councils of the Viceroy and Governors.\gls{person:SatyendraPrasadSinhaEXb} became the first Indian to join the Viceroy's Executive Council. He was appointed as the law member.
  \item It introduced a system of communal representation\index{communal representation} for Muslims by accepting the concept of \gls{SeparateElectorateHNF}'. Under this, the Muslim members were to be elected only by Muslim voter. Thus, the Act `legalized communal-ism' and\gls{person:LordMintoCYk} came to be known as the Father of Communal Electorate.
...
On Feburary 20, 1947\index{Date!Feburary 20, 1947}, the British Prime Minister\gls{person:ClementAtleei0x} declared that the British rule in India would end by\gls{date:June201948qQ2}\index{Date!June 20, 1948}; after which the power would be transferred to responsible Indian hands. This announcement was followed by the agitation by the Muslim League demanding partition of the country. Again on June 03, 1947\index{Date!June 03, 1947} the British Government made it clear that any Constitution framed by the Constituent Assembly of India (formed in 1946) cannot apply to those parts of the country which were unwilling to accept it. On the same day (June 03, 1947\index{Date!June 03, 1947}),\gls{person:LordMountbettendof}, the viceroy of India, put forth the partition plan known as the Mountbatten Plan\index{Mountbatten Plan}. The plan was accepted by the Congress and the Muslim League. Immediate effect was given to the plan by enacting the Indian Independence Act\endnote{The Indian Independence Bill was introduced in the British Parliament on July 04, 1947\index{Date!July 04, 1947} and received the Royal Assent on\gls{date:July181947ZsT}\index{Date!July 18, 1947}. The act came into force on\gls{date:August151947yYV}\index{Date!August 15, 1947}.} (1947).

\paragraph{Features of the Act}
\begin{enumerate}
  \item It ended the British rule in India and declared India as an independent and sovereign state from\gls{date:August151947yYV}\index{Date!August 15, 1947}.
  ...
  \item It proclaimed the lapse of British paramountcy over the Indian princely states and treaty relations with tribal areas from\gls{date:August151947yYV}\index{Date!August 15, 1947}.
  ...
  \item It discontinued the appointment to civil services and reservation of posts by the secretary of state for India. The members of the civil services appointed before\gls{date:August151947yYV}\index{Date!August 15, 1947}, would continue to enjoy all benefits that they were entitled to till that time.
\end{enumerate}

At the stroke of midnight 14-15 August, 1947, the British rule came to an end and power was transferred to the two new independent Dominions of India and Pakistan\endnote{The boundaries between the two Dominions were determined by a Boundary Commission headed by Radcliff. Pakistan included the provinces of West Punjab, Sind, Baluchistan, East Bengal,\gls{NorthWesternFrontierProvincetDC} and the district of Sylhet in Assam. The referendum in the\gls{NorthWesternFrontierProvincetDC} and Sylhet was in favor of Pakistan.}.\gls{person:LordMountbettendof} became the first governor-general of the new Dominion of India. He swore in\gls{person:JawaharlalNehruBmz} as the first prime minister of independent India. The Constituent Assembly of India formed in 1946 became the Parliament of the Indian Dominion.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
  ...
  \endlastfoot
  %
  1. &\gls{person:JawaharlalNehruBmz} & External Affairs \& Commonwealth \\
     &                           & Relations \\
  2. &\gls{person:SardarVallabhbhaiPateldCT} & Home, Information \& Broadcasting \\
  3. &\gls{person:DrRajendraPrasadC4e} & Food \& Agriculture \\
  4. &\gls{person:DrJohnMathai4GF} & Industries \& Supplies \\
  5. &\gls{person:JagjivanRam4zW} & Labor \\
  6. &\gls{person:SardarBaldevSinghRsy} & Defense \\
  7. &\gls{person:CHBhabhaNqM} & Works, Mines \& Power \\
  8. &\gls{person:LiaquatAliKhanqfZ} & Finance \\
  9. &\gls{person:AbdurRabNishtarJyi} & Posts \& Air \\
  10. &\gls{person:AsafAliop8} & Railways \& Transport \\
  11. &\gls{person:CRajagopalachariYvf} & Education \& Arts \\
  12. &\gls{person:IIChundrigarZq8} & Commerce \\
  13. &\gls{person:GhaznafarAliKhann3h} & Health \\
  14. &\gls{person:JoginderNathMandalG9i} & Law \\* \bottomrule
\end{longtable}
\textit{\textbf{Note}}: The members of the interim government were members of the Viceroy's Executive Council. The Viceroy continues to be the head of the Council. But,\gls{person:JawaharlalNehruBmz} was designated as the Vice-President of the Council.
...
\begin{longtable}[c]{@{}|p{1cm}|p{4cm}|p{7cm}|@{}}
	...
	\endlastfoot
	%
	1. &\gls{person:JawaharlalNehruBmz} & Prime Minister; External Affairs \& Commonwealth \\
	&                           & Relations; Scientific Research \\
	2. &\gls{person:SardarVallabhbhaiPateldCT} & Home, Information \& Broadcasting; States \\
	3. &\gls{person:DrRajendraPrasadC4e} & Food \& Agriculture \\
	4. &\gls{person:MaulanaAbulKalamAzadalB} & Education \\
	5. &\gls{person:DrJohnMathai4GF} & Railway \& Transport \\
	6. &\gls{person:RKShanmughamD30} & Finance \\
	7. &\gls{person:DrBRAmbedkarUAG} & Law \\
	8. &\gls{person:JagjivanRam4zW} & Labor \\
	9. &\gls{person:SardarBaldevSinghRsy} & Defense \\
	10. &\gls{person:RajKumariAmritKaur5b9} & Health \\
	11. &\gls{person:CHBhabhaNqM} & Commerce \\
	12. &\gls{person:RafiAhmedKidwaiYhg} & Communication \\
	13. &\gls{person:DrShyamaPrasadMukherjiFZp} & Industries \& Supplies \\
	14. &\gls{person:VNGadgilLML} & Works, Mines \& Power \\* \bottomrule
\end{longtable}
...
It was in 1934\index{Year!1934} that the idea of a Constituent Assembly for India was put forward for the first time by\gls{person:MNRoyuNR}, a pioneer of communist movement in India. In 1935\index{Year!1935}, the Indian National Congress (INC), for the first time, officially demanded a Constituent Assembly to frame the Constitution of free India. In 1938\index{Year!1938},\gls{person:JawaharlalNehruBmz}, on behalf of the INC declared that `the Constitution of free India must be framed, without outside interference, by a Constituent Assembly elected on the basis of adult franchise'.

The demand was finally accepted in principle by the British Government in what is known as the `August Offer' of 1940. In 1942\index{Year!1942},\gls{person:SirStaffordCrippsjPO}, a member of the cabinet, came India with a draft proposal of the British Government on the framing of an independent Constitution to be adopted after the World War II. The Cripps Proposals were rejected by the Muslim League which wanted India to be divide into two autonomous states with two separate Constituent Assemblies. Finally, a Cabinet Mission\endnote{The Cabinet Mission consisting of three members (Lord Pethick Lawrence,\gls{person:SirStaffordCrippsjPO} and A V Alexander) arrived in India on\gls{date:March241946hYT}\index{Date!March 24, 1946}. The Cabinet Mission published its plan on\gls{date:May161946mZD}\index{Date!May 16, 1946}.} was sent to India. While it rejected the idea of two Constituent Assemblies, it put forth a scheme for the Constituent Assembly which more or less satisfied the Muslim League.
...
Although the Constituent Assembly was not directly elected by the people of India on the basis of adult franchise, the Assembly comprised representatives of all section of Indian Society - Hindus, Muslims, Sikhs, Parsis, Anglo-Indians, Indian Christians, SCs, STs including women of all these sections. The Assembly included all important personalities of India at that time, with the exception of\gls{person:MahatmaGandhiuGv}.

\section{Working of the Constituent Assembly}

The Constituent Assembly held its first meeting on December 09, 1946\index{Date!December 09, 1946}. The Muslim League boycotted the meeting and insisted on a separate state of Pakistan. The meeting was thus attended by only 211 members. {\colord{\gls{person:DrSachchidanandSinhaHBr}, the oldest member, was elected as the temporary President of the Assembly, following the French practice.}

Later,\gls{person:DrRajendraPrasadC4e} was elected as the President of the Assembly. Similarly, both\gls{person:HCMukherjeexky} and\gls{person:VTKrishnamachisw8} were elected as the Vice-Presidents of the Assembly. In other words, the Assembly had two Vice-Presidents.

\paragraph{Objectives Resolution\index{Objectives Resolution}}

On\gls{date:December131946R4m}\index{Date!December 13, 1946},\gls{person:JawaharlalNehruBmz} moved the historic `Objectives Resolution\index{Objectives Resolution}' in the Assembly. It laid down the fundamentals and philosophy of the constitutional structure. It read:
...
\begin{enumerate}
  ...
  \item The Assembly also became a legislative body. In other words, two separate functions were assigned to the Assembly, that is, making of a constitution for free India and enacting of ordinary laws for the country. These two tasks were to be performed on separate days. Thus, the Assembly became the first Parliament of free India (Dominion Legislature). Whenever the Assembly met as the Constituent body it was chaired by\gls{person:DrRajendraPrasadC4e} and when it met as the legislative body\endnote{For the first time, the Constituent Assembly met as Dominion Legislature on\gls{date:November171947Up7}\index{Date!November 17, 1947} and elected\gls{person:GVMavalankarNIK} as its speaker.}, it was chaired by\gls{person:GVMavalankarNIK}. These two functions continued till\gls{date:November261949epG}\index{Date!November 26, 1949}, when the task of making the Constitution was over.
  \item The Muslim League members (hailing from the areas\endnote{These are West Punjab, East Bengal, NWFP, Sindh, Baluchistan and Sylhet District of Assam. A separate Constituent Assembly was set up for Pakistan.} included in the Pakistan) withdrew from the Constituent Assembly for India. Consequently, the total strength of the Assembly came down to 299 as against 389 originally fixed in 1946 under the Cabinet Mission Plan. The strength of the Indian provinces (formerly British Provinces) was reduced from 296 to 299 and those of the princely states from 93 to 70. The state-wise membership of the Assembly as on\gls{date:December311947gBh}\index{Date!December 31, 1947}, is shown in \ref{tab:StateWiseMemberShipAssembly} at the end of this chapter.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item It elected\gls{person:DrRajendraPrasadC4e} as the first President of India on January 24, 1950\index{Date!January 24, 1950}.
\end{enumerate}
...
On January 24, 1950\index{Date!January 24, 1950}, the Constituent Assembly held its final session. It however, did not end, and continued as the provisional parliament of India from January 26, 1950\index{Date!January 26, 1950} till the formation of new Parliament\endnote{The Provisional Parliament ceased to exist on\gls{date:April171952lN5}\index{Date!April 17, 1952}. The first elected Parliament with the two Houses came into being in 1952\index{Date!1952}.} after the first general elections in 1951-52.
...
\begin{enumerate}
  \item\gls{committee:UnionPowersCommittee9Zb} -\gls{person:JawaharlalNehruBmz}
  \item\gls{committee:UnionConstitutionCommitteeRAS} -\gls{person:JawaharlalNehruBmz}
  \item\gls{committee:ProvincialConstitutionCommitteewDh} -\gls{person:SardarVallabhbhaiPateldCT}
  \item\gls{committee:DraftingCommitteeHEV} -\gls{person:DrBRAmbedkarUAG}
  \item\gls{committee:AdvisoryCommitteeLSW} on Fundamental Rights\index{Fundamental Rights}, Minorities and Tribal and Excluded Areas -\gls{person:SardarVallabhbhaiPateldCT}. This committee had the following five sub-committees:
  \begin{enumerate}
    \item\gls{committee:FundamentalRightsSubCommitteeyqU} -\gls{person:JBKripalanivJn}
    \item\gls{committee:MinoritiesSubCommitteesAM} -\gls{person:HCMukherjeexky}
    \item\gls{committee:NorthEastFrontierTribunalAreasSubCommitteeVdT} (with Assam Excluded \& Partially Excluded Areas) -\gls{person:GopinathBardoloi3f0}
    \item\gls{committee:ExcludedandPartiallyExcludedAreasfSr} Other than those in Assam Sub Committee -\gls{person:AVThakkarDvq}
    \item\gls{committee:NorthWestFrontierTribalAreasSubCommitteetVo}\endnote{One of the political consequences of the British Government’s statement of May 03, 1947\index{Date!May 03, 1947}, was that following a referendum, the North-West Frontier Province and Baluchistan became part of the territory of the Dominion of Pakistan and as a result the tribal areas in this region became a concern of that Dominion. The Sub-Committee on the Tribal Areas in the North-West Frontier Province and Baluchistan was not therefore called upon to function on behalf of the Constituent Assembly of India. (B. Shiva Rao, The Framing of India’s Constitution : Select Documents, Volume III, P.681.) The members of this Sub-Committee were : Khan Abdul Ghaffar Khan, Khan Abdul Samad Khan and Mehr Chand Khanna. The information about the Chairman is not found.}
  \end{enumerate}
  
  \item\gls{committee:RulesofProcedureCommitteetiO} -\gls{person:DrRajendraPrasadC4e}
  \item States Committee (Committee for Negotiating with States) -\gls{person:JawaharlalNehruBmz}
  \item\gls{committee:SteeringCommittee9Nr} -\gls{person:DrRajendraPrasadC4e}
\end{enumerate}

\subsection{Minor Committees}

\begin{enumerate}
  \item\gls{committee:FinanceandStaffCommittee5je} -\gls{person:DrRajendraPrasadC4e}
  \item\gls{committee:CredentialsCommittee1YE} -\gls{person:AlladiKrishnaswamiAyyaruuF}
  \item\gls{committee:HouseCommittee5tG} -\gls{person:BPattabhiSitaramayyaRn4}
  \item\gls{committee:OrderofBusinessCommitteeO7j} -\gls{person:DrKMMunshinsm}
  \item\gls{committee:AdhocCommitteeontheNationalFlagooq} -\gls{person:DrRajendraPrasadC4e}
  \item\gls{committee:CommitteeontheFunctionsoftheConstituentAssemblyK5K} -\gls{person:GVMavalankarNIK}
  \item\gls{committee:AdhocCommitteeontheSupremeCourtPV7} -\gls{person:SVaradacharis51} (Not an Assembly Member)
  \item\gls{committee:CommitteeonChiefCommissionersProvincesoMD} -\gls{person:BPattabhiSitaramayyaRn4}
  \item\gls{committee:ExpertCommitteeontheFinancialProvisionsoftheUnionConstitutionB8s} -\gls{person:NaliniRanjanSarkarYzx} (Not an Assembly Member)
  \item\gls{committee:LinguisticProvincesCommissioneT2} -\gls{person:SKDar0uV} (Not an Assembly Member)
  \item\gls{committee:SpecialCommitteetoExaminetheDraftConstitutionT1a} -\gls{person:JawaharlalNehruBmz}
  \item\gls{committee:PressGalleryCommitteeDLO} -\gls{person:UshaNathSendbu}
  \item\gls{committee:AdhocCommitteeonCitizenshipiWI} -\gls{person:SVaradacharis51}
\end{enumerate}


\subsection\gls{committee:DraftingCommitteeHEV}}

Among all the committees of the Constituent Assembly, the most important committee was the\gls{committee:DraftingCommitteeHEV} set up on\gls{date:August291947Ook}\index{Date!August 29, 1947}. It was this committee that was entrusted with the task of preparing a draft of the new Constitution. It consisted of seven members. They were

\begin{enumerate}
  \item\gls{person:DrBRAmbedkarUAG} ({\colord Chairmen})
  \item\gls{person:NGopalaswamyAyyangarajm}
  \item\gls{person:AlladiKrishnaswamiAyyaruuF}
  \item\gls{person:DrKMMunshinsm}
  \item\gls{person:SayedMohammadSaadullahl2Q}
  \item\gls{person:NMadhavaRauiSK} (He replaced\gls{person:BLMitterBdN} who resined due to ill-health)
  \item\gls{person:TTKrishnamachari24U} (He replaced\gls{person:DPKhaitanmx2} who died in 1948)
\end{enumerate}

The\gls{committee:DraftingCommitteeHEV}, after taking into consideration the proposal of the various committees, prepared the first draft of the Constitution of India, which was published in 1948\index{Date!1948}. The people of India were given eight months to discuss the draft and propose amendments. In the light of the public comments, criticisms and suggestions, the\gls{committee:DraftingCommitteeHEV} prepared a second draft, which was published in 1948\index{Date!1948}.

The\gls{committee:DraftingCommitteeHEV} took less than six months to prepare its draft. In all it say for 141 days.

\section{Enactment of the Constitution}
\gls{person:DrBRAmbedkarUAG} introduced the final draft of the Constitution in the Assembly on November 04, 1948\index{Date!November 04, 1948} (first reading). The Assembly had a general discussion on it for five days (till November 09, 1948\index{Date!November 09, 1948}).

The second reading (clause by clause consideration) started on\gls{date:November151948qdO}\index{Date!November 15, 1948} and ended on\gls{date:October171949SBL}\index{Date!October 17, 1949}. During this stage, as many as 7653 amendments were proposed and 2473 were actually discussed in the Assembly.

The third reading of the draft started on\gls{date:November141949t3U}\index{Date!November 14, 1949}.\gls{person:DrBRAmbedkarUAG} moved a motion - `the Constitution as settled by the Assembly be passed'. The motion on Draft Constitution was declared as passed on\gls{date:November261949epG}\index{Date!November 26, 1949}, and received the signatures of the members and the president. Out of a total 299 members of the Assembly, only 284 were actually present on that day and signed the Constitution. This is also the date mentioned in the Preamble as the date on which the people of India in the Constituent Assembly adopted, enacted and gave to themselves this Constitution.

{\colord The Constitution as adopted on\gls{date:November261949epG}\index{Date!November 26, 1949}, contained a Preamble, 395 Articles and 8 Schedules}. The Preamble was enacted after the entire Constitution was already enacted.
\gls{person:DrBRAmbedkarUAG}, the then Law Minister, piloted the Draft Constitution in the Assembly. He took a very prominent part in the deliberations of the Assembly. He was known for his logical, forceful and persuasive arguments on the floor of the Assembly. He is recognized as the `Father of the Constitution of India'. This brilliant writer, constitutional expert, undisputed leader of the scheduled castes and the `chief architech of the Constitution of India' is also known as a `Modern Manu'.

\section{Enforcement of the Constitution}

Some provisions of the Constitution pertaining to citizenship, elections, provisional parliament, temporary and transitional provisions, and short title contained in Articles 5, 6, 7, 8, 9, 60, 324, 366, 367, 379, 380, 388, 391, 392 and 393 came into force on\gls{date:November261949epG}\index{Date!November 26, 1949}, itself.
...
\begin{enumerate}
  ...
  \item \textbf{Time Consuming}: According to the critics, the Constituent Assembly took unduly long time to make the Constitution. They stated that the framers of the American Constitution took only four months to complete their work. In this context,\gls{person:NaziruddinAhmedfHl}, a member of the Constituent Assembly, coined a new name for the\gls{committee:DraftingCommitteeHEV} to show his contempt for it. He called it a \enquote{Drifting Committee}.
  \item \textbf{Dominated by Congress}: The critics charged that the Constituent Assembly was dominated by the Congress party.\gls{person:GranvilleAustinLLB}, a British Constitutional expert, remarked: `The Constituent Assembly was a one-party body in an essentially one-party country. The Assembly was the Congress and the Congress was India'\endnote\gls{person:GranvilleAustinLLB}, The Indian Constitution—Cornerstone of a Nation, Oxford, 1966, P. 8.}.
  ...
  \item \textbf{Dominated by Hindus}: According to some critics, the Constituent Assembly was a Hindu dominated body.\gls{person:LordViscountSimoncxr} called it `a body of Hindus'. Similarly,\gls{person:WinstonChurchillIPg} commented that the Constituent Assembly represented `only one major community in India'.
\end{enumerate}
...
\begin{enumerate}
  ...
  \item\gls{person:SirBNRausOX} was appointed as the constitutional advisor (Legal advisor) to the Constituent Assembly.
  \item\gls{person:HVRIyengar1DI} was the Secretary to the Constituent Assembly.
  \item\gls{person:SNMukerjees7c} was the chief draftsman of the constitution in the Constituent Assembly.
  \item\gls{person:PremBehariNarainRaizadao78} was the calligrapher of the Indian Constitution. The original constitution was handwritten by him in a flowing italic style.
  \item The original version was beautified and decorated by artists from Shantiniketan including\gls{person:NandLalBoseraB} and\gls{person:BeoharRammanoharSinhaa3D}.
  \item\gls{person:BeoharRammanoharSinhaa3D} illuminated, beautified and ornamented the original Preamble calligraph-ed by\gls{person:PremBehariNarainRaizadao78}.
  \item The calligraphy of the Hindi version of the original constitution was done by\gls{person:VasantKrishanVaidya1Ij} and elegantly decorated and illuminated by\gls{person:NandLalBoseraB}.
\end{enumerate}
...
\begin{longtable}[c]{@{}|p{1cm}p{1cm}|p{6cm}|p{4cm}|@{}}
  \caption{State wise Membership of the Constituent Assembly of India as on\gls{date:December311947gBh}\index{Date!December 31, 1947}}
...
It should be notes al the outset that a number of original features of the Constitution (as adopted in 1949) have undergone a substantial change, on account of several amendments, particularly 7th, 42nd, 44th, 73rd, 74th and 97th Amendments. In fact, the 42nd Amendment Act of 1976, is known as `Mini-Constitution' due to the important and large number of changes made by it in various parts of the Constitution. However, in the {\colord \textit\gls{person:KeshavanandaBhartiTEc}}} case\endnote{Kesavananda Bharati vs State of Kerala, (1973)} (1973), the Supreme Court rules that the constitution power of Parliament under Article 368 does not enable it to alter the `basic structure' of the Constitution.
...
The Constitution of India has borrowed most of its provisions from the constitutions of various other countries as well as from the Government of India Act\endnote{About 250 provisions of the 1935 Act have been included in the Constitution.} of 1935.\gls{person:DrBRAmbedkarUAG} proudly acclaimed that the Constitution of India has been framed after `ransacking all the known Constitution of the World\endnote{Constituent Assembly Debates, Volume VII, P. 35–38.}'.
...
Hence, the Indian Constitution has been variously described a `federal in form but unitary in spirit', `quasi-federl' by\gls{person:KCWheareMDt}, `bargaining federalism' by\gls{person:MorrisJonesFpy}, `co-operative federalism' by\gls{person:GranvilleAustinLLB}, `federation with a centralizing tendency' by\gls{person:IvorJenningsmWr}, and so on.
...
According to\gls{person:DrBRAmbedkarUAG}, the Directive Principles of State Policy is a `novel feature' of the Indian Constitution. They are enumerated in Part IV of the Constitution. They can be classified into three broad categories — socialistic, Gandhian and liberal-intellectual.
...
The original constitution did not provide for the fundamental duties of the citizens. These were added during the operation of internal emergency(1975-77) by the 42nd Constitutional Amendment Act of 1976, on the recommendation of the\gls{committee:SwaranSinghCommitteeNIT}. The 86the Constitutional Amendment Act of 2002, added one more fundamental duty.
...
\begin{enumerate}
  ...
  \item \textbf{Date of adoption of the Constitution}: It stipulates\gls{date:November261949epG}\index{Date!November 26, 1949}, as the date.
\end{enumerate}
